...
const POKEMON = [
  ...
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水砲',dmg:50,cost:0,type:'water',megaBoost:true,bonusEnergy:4},{name:'蟲毒吸能擊',dmg:34,cost:2,type:'bug',rider:'energy-steal'},{name:'衝浪',dmg:120,cost:11,type:'fairy',selfHeal:0.28},{name:'冰凍光束',dmg:123,cost:11,type:'ice',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10281, type:'dragon', type2:'flying', ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}}, id:149, name:'快龍',       type:'dragon',   type2:'flying',  hp:320, tier:2, ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}, attacks:[{name:'龍息',dmg:82,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'雷電',dmg:124,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25}},{name:'冰霜護甲擊',dmg:63,cost:8,type:'ice',rider:'guard-up'},{name:'破壞光線',dmg:126,cost:11,type:'normal',status:{effect:'paralysis', chance:0.3}}]},
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'磚塊',dmg:66,cost:8,type:'rock',megaBoost:true,bonusEnergy:8},{name:'連踢',dmg:84,cost:9,type:'normal',selfHeal:0.25},{name:'地震',dmg:99,cost:14,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'破壞光線',dmg:99,cost:14,type:'steel',selfHeal:0.29}]},
  ...
  { id:700, name:'仙子伊布',   type:'fairy',    hp:300, tier:2, ability:{id:'fairy-domain', name:'妖精支配', trigger:'onEnter', desc:'上場時場地切換為妖精結界原野；妖精屬性攻擊傷害額外 +40'}, attacks:[{name:'妖精風',dmg:61,cost:3,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:95,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'月亮力量',dmg:141,cost:13,type:'poison',status:{effect:'poison', chance:0.3}},{name:'暗影球',dmg:137,cost:14,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'冰凍光束',dmg:51,cost:0,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'怒風',dmg:82,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'冰耳光',dmg:122,cost:11,type:'ghost',status:{effect:'sleep', chance:0.2}},{name:'激流威壓擊',dmg:24,cost:3,type:'water',rider:'weaken'}]},
  { id:614, name:'凍原熊',     type:'ice',      hp:215, tier:2, ability:{id:'ice-domain', name:'冰霜支配', trigger:'onEnter', desc:'上場時場地切換為永凍冰原；冰屬性攻擊傷害額外 +40'}, attacks:[{name:'冰耳光',dmg:88,cost:7,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'大浪',dmg:126,cost:12,type:'water',status:{effect:'poison', chance:0.3}},{name:'暴風雪',dmg:126,cost:11,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:128,cost:12,type:'ground',status:{effect:'poison', chance:0.3}}]},
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'夜斬',dmg:61,cost:3,type:'dark',megaBoost:true,bonusEnergy:6},{name:'夜騷動',dmg:100,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'空氣斬',dmg:145,cost:14,type:'psychic',selfHeal:0.22},{name:'怒風',dmg:139,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:466, name:'電擊魔獸',   type:'electric', hp:300, tier:2, ability:{id:'electric-domain', name:'雷霆支配', trigger:'onEnter', desc:'上場時場地切換為雷雲庇護所；電屬性攻擊傷害額外 +40'}, attacks:[{name:'電磁衝浪',dmg:56,cost:3,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'動感拳',dmg:96,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'十萬伏特',dmg:138,cost:14,type:'psychic',selfHeal:0.18},{name:'冰凍拳',dmg:138,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  { id:467, name:'鴨嘴炎獸',   type:'fire',     hp:300, tier:2, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'火焰衝擊',dmg:63,cost:3,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:98,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'噴射火焰',dmg:141,cost:14,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'雷電',dmg:143,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:157, name:'火爆獸',     type:'fire',                      hp:260, tier:2, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'疾風吸能擊',dmg:36,cost:3,type:'flying',rider:'energy-steal'},{name:'地震',dmg:91,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'爆炸火焰',dmg:94,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'烈火強衝',dmg:136,cost:13,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10282, type:'grass', type2:'fairy', ability:{id:'huge-power', name:'太陽核心', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:154, name:'大竺葵',     type:'grass',                     hp:270, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'逆鱗護甲擊',dmg:28,cost:3,type:'dragon',rider:'guard-up'},{name:'大地之力',dmg:103,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'花瓣風暴',dmg:102,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:145,cost:15,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  // Tier 3
  { id:383, name:'固拉多',     type:'ground',   hp:300, tier:3, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'地震',dmg:67,cost:11,type:'ground',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:83,cost:10,type:'rock',selfHeal:0.22},{name:'火焰噴射',dmg:83,cost:10,type:'fire',status:{effect:'confusion', chance:0.25}},{name:'原始大地',dmg:71,cost:5,type:'fairy',status:{effect:'burn', chance:0.15},selfHeal:0.26}]},
  { id:382, name:'蓋歐卡',     type:'water',    hp:290, tier:3, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'源起之波',dmg:55,cost:5,type:'water',megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:82,cost:10,type:'electric',status:{effect:'burn', chance:0.25}},{name:'大浪',dmg:80,cost:9,type:'normal',selfHeal:0.16},{name:'原始海洋',dmg:80,cost:9,type:'ice',selfHeal:0.21}]},
  ...
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:77,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'龍息',dmg:73,cost:6,type:'dragon',selfHeal:0.17},{name:'電磁炮',dmg:86,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'未來雷霆',dmg:86,cost:11,type:'psychic',selfHeal:0.23}]},
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'flying-domain', name:'疾風支配', trigger:'onEnter', desc:'上場時場地切換為疾風之翼；飛行屬性攻擊傷害額外 +40'}, attacks:[{name:'怒風',dmg:56,cost:3,type:'flying',status:{effect:'paralysis', chance:0.2}},{name:'聖焰',dmg:93,cost:8,type:'fire',status:{effect:'burn', chance:0.3}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'神聖之焰',dmg:140,cost:13,type:'dragon',selfHeal:0.22}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'念力',dmg:55,cost:3,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:92,cost:8,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:88,cost:9,type:'ice',rider:'guard-up'},{name:'極光束',dmg:138,cost:13,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10051, type:'psychic', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:282, name:'沙奈朵',     type:'psychic',  type2:'fairy',   hp:205, tier:3, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'妖精之力',dmg:83,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:120,cost:11,type:'ghost',selfHeal:0.26},{name:'月亮力量',dmg:124,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'精神強擊',dmg:123,cost:11,type:'psychic',selfHeal:0.24}]},
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'暴風雪',dmg:61,cost:6,type:'ice',status:{effect:'freeze', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'冷凍光線',dmg:86,cost:11,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'暴風',dmg:86,cost:11,type:'ghost',selfHeal:0.22},{name:'怒風',dmg:73,cost:6,type:'normal',selfHeal:0.25}]},
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:245, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:66,cost:11,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'電磁衝浪',dmg:89,cost:12,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'雷電',dmg:73,cost:12,type:'dragon',selfHeal:0.25},{name:'怒風',dmg:89,cost:8,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:200, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'火焰衝擊',dmg:72,cost:11,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:65,cost:4,type:'psychic',status:{effect:'confusion', chance:0.15},selfHeal:0.16},{name:'噴射火焰',dmg:76,cost:9,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'怒風',dmg:76,cost:9,type:'flying',selfHeal:0.28}]},
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'steel-domain', name:'鋼鐵支配', trigger:'onEnter', desc:'上場時場地切換為鋼鐵堡壘；鋼屬性攻擊傷害額外 +40'}, attacks:[{name:'鐵頭功',dmg:66,cost:8,type:'steel',megaBoost:true,bonusEnergy:8},{name:'剛劍',dmg:94,cost:11,type:'fairy',selfHeal:0.19},{name:'接近戰',dmg:94,cost:11,type:'fighting',selfHeal:0.21},{name:'神秘劍',dmg:80,cost:6,type:'poison',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:305, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'妖精之風',dmg:57,cost:3,type:'fairy'},{name:'月亮力量',dmg:94,cost:8,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'十萬伏特',dmg:90,cost:9,type:'grass',rider:'card-steal'},{name:'光之波動',dmg:139,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'暴風雪',dmg:78,cost:13,type:'ice',status:{effect:'freeze', chance:0.2},megaBoost:true,bonusEnergy:8},{name:'閃光炮',dmg:71,cost:8,type:'steel',status:{effect:'paralysis', chance:0.2}},{name:'冰耳光',dmg:84,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'電磁砲',dmg:71,cost:8,type:'electric',status:{effect:'burn', chance:0.25}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:265, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'惡意波動',dmg:58,cost:3,type:'dark'},{name:'空氣斬',dmg:91,cost:8,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'大地虹吸',dmg:85,cost:9,type:'ground',rider:'life-drain'},{name:'夜騷動',dmg:141,cost:13,type:'ghost',selfHeal:0.25}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:76,cost:12,type:'steel',megaBoost:true,bonusEnergy:7},{name:'鋼鐵翼',dmg:95,cost:10,type:'dragon',selfHeal:0.19},{name:'龍爪',dmg:81,cost:5,type:'electric',selfHeal:0.21},{name:'時間咆哮',dmg:95,cost:10,type:'ghost',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:65,cost:7,type:'water',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:70,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'水之脈動',dmg:82,cost:11,type:'psychic',selfHeal:0.25},{name:'空間扭曲',dmg:98,cost:11,type:'steel',selfHeal:0.15}]},
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, ability:{id:'dark-domain', name:'暗夜支配', trigger:'onEnter', desc:'上場時場地切換為暗夜詛咒領域；惡屬性攻擊傷害額外 +40'}, attacks:[{name:'火焰噴射',dmg:59,cost:3,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'暗黑強打',dmg:95,cost:9,type:'dark',megaBoost:true,bonusEnergy:7},{name:'超強衝擊',dmg:135,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}},{name:'赤焰衝擊',dmg:138,cost:13,type:'poison',selfHeal:0.2}]},
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:62,cost:1,type:'normal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:31,cost:5,type:'fire',rider:'life-drain'},{name:'地震',dmg:97,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'強力碰撞',dmg:151,cost:12,type:'dark',selfHeal:0.21}]},
  ...
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:66,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:64,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:96,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:12,cost:5,type:'steel',rider:'guard-up'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'蟲毒強奪擊',dmg:29,cost:3,type:'bug',rider:'card-steal'},{name:'毒液',dmg:74,cost:4,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:7},{name:'衝浪',dmg:120,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'水砲',dmg:170,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'妖精吸血擊',dmg:22,cost:1,type:'fairy',rider:'life-drain'},{name:'突擊',dmg:83,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:125,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:179,cost:14,type:'poison',selfHeal:0.27}]},
  ...
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'暗影爪',dmg:72,cost:3,type:'ghost',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:72,cost:3,type:'ice',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:113,cost:8,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:11,cost:3,type:'flying',rider:'card-steal'}]},
  { mega:{spriteId:10291, type:'ghost', type2:'fire', ability:{id:'frisk-ward', name:'穿透', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:609, name:'水晶燈火靈', type:'ghost',    type2:'fire',    hp:260, tier:2, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'冰霜吸血擊',dmg:22,cost:5,type:'ice',rider:'life-drain'},{name:'噴火',dmg:86,cost:7,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:5},{name:'火焰漩渦',dmg:89,cost:8,type:'ghost',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'暗影球',dmg:128,cost:12,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:70,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'追影斬',dmg:68,cost:4,type:'grass',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:27,cost:3,type:'fairy',rider:'weaken'},{name:'暗黑脈衝',dmg:163,cost:14,type:'steel',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:67,cost:3,type:'normal',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:33,cost:2,type:'steel',rider:'energy-steal'},{name:'居合斬',dmg:112,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:157,cost:13,type:'dark',selfHeal:0.18}]},
  ...
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'咬住',dmg:61,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'吼叫',dmg:96,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'破魂威壓擊',dmg:11,cost:3,type:'fighting',rider:'weaken'},{name:'火焰牙',dmg:98,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  ...
  { mega:{spriteId:10064, type:'water', type2:'ground', ability:{id:'huge-power', name:'飛毛腿', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:260, name:'巨沼怪', type:'water', type2:'ground', hp:300, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水槍',dmg:59,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:92,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:136,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'冰凍拳',dmg:135,cost:13,type:'ice',status:{effect:'confusion', chance:0.25}}]},
  { id:407, name:'羅絲雷朵', type:'grass', type2:'poison', hp:270, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'激流吸血擊',dmg:31,cost:4,type:'water',rider:'life-drain'},{name:'魔法葉',dmg:99,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'花瓣舞',dmg:99,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'污泥炸彈',dmg:141,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'飛葉快刀',dmg:50,cost:1,type:'grass',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:90,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'幽靈箭',dmg:133,cost:12,type:'fire',status:{effect:'burn', chance:0.25}},{name:'光合作用強擊',dmg:128,cost:13,type:'flying',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'毒針',dmg:54,cost:0,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:80,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'疾風威壓擊',dmg:27,cost:5,type:'flying',rider:'weaken'},{name:'惡意突刺',dmg:120,cost:11,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  { id:862, name:'堵攔熊', type:'dark', type2:'normal', hp:300, tier:2, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'夜斬',dmg:62,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'連續切',dmg:98,cost:8,type:'normal',megaBoost:true,bonusEnergy:6},{name:'惡意突刺',dmg:141,cost:14,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'蠻力',dmg:142,cost:14,type:'dragon',selfHeal:0.2}]},
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'蟲咬',dmg:64,cost:4,type:'bug',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:99,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'蟲鳴',dmg:96,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'妖精吸能擊',dmg:25,cost:5,type:'fairy',rider:'energy-steal'}]},
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'泥巴射擊',dmg:68,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'影子偷襲',dmg:105,cost:10,type:'ghost',megaBoost:true,bonusEnergy:8},{name:'地震',dmg:150,cost:15,type:'bug',selfHeal:0.22},{name:'惡靈波動',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'水槍',dmg:70,cost:5,type:'water',megaBoost:true,bonusEnergy:8},{name:'念力',dmg:104,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'蟲毒護甲擊',dmg:33,cost:3,type:'bug',rider:'guard-up'},{name:'精神強擊',dmg:150,cost:15,type:'fighting',selfHeal:0.15}]},
  { mega:{spriteId:10045, type:'electric', type2:'dragon', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:181, name:'電龍', type:'electric',  hp:300, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:55,cost:2,type:'electric',megaBoost:true,bonusEnergy:6},{name:'電光一閃',dmg:90,cost:8,type:'normal',megaBoost:true,bonusEnergy:6},{name:'十萬伏特',dmg:134,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'雷電',dmg:138,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10316, type:'bug', type2:'steel', ability:{id:'solid-rock', name:'重甲化', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:768, name:'具甲武者', type:'bug', type2:'water', hp:290, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'水流手裏劍',dmg:51,cost:2,type:'water',megaBoost:true,bonusEnergy:6},{name:'蟲咬',dmg:88,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'X 剪刀',dmg:128,cost:13,type:'fire',selfHeal:0.17},{name:'水炮',dmg:131,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'魔法葉',dmg:68,cost:4,type:'grass',megaBoost:true,bonusEnergy:7},{name:'藤鞭',dmg:100,cost:10,type:'fire',megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:149,cost:15,type:'normal',status:{effect:'confusion', chance:0.25}},{name:'能量球',dmg:144,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'冰凍拳',dmg:85,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:122,cost:11,type:'rock',selfHeal:0.24},{name:'暴風雪',dmg:126,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'雪崩',dmg:122,cost:11,type:'grass',selfHeal:0.17}]},
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:58,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:27,cost:1,type:'electric',rider:'card-steal'},{name:'精神強擊',dmg:124,cost:11,type:'ghost',selfHeal:0.2},{name:'未來預知',dmg:129,cost:12,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:235, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'冰凍拳',dmg:72,cost:11,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:81,cost:12,type:'ground',selfHeal:0.28},{name:'雪崩',dmg:69,cost:7,type:'dark',status:{effect:'freeze', chance:0.15},selfHeal:0.25},{name:'冰牙',dmg:69,cost:7,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:625, name:'劈斬司令', type:'dark', type2:'steel', hp:295, tier:3, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'金屬爪',dmg:64,cost:10,type:'steel',megaBoost:true,bonusEnergy:5},{name:'夜斬',dmg:73,cost:12,type:'dark',selfHeal:0.16},{name:'惡意突刺',dmg:73,cost:8,type:'water',selfHeal:0.23},{name:'鐵頭功',dmg:73,cost:8,type:'psychic',selfHeal:0.3}]},
  /* ── Mega 進化擴充（Legends Z-A / 原有 46 種缺漏補完） ── */
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:61,cost:2,type:'flying',megaBoost:true,bonusEnergy:6},{name:'疾風拳',dmg:62,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:109,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:50,cost:8,type:'poison',rider:'weaken'}]},
  ...
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'啃咬',dmg:61,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:65,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'幽冥威壓擊',dmg:12,cost:3,type:'ghost',rider:'weaken'},{name:'重磅衝撞',dmg:145,cost:11,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10053, type:'steel', type2:null, ability:{id:'solid-rock', name:'過濾', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:306, name:'波士可多拉', type:'steel', type2:'rock', hp:200, tier:2, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'金屬爪',dmg:67,cost:5,type:'steel',megaBoost:true,bonusEnergy:8},{name:'岩石滑落',dmg:105,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'重磅衝撞',dmg:146,cost:15,type:'ghost',selfHeal:0.18},{name:'劈斬',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:84,cost:5,type:'electric',megaBoost:true,bonusEnergy:8},{name:'大地護甲擊',dmg:10,cost:3,type:'ground',rider:'guard-up'},{name:'十萬伏特',dmg:124,cost:10,type:'normal',megaBoost:true,bonusEnergy:8},{name:'火焰牙',dmg:176,cost:15,type:'fire',selfHeal:0.26}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水槍',dmg:78,cost:4,type:'water',megaBoost:true,bonusEnergy:7},{name:'劇毒強奪擊',dmg:34,cost:5,type:'poison',rider:'card-steal'},{name:'衝浪',dmg:122,cost:10,type:'dark',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:176,cost:14,type:'ice',selfHeal:0.18}]},
  { mega:{spriteId:10087, type:'fire', type2:'ground', ability:{id:'tough-claws', name:'強行', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:323, name:'噴火駝', type:'fire', type2:'ground', hp:260, tier:2, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'火花',dmg:59,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:97,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽冥吸血擊',dmg:24,cost:3,type:'ghost',rider:'life-drain'},{name:'地震',dmg:139,cost:13,type:'steel',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10067, type:'dragon', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:334, name:'七夕青鳥', type:'dragon', type2:'flying', hp:270, tier:2, ability:{id:'frisk-ward', name:'自然回復', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:66,cost:4,type:'flying',megaBoost:true,bonusEnergy:7},{name:'龍之氣息',dmg:101,cost:10,type:'dragon',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:104,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:50,cost:8,type:'grass',rider:'weaken'}]},
