...
const POKEMON = [
  ...
  // Tier 2
  { mega:{spriteId:10034, type:'fire', type2:'dragon', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:6,   name:'噴火龍',     type:'fire',     type2:'flying',  hp:290, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火焰噴射',dmg:27,cost:2,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'龍爪',dmg:12,cost:1,type:'dragon',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:151,cost:12,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.2}},{name:'燕返',dmg:151,cost:12,type:'flying',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水砲',dmg:20,cost:0,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:4},{name:'蟲毒吸能擊',dmg:23,cost:2,type:'bug',rider:'type-draw'},{name:'妖精吸血擊',dmg:143,cost:11,type:'fairy',ignoreReflect:true,selfHeal:0.28},{name:'冰凍光束',dmg:143,cost:11,type:'ice',selfHeal:0.29}]},
  { mega:{spriteId:10043, type:'psychic', type2:'fighting', ability:{id:'guts', name:'不屈之心', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:150, name:'超夢',       type:'psychic',  hp:320, tier:2, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'念力衝擊',dmg:80,cost:6,type:'psychic',status:{effect:'confusion', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'氣功拳',dmg:131,cost:11,type:'fighting',selfHeal:0.19},{name:'閃電拳',dmg:131,cost:11,type:'electric',status:{effect:'sleep', chance:0.2}},{name:'暗影球',dmg:40,cost:3,type:'ghost',rider:'type-draw',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10281, type:'dragon', type2:'flying', ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}}, id:149, name:'快龍',       type:'dragon',   type2:'flying',  hp:320, tier:2, ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}, attacks:[{name:'逆鱗護甲擊',dmg:82,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'雷電',dmg:140,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25}},{name:'冰霜護甲擊',dmg:42,cost:3,type:'ice',rider:'energy-steal'},{name:'破壞光線',dmg:134,cost:11,type:'normal',status:{effect:'paralysis', chance:0.3}}]},
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'磚塊',dmg:69,cost:6,type:'rock',megaBoost:true,bonusEnergy:8},{name:'喊叫',dmg:27,cost:2,type:'normal',rider:'self-cure',selfHeal:0.25},{name:'地震',dmg:155,cost:14,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'鐵頭',dmg:155,cost:14,type:'steel',selfHeal:0.29}]},
  { id:59,  name:'風速狗',     type:'fire',     hp:260, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'連續啃咬',dmg:13,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'冰霜強奪擊',dmg:23,cost:2,type:'ice',rider:'type-draw'},{name:'頭槌',dmg:90,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'噴射火焰',dmg:134,cost:12,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25}}]},
  { id:131, name:'拉普拉斯',   type:'water',    type2:'ice',     hp:290, tier:2, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:14,cost:1,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'冷凍光線',dmg:24,cost:2,type:'ice',rider:'energy-steal',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:132,cost:12,type:'electric',selfHeal:0.21},{name:'遠古之力',dmg:154,cost:13,type:'rock',selfHeal:0.17}]},
  { mega:{spriteId:10058, type:'dragon', type2:'ground', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:445, name:'烈咬陸鯊',   type:'dragon',   type2:'ground',  hp:280, tier:2, ability:{id:'frisk-ward', name:'沙隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'龍爪',dmg:13,cost:1,type:'dragon',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'疾風吸血擊',dmg:35,cost:3,type:'flying',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:146,cost:11,type:'ground',selfHeal:0.23},{name:'惡意突刺',dmg:146,cost:11,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:210, name:'布魯皇',     type:'fairy',    hp:300, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'妖精之力',dmg:42,cost:3,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'雷電',dmg:12,cost:1,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'咬碎',dmg:143,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}},{name:'地震',dmg:138,cost:13,type:'ground',status:{effect:'confusion', chance:0.25}}]},
  { id:700, name:'仙子伊布',   type:'fairy',    hp:300, tier:2, ability:{id:'fairy-domain', name:'妖精支配', trigger:'onEnter', desc:'上場時場地切換為妖精結界原野；妖精屬性攻擊傷害額外 +40'}, attacks:[{name:'妖精風',dmg:34,cost:3,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:39,cost:3,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'毒牙',dmg:141,cost:13,type:'poison',status:{effect:'poison', chance:0.3}},{name:'暗影球',dmg:137,cost:14,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'冰凍光束',dmg:22,cost:0,type:'ice',rider:'energy-steal',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'怒風',dmg:82,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'幽靈球',dmg:131,cost:11,type:'ghost',ignoreReflect:true,status:{effect:'sleep', chance:0.2}},{name:'激流威壓擊',dmg:38,cost:3,type:'water',rider:'mega-charge'}]},
  { id:614, name:'凍原熊',     type:'ice',      hp:215, tier:2, ability:{id:'ice-domain', name:'冰霜支配', trigger:'onEnter', desc:'上場時場地切換為永凍冰原；冰屬性攻擊傷害額外 +40'}, attacks:[{name:'冰耳光',dmg:78,cost:3,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'大浪',dmg:172,cost:12,type:'water',status:{effect:'poison', chance:0.3}},{name:'火焰噴射',dmg:122,cost:6,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:172,cost:12,type:'ground',status:{effect:'poison', chance:0.3}}]},
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'夜斬',dmg:38,cost:3,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'暴風',dmg:43,cost:3,type:'flying',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:145,cost:14,type:'psychic',selfHeal:0.22},{name:'毒粉刺',dmg:139,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:466, name:'電擊魔獸',   type:'electric', hp:300, tier:2, ability:{id:'electric-domain', name:'雷霆支配', trigger:'onEnter', desc:'上場時場地切換為雷雲庇護所；電屬性攻擊傷害額外 +40'}, attacks:[{name:'電磁衝浪',dmg:39,cost:3,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'決勝衝擊',dmg:34,cost:3,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:138,cost:14,type:'psychic',selfHeal:0.18},{name:'冰凍拳',dmg:138,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  { id:467, name:'鴨嘴炎獸',   type:'fire',     hp:300, tier:2, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'火焰衝擊',dmg:42,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:25,cost:2,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'閃電拳',dmg:141,cost:14,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'惡意突刺',dmg:143,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:157, name:'火爆獸',     type:'fire',                      hp:260, tier:2, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'疾風吸能擊',dmg:44,cost:3,type:'flying',ignoreReflect:true,rider:'energy-steal'},{name:'地震',dmg:91,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'爆炸火焰',dmg:11,cost:1,type:'fire',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'毒粉刺',dmg:136,cost:13,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10282, type:'grass', type2:'fairy', ability:{id:'huge-power', name:'太陽核心', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:154, name:'大竺葵',     type:'grass',                     hp:270, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'逆鱗護甲擊',dmg:35,cost:3,type:'dragon',rider:'mega-charge'},{name:'大地之力',dmg:103,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'花瓣風暴',dmg:48,cost:4,type:'grass',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'閃電拳',dmg:145,cost:15,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  // Tier 3
  { id:383, name:'固拉多',     type:'ground',   hp:300, tier:3, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'地震',dmg:143,cost:11,type:'ground',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:25,cost:3,type:'rock',selfHeal:0.22},{name:'火焰噴射',dmg:37,cost:3,type:'fire',ignoreReflect:true,status:{effect:'confusion', chance:0.25}},{name:'妖精威壓擊',dmg:112,cost:8,type:'fairy',rider:'move-reflect',status:{effect:'burn', chance:0.15},selfHeal:0.26}]},
  { id:382, name:'蓋歐卡',     type:'water',    hp:290, tier:3, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'源起之波',dmg:73,cost:5,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:82,cost:10,type:'electric',status:{effect:'burn', chance:0.25}},{name:'橫衝直撞',dmg:80,cost:9,type:'normal',selfHeal:0.16},{name:'原始海洋',dmg:66,cost:5,type:'ice',rider:'type-draw',selfHeal:0.21}]},
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'神速',dmg:66,cost:5,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:135,cost:11,type:'fire',ignoreReflect:true,status:{effect:'freeze', chance:0.15}},{name:'燕返',dmg:135,cost:11,type:'flying',status:{effect:'poison', chance:0.3}},{name:'龍之隕星',dmg:35,cost:3,type:'dragon',rider:'self-cure',status:{effect:'burn', chance:0.25}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:135,cost:12,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'逆鱗護甲擊',dmg:73,cost:6,type:'dragon',selfHeal:0.17},{name:'毒牙',dmg:131,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'精神強擊',dmg:42,cost:3,type:'psychic',rider:'mega-charge',selfHeal:0.23}]},
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'flying-domain', name:'疾風支配', trigger:'onEnter', desc:'上場時場地切換為疾風之翼；飛行屬性攻擊傷害額外 +40'}, attacks:[{name:'怒風',dmg:34,cost:3,type:'flying',rider:'self-cure',status:{effect:'paralysis', chance:0.2}},{name:'聖焰',dmg:39,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.3}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'龍之氣息',dmg:140,cost:13,type:'dragon',selfHeal:0.22}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'未來雷霆',dmg:61,cost:3,type:'psychic',rider:'mega-charge',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:69,cost:4,type:'flying',rider:'type-draw',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:108,cost:9,type:'ice',rider:'guard-up'},{name:'幽靈球',dmg:158,cost:13,type:'ghost',ignoreReflect:true,status:{effect:'freeze', chance:0.15}}]},
  { id:1007,name:'故勒頓',     type:'fighting', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'緋紅脈動', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'決勝衝擊',dmg:87,cost:6,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:83,cost:10,type:'fire',status:{effect:'burn', chance:0.25}},{name:'泥巴射擊',dmg:83,cost:10,type:'ground',status:{effect:'sleep', chance:0.2}},{name:'遠古之力',dmg:53,cost:4,type:'rock',rider:'energy-steal',selfHeal:0.3}]},
  { mega:{spriteId:10051, type:'psychic', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:282, name:'沙奈朵',     type:'psychic',  type2:'fairy',   hp:205, tier:3, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'妖精之力',dmg:123,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:175,cost:11,type:'ghost',selfHeal:0.26},{name:'毒針',dmg:175,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'精神強擊',dmg:79,cost:3,type:'psychic',rider:'energy-steal',selfHeal:0.24}]},
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'暴風雪',dmg:61,cost:6,type:'ice',status:{effect:'freeze', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:131,cost:11,type:'flying',ignoreReflect:true,status:{effect:'sleep', chance:0.2}},{name:'幽冥威壓擊',dmg:131,cost:11,type:'ghost',selfHeal:0.22},{name:'橫衝直撞',dmg:73,cost:6,type:'normal',selfHeal:0.25}]},
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:245, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:92,cost:5,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'猛禽炸彈',dmg:174,cost:12,type:'flying',ignoreReflect:true,status:{effect:'sleep', chance:0.2}},{name:'龍爪',dmg:174,cost:12,type:'dragon',selfHeal:0.25},{name:'吼叫',dmg:37,cost:1,type:'normal',rider:'type-draw',status:{effect:'paralysis', chance:0.2}}]},
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:200, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'火焰衝擊',dmg:175,cost:11,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:91,cost:4,type:'psychic',rider:'energy-steal',status:{effect:'confusion', chance:0.15},selfHeal:0.16},{name:'十萬伏特',dmg:116,cost:9,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'怒風',dmg:53,cost:1,type:'flying',ignoreReflect:true,selfHeal:0.28}]},
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'steel-domain', name:'鋼鐵支配', trigger:'onEnter', desc:'上場時場地切換為鋼鐵堡壘；鋼屬性攻擊傷害額外 +40'}, attacks:[{name:'鐵頭功',dmg:81,cost:6,type:'steel',megaBoost:true,bonusEnergy:8},{name:'月亮力量',dmg:138,cost:11,type:'fairy',ignoreReflect:true,selfHeal:0.19},{name:'接近戰',dmg:138,cost:11,type:'fighting',selfHeal:0.21},{name:'劇毒威壓擊',dmg:80,cost:6,type:'poison',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:305, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'魔法閃耀',dmg:39,cost:3,type:'fairy',rider:'type-draw'},{name:'十萬伏特',dmg:57,cost:5,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.2}},{name:'飛葉快刀',dmg:90,cost:9,type:'grass',rider:'card-steal'},{name:'冰耳光',dmg:139,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'暴風雪',dmg:150,cost:13,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.2},megaBoost:true,bonusEnergy:8},{name:'閃光炮',dmg:13,cost:1,type:'steel',rider:'self-cure',status:{effect:'paralysis', chance:0.2}},{name:'未來雷霆',dmg:150,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'電磁砲',dmg:25,cost:2,type:'electric',rider:'mega-charge',status:{effect:'burn', chance:0.25}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:265, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'惡意波動',dmg:42,cost:3,type:'dark',ignoreReflect:true},{name:'空氣斬',dmg:49,cost:4,type:'flying',rider:'mega-charge',status:{effect:'freeze', chance:0.15}},{name:'大地虹吸',dmg:85,cost:9,type:'ground',rider:'life-drain'},{name:'幽靈球',dmg:141,cost:13,type:'ghost',selfHeal:0.25}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:142,cost:12,type:'steel',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:95,cost:10,type:'dragon',selfHeal:0.19},{name:'雷霆',dmg:62,cost:5,type:'electric',rider:'mega-charge',selfHeal:0.21},{name:'幽靈之爪',dmg:84,cost:6,type:'ghost',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:66,cost:2,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:110,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'空間扭曲',dmg:171,cost:11,type:'psychic',ignoreReflect:true,selfHeal:0.25},{name:'鐵翼',dmg:171,cost:11,type:'steel',selfHeal:0.15}]},
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, ability:{id:'dark-domain', name:'暗夜支配', trigger:'onEnter', desc:'上場時場地切換為暗夜詛咒領域；惡屬性攻擊傷害額外 +40'}, attacks:[{name:'火焰噴射',dmg:40,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'暗黑強打',dmg:70,cost:6,type:'dark',megaBoost:true,bonusEnergy:7},{name:'超強衝擊',dmg:135,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}},{name:'劇毒威壓擊',dmg:138,cost:13,type:'poison',selfHeal:0.2}]},
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:44,cost:1,type:'normal',rider:'energy-steal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:93,cost:5,type:'fire',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:127,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'夜襲',dmg:181,cost:12,type:'dark',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'疾風威壓擊',dmg:70,cost:3,type:'flying',rider:'self-cure'},{name:'大字爆炎',dmg:128,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:126,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:174,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'閃電拳',dmg:24,cost:2,type:'electric',rider:'mega-charge',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'能量球',dmg:91,cost:8,type:'grass',ignoreReflect:true,status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:89,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'神速吸能擊',dmg:41,cost:3,type:'normal',rider:'self-cure'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:61,cost:0,type:'normal',rider:'mega-charge',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:59,cost:0,type:'poison',rider:'type-draw',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'地震',dmg:136,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:102,cost:5,type:'steel',ignoreReflect:true,rider:'guard-up'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'蟲毒強奪擊',dmg:74,cost:3,type:'bug',rider:'energy-steal'},{name:'毒液',dmg:93,cost:4,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:7},{name:'衝浪',dmg:155,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:205,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'妖精吸血擊',dmg:42,cost:1,type:'fairy',rider:'mega-charge'},{name:'夜襲',dmg:84,cost:4,type:'dark',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:155,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'劇毒威壓擊',dmg:209,cost:14,type:'poison',selfHeal:0.27}]},
  { id:553, name:'流氓鱷',     type:'ground',   type2:'dark',    hp:270, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'岩石滑落',dmg:57,cost:4,type:'rock',rider:'energy-steal',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'激流威壓擊',dmg:38,cost:3,type:'water',rider:'self-cure'},{name:'地震',dmg:102,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'暗黑強打',dmg:147,cost:14,type:'dark',ignoreReflect:true,selfHeal:0.24}]},
  { id:641, name:'龍捲雲',     type:'flying',                    hp:290, tier:2, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'空氣斬',dmg:13,cost:1,type:'flying',rider:'type-draw',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:23,cost:2,type:'electric',rider:'energy-steal',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'蟲刃剪',dmg:148,cost:12,type:'bug',ignoreReflect:true,selfHeal:0.22},{name:'飛葉快刀',dmg:132,cost:12,type:'grass',selfHeal:0.18}]},
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'神速吸能擊',dmg:50,cost:0,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'暴風',dmg:127,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:80,cost:8,type:'grass',rider:'energy-steal'},{name:'夜騷動',dmg:178,cost:12,type:'dark',selfHeal:0.25}]},
  { id:663, name:'烈箭鷹',     type:'fire',     type2:'flying',  hp:260, tier:2, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'炎翼衝刺',dmg:41,cost:3,type:'fire',rider:'energy-steal',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'空氣斬',dmg:95,cost:9,type:'flying',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'荒草護甲擊',dmg:68,cost:5,type:'grass',rider:'mega-charge'},{name:'幽靈球',dmg:139,cost:14,type:'ghost',selfHeal:0.2}]},
  { mega:{spriteId:10047, type:'bug', type2:'fighting', ability:{id:'huge-power', name:'連續攻擊', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:214, name:'赫拉克羅斯', type:'bug',      type2:'fighting',hp:270, tier:2, ability:{id:'guts', name:'毅力', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'妖精強奪擊',dmg:14,cost:1,type:'fairy',rider:'mega-charge'},{name:'地震',dmg:98,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'聖甲蟲衝擊',dmg:58,cost:4,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:143,cost:14,type:'fighting',ignoreReflect:true,status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10046, type:'bug', type2:'steel', ability:{id:'technician', name:'技術高手', trigger:'onAttack', desc:'威力 60 以下的招式，傷害 ×1.1'}}, id:212, name:'巨鉗螳螂',   type:'bug',      type2:'steel',   hp:260, tier:2, ability:{id:'blaze-boost', name:'蟲之預感', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'疾風吸血擊',dmg:25,cost:2,type:'flying',ignoreReflect:true,rider:'life-drain'},{name:'子彈拳',dmg:89,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'蟲刃剪',dmg:76,cost:6,type:'bug',megaBoost:true,bonusEnergy:5},{name:'破魂吸血擊',dmg:134,cost:12,type:'fighting',selfHeal:0.23}]},
  { id:469, name:'遠古巨蜓',   type:'bug',      type2:'flying',  hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'空氣斬',dmg:80,cost:4,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'雷光威壓擊',dmg:115,cost:6,type:'electric',rider:'weaken'},{name:'蟲鳴',dmg:150,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'實力全開',dmg:204,cost:14,type:'normal',selfHeal:0.25}]},
  { mega:{spriteId:10049, type:'rock', type2:'dark', ability:{id:'solid-rock', name:'揚沙', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:248, name:'班基拉斯',   type:'rock',     type2:'dark',    hp:300, tier:2, ability:{id:'solid-rock', name:'揚沙', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'碎岩',dmg:102,cost:8,type:'rock',rider:'move-reflect',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:8},{name:'咬碎',dmg:73,cost:5,type:'dark',ignoreReflect:true,status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'地震',dmg:68,cost:7,type:'ground',selfHeal:0.21},{name:'踢腿',dmg:147,cost:14,type:'fighting',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10042, type:'rock', type2:'flying', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:142, name:'化石翼龍',   type:'rock',     type2:'flying',  hp:260, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'咬碎',dmg:56,cost:4,type:'dark',ignoreReflect:true,status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'翼擊',dmg:99,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'精神吸能擊',dmg:56,cost:4,type:'psychic',rider:'type-draw'},{name:'岩石炮',dmg:140,cost:14,type:'rock',selfHeal:0.2}]},
  { id:526, name:'龐岩怪',     type:'rock',                      hp:280, tier:2, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:12,cost:1,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'逆鱗護甲擊',dmg:42,cost:3,type:'dragon',rider:'energy-steal'},{name:'地震',dmg:138,cost:12,type:'ground',ignoreReflect:true,status:{effect:'freeze', chance:0.15}},{name:'岩石炮',dmg:132,cost:11,type:'rock',status:{effect:'poison', chance:0.3}}]},
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'幽靈球',dmg:75,cost:3,type:'ghost',ignoreReflect:true,status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:70,cost:3,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'月亮力量',dmg:148,cost:8,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:70,cost:3,type:'flying',rider:'energy-steal'}]},
  { mega:{spriteId:10291, type:'ghost', type2:'fire', ability:{id:'frisk-ward', name:'穿透', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:609, name:'水晶燈火靈', type:'ghost',    type2:'fire',    hp:260, tier:2, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'冰霜吸血擊',dmg:66,cost:5,type:'ice',ignoreReflect:true,rider:'life-drain'},{name:'噴火',dmg:46,cost:4,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:5},{name:'暗影球',dmg:89,cost:8,type:'ghost',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'空間扭曲',dmg:131,cost:12,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:88,cost:4,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'光合作用強擊',dmg:81,cost:4,type:'grass',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:75,cost:3,type:'fairy',rider:'energy-steal'},{name:'鐵尾',dmg:198,cost:14,type:'steel',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:71,cost:3,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:63,cost:2,type:'steel',ignoreReflect:true,rider:'energy-steal'},{name:'碎岩',dmg:147,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'暗黑脈衝',dmg:192,cost:13,type:'dark',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'突擊',dmg:37,cost:1,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:109,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'魔法閃耀',dmg:159,cost:12,type:'fairy',selfHeal:0.22},{name:'蟲毒護甲擊',dmg:66,cost:3,type:'bug',rider:'energy-steal'}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'神速強奪擊',dmg:82,cost:3,type:'normal',ignoreReflect:true,rider:'card-steal'},{name:'夜斬',dmg:52,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'水槍',dmg:144,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:198,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'地震',dmg:100,cost:5,type:'ground',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'灼熱吸血擊',dmg:92,cost:5,type:'fire',rider:'type-draw'},{name:'衝撞',dmg:155,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:205,cost:14,type:'rock',ignoreReflect:true,selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'bug-domain', name:'蟲群支配', trigger:'onEnter', desc:'上場時場地切換為蟲群巢穴；蟲屬性攻擊傷害額外 +40'}, attacks:[{name:'冰霜威壓擊',dmg:157,cost:8,type:'ice',rider:'move-reflect'},{name:'金屬爪',dmg:53,cost:1,type:'steel',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'蟲咬',dmg:140,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:190,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'蟲咬',dmg:49,cost:0,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:44,cost:1,type:'grass',rider:'self-cure'},{name:'岩石封鎖',dmg:132,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'烈火強衝',dmg:180,cost:12,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25}}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'蟲毒護甲擊',dmg:73,cost:3,type:'bug',rider:'self-cure'},{name:'喊叫',dmg:64,cost:2,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'地震',dmg:150,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:195,cost:14,type:'ghost',selfHeal:0.25}]},
  ...
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'水槍',dmg:39,cost:3,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:95,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'暗影吸能擊',dmg:66,cost:5,type:'dark',rider:'energy-steal'},{name:'冰凍光束',dmg:97,cost:9,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  ...
  { id:407, name:'羅絲雷朵', type:'grass', type2:'poison', hp:270, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'激流吸血擊',dmg:58,cost:4,type:'water',ignoreReflect:true,rider:'life-drain'},{name:'魔法葉',dmg:99,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'毒粉刺',dmg:34,cost:3,type:'poison',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'噴火',dmg:141,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'飛葉快刀',dmg:14,cost:1,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:37,cost:3,type:'ghost',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'烈焰衝浪腳',dmg:133,cost:12,type:'fire',status:{effect:'burn', chance:0.25}},{name:'猛禽炸彈',dmg:147,cost:13,type:'flying',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'毒針',dmg:20,cost:0,type:'poison',ignoreReflect:true,status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:80,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'疾風威壓擊',dmg:67,cost:5,type:'flying',rider:'energy-steal'},{name:'地震',dmg:135,cost:11,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  { id:862, name:'堵攔熊', type:'dark', type2:'normal', hp:300, tier:2, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'夜斬',dmg:50,cost:4,type:'dark',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'高周波音',dmg:43,cost:3,type:'normal',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:141,cost:14,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'空間扭曲',dmg:142,cost:14,type:'dragon',selfHeal:0.2}]},
  ...
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'大地虹吸',dmg:64,cost:5,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'幽靈球',dmg:29,cost:2,type:'ghost',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'百萬針',dmg:150,cost:15,type:'bug',selfHeal:0.22},{name:'冰霜拳',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10045, type:'electric', type2:'dragon', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:181, name:'電龍', type:'electric',  hp:300, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:27,cost:2,type:'electric',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'衝撞',dmg:73,cost:6,type:'normal',megaBoost:true,bonusEnergy:6},{name:'冰霜護甲擊',dmg:134,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'精神護甲擊',dmg:138,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10316, type:'bug', type2:'steel', ability:{id:'solid-rock', name:'重甲化', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:768, name:'具甲武者', type:'bug', type2:'water', hp:290, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'大浪',dmg:23,cost:2,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'蟲咬',dmg:13,cost:1,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'聖焰',dmg:159,cost:13,type:'fire',selfHeal:0.17},{name:'雷光威壓擊',dmg:131,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'光合作用強擊',dmg:48,cost:4,type:'grass',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'灼熱吸血擊',dmg:55,cost:4,type:'fire',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:149,cost:15,type:'normal',status:{effect:'confusion', chance:0.25}},{name:'惡意突刺',dmg:144,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'雪崩',dmg:85,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:132,cost:11,type:'rock',ignoreReflect:true,selfHeal:0.24},{name:'毒液',dmg:132,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'光合作用強擊',dmg:48,cost:4,type:'grass',rider:'mega-charge',selfHeal:0.17}]},
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:12,cost:1,type:'psychic',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:14,cost:1,type:'electric',rider:'energy-steal'},{name:'幽冥威壓擊',dmg:140,cost:11,type:'ghost',selfHeal:0.2},{name:'冰耳光',dmg:147,cost:12,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10048, type:'dark', type2:'fire', ability:{id:'blaze-boost', name:'太陽之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:229, name:'黑魯加', type:'fire', type2:'dark', hp:280, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'惡意波動',dmg:12,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'火焰牙',dmg:85,cost:7,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'水之脈動',dmg:134,cost:12,type:'water',ignoreReflect:true,selfHeal:0.26},{name:'精神吸血擊',dmg:41,cost:3,type:'psychic',rider:'self-cure'}]},
  { id:464, name:'超甲狂犀', type:'ground', type2:'rock', hp:360, tier:3, ability:{id:'ground-domain', name:'風沙支配', trigger:'onEnter', desc:'上場時場地切換為沙塵暴；地面屬性攻擊傷害額外 +40'}, attacks:[{name:'角撞',dmg:141,cost:13,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:73,cost:6,type:'ground',selfHeal:0.18},{name:'岩崩',dmg:131,cost:11,type:'rock',status:{effect:'confusion', chance:0.25}},{name:'惡意突刺',dmg:13,cost:1,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.3}}]},
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:235, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'雪崩',dmg:161,cost:11,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:161,cost:12,type:'ground',selfHeal:0.28},{name:'啃咬',dmg:69,cost:3,type:'dark',ignoreReflect:true,status:{effect:'freeze', chance:0.15},selfHeal:0.25},{name:'毒針',dmg:64,cost:3,type:'poison',rider:'mega-charge',status:{effect:'poison', chance:0.3}}]},
  { id:625, name:'劈斬司令', type:'dark', type2:'steel', hp:295, tier:3, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'金屬爪',dmg:64,cost:10,type:'steel',megaBoost:true,bonusEnergy:5},{name:'夜斬',dmg:140,cost:12,type:'dark',ignoreReflect:true,selfHeal:0.16},{name:'水炮',dmg:12,cost:1,type:'water',rider:'mega-charge',selfHeal:0.23},{name:'念力衝擊',dmg:13,cost:1,type:'psychic',rider:'type-draw',selfHeal:0.3}]},
  ...
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:52,cost:1,type:'ghost',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'雷光吸能擊',dmg:81,cost:3,type:'electric',rider:'type-draw'},{name:'暗黑爆破',dmg:146,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'空間扭曲',dmg:189,cost:12,type:'psychic',ignoreReflect:true,selfHeal:0.19}]},
  { mega:{spriteId:10074, type:'ice', type2:null, ability:{id:'adaptability', name:'冰肌', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:362, name:'冰鬼護', type:'ice', hp:260, tier:2, ability:{id:'thick-fat', name:'冰凍之軀', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'冰耳光',dmg:38,cost:3,type:'ice',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'激流護甲擊',dmg:29,cost:2,type:'water',rider:'mega-charge'},{name:'鐵頭',dmg:90,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'暗黑爆破',dmg:136,cost:13,type:'dark',selfHeal:0.2}]},
  { mega:{spriteId:10089, type:'dragon', type2:'flying', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:373, name:'暴飛龍', type:'dragon', type2:'flying', hp:220, tier:3, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'咬碎',dmg:167,cost:11,type:'dark',megaBoost:true,bonusEnergy:6},{name:'龍之氣息',dmg:122,cost:6,type:'dragon',selfHeal:0.27},{name:'冰霜吸血擊',dmg:173,cost:12,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'燕返',dmg:46,cost:1,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10062, type:'dragon', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:380, name:'拉帝亞斯', type:'dragon', type2:'psychic', hp:320, tier:3, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'念力',dmg:83,cost:6,type:'psychic',megaBoost:true,bonusEnergy:4},{name:'龍之氣息',dmg:151,cost:12,type:'dragon',status:{effect:'sleep', chance:0.2}},{name:'魔法閃耀',dmg:151,cost:12,type:'fairy',status:{effect:'freeze', chance:0.15}},{name:'熔岩爆發',dmg:15,cost:1,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.25}}]},
  { mega:{spriteId:10063, type:'dragon', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:381, name:'拉帝歐斯', type:'dragon', type2:'psychic', hp:320, tier:3, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'龍之隕星',dmg:80,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'念力',dmg:136,cost:11,type:'psychic',status:{effect:'burn', chance:0.25}},{name:'冷凍光線',dmg:136,cost:11,type:'ice',selfHeal:0.23},{name:'地震',dmg:73,cost:6,type:'ground',selfHeal:0.16}]},
  ...
  { mega:{spriteId:10292, type:'grass', type2:'fighting', ability:{id:'solid-rock', name:'防彈', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:652, name:'布里卡隆', type:'grass', type2:'fighting', hp:300, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'藤鞭',dmg:27,cost:2,type:'grass',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'磚塊',dmg:35,cost:3,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'吼叫',dmg:134,cost:12,type:'normal',selfHeal:0.19},{name:'燕返',dmg:134,cost:13,type:'flying',selfHeal:0.16}]},
  ...
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:61,cost:0,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:87,cost:4,type:'electric',ignoreReflect:true,rider:'weaken'},{name:'突擊',dmg:136,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'日光束',dmg:184,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:78,cost:3,type:'psychic',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'大地吸能擊',dmg:48,cost:1,type:'ground',rider:'self-cure'},{name:'火花',dmg:151,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:208,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10297, type:'dark', type2:'psychic', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:687, name:'烏賊王', type:'dark', type2:'psychic', hp:260, tier:2, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'惡意波動',dmg:25,cost:2,type:'dark',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'精神強擊',dmg:95,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'神速護甲擊',dmg:38,cost:3,type:'normal',rider:'type-draw'},{name:'大地波動',dmg:131,cost:13,type:'ground',selfHeal:0.21}]},
  { mega:{spriteId:10298, type:'rock', type2:'fighting', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:689, name:'龜足巨鎧', type:'rock', type2:'water', hp:260, tier:2, ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'岩石滑落',dmg:43,cost:3,type:'rock',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'鋼影強奪擊',dmg:39,cost:3,type:'steel',rider:'type-draw'},{name:'衝浪',dmg:96,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'妖精吸能擊',dmg:140,cost:14,type:'fairy',ignoreReflect:true,selfHeal:0.21}]},
  { mega:{spriteId:10299, type:'poison', type2:'dragon', ability:{id:'thick-fat', name:'再生力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:691, name:'毒藻龍', type:'poison', type2:'dragon', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'惡意突刺',dmg:52,cost:4,type:'poison',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'破魂吸血擊',dmg:34,cost:3,type:'fighting',rider:'energy-steal'},{name:'逆鱗護甲擊',dmg:100,cost:9,type:'dragon',megaBoost:true,bonusEnergy:7},{name:'十字剪',dmg:142,cost:14,type:'bug',ignoreReflect:true,selfHeal:0.15}]},
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'空手劈',dmg:92,cost:5,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'大地威壓擊',dmg:58,cost:2,type:'ground',rider:'energy-steal'},{name:'疾風吸能擊',dmg:154,cost:10,type:'flying',megaBoost:true,bonusEnergy:8},{name:'惡意突刺',dmg:210,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10301, type:'dragon', type2:'ground', ability:{id:'solid-rock', name:'極巨腺體', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:718, name:'基格爾德', type:'dragon', type2:'ground', hp:360, tier:3, ability:{id:'solid-rock', name:'終結之地', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'咬碎',dmg:12,cost:1,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'大地虹吸',dmg:150,cost:13,type:'ground',status:{effect:'burn', chance:0.25}},{name:'電球',dmg:150,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'龍之波動',dmg:67,cost:5,type:'dragon',rider:'type-draw',selfHeal:0.21}]},
...
function doAttack(attacker, defender, atk, aBuff, dBuff, log, G, switchGuardMult = 1) {
  ...
  if (dBuff.reflect) {
    ...
    aBuff.atkBonus = 0; aBuff.atkMult = 1; aBuff.typeOverride = null; aBuff.doubleStrike = false; aBuff.typeBoost = null; aBuff.ignoreShield = false; aBuff.guaranteedStatus = false; aBuff.costFreeType = null; aBuff.costHalved = false; aBuff.ignoreReflectNext = false; dBuff.shield = 0; dBuff.iceImmune = false;
  ...
  if (mult === 0) {
    ...
    const rollStatus = () => {
      ...
      if (damage > 0 && atk.status && defender.cur > 0 && G[`${dRole}StatusImmuneTurns`] > 0) {
        log.push({ text: `${defender.name} 的妖精結界抵擋了異常狀態！`, cls: 'special' });
        return;
      }
      if (damage > 0 && atk.status && defender.cur > 0 && defenderAbility?.id === 'status-immune-once' && !defender._temperedHeart) {
    ...
    if (damage > 0 && atk.rider) {
      switch (atk.rider) {
        case 'energy-steal':
          G[`${dRole}Energy`] = Math.max(0, (G[`${dRole}Energy`] || 0) - 5);
          G[`${aRole}Energy`] = Math.min(20, (G[`${aRole}Energy`] || 0) + 3);
          log.push({ text: `${attacker.name} 吸取了對方 5 點能量，自身回復 3 點能量！`, cls: 'special' });
          break;
        case 'guard-up':
          aBuff.shield += 50;
...
function applyTrainer(card, role, G, log, chosenType) {
  ...
  switch (card.id) {
    ...
    case 'ice-howl': {
      const opActive = G[`${op}Deck`][G[`${op}Idx`]];
      if (Math.random() < 0.35 && inflictStatus(opActive, 'freeze', 2)) {
