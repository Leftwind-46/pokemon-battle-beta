...
const POKEMON = [
  ...
  { mega:{spriteId:10038, type:'ghost', type2:'poison', ability:{id:'frisk-ward', name:'踩影', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:94,  name:'耿鬼',       type:'ghost',    type2:'poison',  hp:220, tier:1, ability:{id:'poison-heal', name:'毒療', trigger:'onStatus', desc:'中毒時每回合回復 1/8 最大HP，而非扣血'}, attacks:[{name:'催眠術',dmg:59,cost:3,type:'psychic',status:{effect:'sleep', chance:0.5},megaBoost:true,bonusEnergy:6},{name:'幽靈之爪',dmg:60,cost:3,type:'ghost',status:{effect:'poison', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'暗影球',dmg:98,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'影舞',cost:2,type:'ghost',support:true,effect:'shadow-dance'}]},
  ...
  { mega:{spriteId:10037, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:65,  name:'胡地',       type:'psychic',  hp:200, tier:1, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'超能力',dmg:56,cost:1,type:'psychic',status:{effect:'confusion', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'念力',dmg:55,cost:0,type:'psychic',status:{effect:'confusion', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:85,cost:6,type:'ghost',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'psychic',support:true,effect:'trick'}]},
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'衝撞',dmg:50,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:50,cost:1,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:100,cost:6,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'electric',support:true,effect:'brace'}]},
  ...
  { id:87,  name:'白海獅',     type:'water',    type2:'ice',     hp:240, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.02'}, attacks:[{name:'冷凍光線',dmg:51,cost:3,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'集氣',cost:3,type:'water',support:true,effect:'focus-energy',bonusEnergy:9},{name:'大浪',dmg:83,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:123,cost:11,type:'water',status:{effect:'confusion', chance:0.25}}]},
  { id:82,  name:'三合一磁怪',   type:'electric', type2:'steel',   hp:210, tier:1, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 ×1.05'}, attacks:[{name:'電磁炮',dmg:54,cost:2,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'集氣',cost:3,type:'electric',support:true,effect:'focus-energy',bonusEnergy:9},{name:'電磁衝浪',dmg:90,cost:8,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'閃光炮',dmg:131,cost:12,type:'steel',selfHeal:0.18}]},
  { id:28,  name:'穿山王',     type:'ground',   hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'灼熱',cost:1,type:'ground',support:true,effect:'debuff',status:{effect:'burn', chance:1}},{name:'地震',dmg:83,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'岩石碎裂',dmg:80,cost:6,type:'rock',megaBoost:true,bonusEnergy:4},{name:'岩石滑落',dmg:120,cost:11,type:'rock',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10294, type:'water', type2:'dark', ability:{id:'adaptability', name:'變幻自如', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:658, name:'甲賀忍蛙',       type:'water',    type2:'dark',    hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水手裏劍',dmg:56,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'夜斬',dmg:62,cost:3,type:'dark',megaBoost:true,bonusEnergy:6},{name:'暗影球',dmg:99,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'電磁波',cost:1,type:'water',support:true,effect:'debuff',status:{effect:'paralysis', chance:1}}]},
  // Tier 2
  ...
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'磚塊',dmg:105,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'連踢',dmg:150,cost:15,type:'normal',selfHeal:0.25},{name:'地震',dmg:149,cost:15,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'破壞光線',dmg:150,cost:15,type:'normal',selfHeal:0.29}]},
  ...
  // Tier 3
  { id:383, name:'固拉多',     type:'ground',   hp:340, tier:3, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 ×1.05'}, attacks:[{name:'地震',dmg:88,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:131,cost:13,type:'rock',selfHeal:0.22},{name:'火焰噴射',dmg:132,cost:13,type:'fire',status:{effect:'confusion', chance:0.25}},{name:'原始大地',dmg:135,cost:13,type:'fire',selfHeal:0.26}]},
  { id:382, name:'蓋歐卡',     type:'water',    hp:340, tier:3, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 ×1.05'}, attacks:[{name:'源起之波',dmg:86,cost:7,type:'water',megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:110,cost:7,type:'electric',status:{effect:'burn', chance:0.25}},{name:'大浪',dmg:128,cost:12,type:'water',selfHeal:0.16},{name:'原始海洋',dmg:127,cost:13,type:'ice',selfHeal:0.21}]},
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'神速',dmg:99,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:139,cost:14,type:'fire',status:{effect:'freeze', chance:0.15}},{name:'怒風',dmg:138,cost:14,type:'flying',status:{effect:'poison', chance:0.3}},{name:'龍之隕星',dmg:139,cost:14,type:'dragon',status:{effect:'burn', chance:0.25}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:103,cost:9,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'龍息',dmg:148,cost:14,type:'dragon',selfHeal:0.17},{name:'電磁炮',dmg:148,cost:14,type:'electric',status:{effect:'poison', chance:0.3}},{name:'未來雷霆',dmg:145,cost:15,type:'psychic',selfHeal:0.23}]},
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'聖焰',dmg:93,cost:8,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'怒風',dmg:134,cost:13,type:'flying',status:{effect:'paralysis', chance:0.2}},{name:'超能力',dmg:138,cost:13,type:'psychic',selfHeal:0.27},{name:'神聖之焰',dmg:132,cost:13,type:'flying',selfHeal:0.2}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'怒風',dmg:92,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:137,cost:13,type:'ice',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:137,cost:13,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'心靈衝擊',dmg:134,cost:13,type:'psychic',status:{effect:'freeze', chance:0.15}}]},
  { id:1007,name:'故勒頓',     type:'fighting', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'緋紅脈動', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'決勝衝擊',dmg:99,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:143,cost:14,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:143,cost:14,type:'ground',status:{effect:'sleep', chance:0.2}},{name:'遠古之力',dmg:146,cost:14,type:'rock',selfHeal:0.3}]},
  ...
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'暴風雪',dmg:96,cost:8,type:'ice',status:{effect:'freeze', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'冷凍光線',dmg:135,cost:13,type:'ice',status:{effect:'sleep', chance:0.2}},{name:'暴風',dmg:138,cost:13,type:'flying',selfHeal:0.22},{name:'怒風',dmg:139,cost:14,type:'flying',selfHeal:0.25}]},
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:87,cost:8,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'電磁衝浪',dmg:135,cost:13,type:'electric',status:{effect:'sleep', chance:0.2}},{name:'雷電',dmg:129,cost:13,type:'electric',selfHeal:0.25},{name:'怒風',dmg:135,cost:12,type:'flying',status:{effect:'paralysis', chance:0.2}}]},
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'火焰衝擊',dmg:96,cost:8,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:133,cost:13,type:'psychic',selfHeal:0.16},{name:'噴射火焰',dmg:136,cost:13,type:'fire',status:{effect:'paralysis', chance:0.2}},{name:'怒風',dmg:135,cost:13,type:'flying',selfHeal:0.28}]},
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'huge-power', name:'不撓之劍', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}, attacks:[{name:'鐵頭功',dmg:105,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'剛劍',dmg:150,cost:15,type:'steel',selfHeal:0.19},{name:'接近戰',dmg:150,cost:15,type:'fighting',selfHeal:0.21},{name:'神秘劍',dmg:150,cost:14,type:'fairy',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:330, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'月亮力量',dmg:90,cost:7,type:'fairy',megaBoost:true,bonusEnergy:5},{name:'仙子之息',dmg:131,cost:12,type:'fairy',status:{effect:'paralysis', chance:0.2}},{name:'光之波動',dmg:129,cost:12,type:'fairy',status:{effect:'freeze', chance:0.15}},{name:'精神強擊',dmg:132,cost:12,type:'psychic',selfHeal:0.15}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'暴風雪',dmg:104,cost:10,type:'ice',status:{effect:'freeze', chance:0.2},megaBoost:true,bonusEnergy:8},{name:'閃光炮',dmg:149,cost:15,type:'steel',status:{effect:'paralysis', chance:0.2}},{name:'冰耳光',dmg:148,cost:14,type:'ice',status:{effect:'confusion', chance:0.25}},{name:'電磁砲',dmg:145,cost:15,type:'electric',status:{effect:'burn', chance:0.25}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:350, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'朽滅之歌',dmg:142,cost:14,type:'flying',selfHeal:0.16},{name:'空氣斬',dmg:138,cost:14,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'夜騷動',dmg:142,cost:14,type:'dark',selfHeal:0.26}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'閃光炮',dmg:101,cost:9,type:'steel',megaBoost:true,bonusEnergy:7},{name:'鋼鐵翼',dmg:145,cost:14,type:'steel',selfHeal:0.19},{name:'龍爪',dmg:144,cost:14,type:'dragon',selfHeal:0.21},{name:'時間咆哮',dmg:145,cost:14,type:'dragon',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:360, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'衝浪',dmg:101,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:143,cost:14,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'水之脈動',dmg:142,cost:14,type:'water',selfHeal:0.25},{name:'空間扭曲',dmg:147,cost:14,type:'dragon',selfHeal:0.15}]},
  ...
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:52,cost:1,type:'normal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'normal',support:true,effect:'brace'},{name:'地震',dmg:81,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'強力碰撞',dmg:126,cost:12,type:'normal',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'噴火',dmg:82,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:80,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:120,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'纏繞',dmg:55,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:53,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:80,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'集氣',cost:3,type:'water',support:true,effect:'focus-energy',bonusEnergy:9},{name:'毒液',dmg:62,cost:4,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:7},{name:'衝浪',dmg:100,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'水砲',dmg:142,cost:14,type:'water',status:{effect:'burn', chance:0.25}}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'毒粉',cost:1,type:'fighting',support:true,effect:'debuff',status:{effect:'poison', chance:1}},{name:'突擊',dmg:69,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:104,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:149,cost:14,type:'fighting',selfHeal:0.27}]},
  ...
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'燕返',dmg:54,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'衝撞',dmg:81,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'勇鳥猛衝',dmg:123,cost:12,type:'flying',selfHeal:0.25}]},
  ...
  { id:469, name:'遠古巨蜓',   type:'bug',      type2:'flying',  hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'空氣斬',dmg:65,cost:4,type:'flying',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'蟲鳴',dmg:100,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'颶風',dmg:145,cost:14,type:'flying',selfHeal:0.25}]},
  ...
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影爪',dmg:60,cost:3,type:'ghost',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:60,cost:3,type:'ice',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:94,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'詭計',cost:3,type:'ghost',support:true,effect:'trick'}]},
  ...
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}, attacks:[{name:'夜斬',dmg:58,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'追影斬',dmg:57,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'冥想',cost:3,type:'dark',support:true,effect:'meditate'},{name:'暗黑脈衝',dmg:136,cost:14,type:'dark',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.06'}, attacks:[{name:'連續攻擊',dmg:56,cost:3,type:'normal',megaBoost:true,bonusEnergy:6},{name:'影舞',cost:2,type:'fighting',support:true,effect:'shadow-dance'},{name:'居合斬',dmg:93,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:131,cost:13,type:'fighting',selfHeal:0.18}]},
  ...
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'冥想',cost:3,type:'water',support:true,effect:'meditate'},{name:'夜斬',dmg:58,cost:1,type:'dark',megaBoost:true,bonusEnergy:5},{name:'亂爪',dmg:87,cost:8,type:'dark',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:132,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'砂子攻擊',dmg:66,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'小偷',cost:5,type:'normal',support:true,effect:'thief'},{name:'地震',dmg:104,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:146,cost:14,type:'rock',selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 ×1.04'}, attacks:[{name:'撐住',cost:5,type:'steel',support:true,effect:'brace'},{name:'金屬爪',dmg:58,cost:1,type:'steel',megaBoost:true,bonusEnergy:5},{name:'鋼鐵頭',dmg:83,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'蟲之抵抗',dmg:125,cost:12,type:'bug',status:{effect:'paralysis', chance:0.2}}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 ×1.04'}, attacks:[{name:'蟲咬',dmg:53,cost:0,type:'bug',megaBoost:true,bonusEnergy:4},{name:'灼熱',cost:1,type:'bug',support:true,effect:'debuff',status:{effect:'burn', chance:1}},{name:'岩石封鎖',dmg:85,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'X 剪刀',dmg:125,cost:12,type:'bug',status:{effect:'burn', chance:0.25}}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.06'}, attacks:[{name:'集氣',cost:3,type:'ground',support:true,effect:'focus-energy',bonusEnergy:9},{name:'喊叫',dmg:55,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:96,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'骨棒',dmg:133,cost:14,type:'ground',selfHeal:0.25}]},
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'夜襲',dmg:64,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'念力',dmg:64,cost:4,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:104,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'灼熱',cost:1,type:'rock',support:true,effect:'debuff',status:{effect:'burn', chance:1}}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.02'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'音爆拳',dmg:57,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:89,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:128,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.06'}, attacks:[{name:'咬住',dmg:51,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'吼叫',dmg:80,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'normal',support:true,effect:'trick'},{name:'火焰牙',dmg:82,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  ...
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'針刺',dmg:50,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'毒針',dmg:57,cost:1,type:'poison',megaBoost:true,bonusEnergy:5},{name:'十字剪',dmg:86,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'bug',support:true,effect:'brace'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'金屬音',dmg:56,cost:3,type:'steel',megaBoost:true,bonusEnergy:6},{name:'頭槌',dmg:57,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:90,cost:8,type:'rock',megaBoost:true,bonusEnergy:6},{name:'撐住',cost:5,type:'rock',support:true,effect:'brace'}]},
  ...
  { id:464, name:'超甲狂犀', type:'ground', type2:'rock', hp:360, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'角撞',dmg:100,cost:10,type:'normal',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:146,cost:14,type:'ground',selfHeal:0.18},{name:'岩崩',dmg:146,cost:14,type:'rock',status:{effect:'confusion', chance:0.25}},{name:'地震',dmg:141,cost:14,type:'ground',status:{effect:'poison', chance:0.3}}]},
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:350, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'冰凍拳',dmg:96,cost:8,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:139,cost:14,type:'ground',selfHeal:0.28},{name:'雪崩',dmg:139,cost:14,type:'ice',selfHeal:0.25},{name:'冰牙',dmg:138,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  { id:625, name:'劈斬司令', type:'dark', type2:'steel', hp:330, tier:3, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.06'}, attacks:[{name:'金屬爪',dmg:85,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'夜斬',dmg:127,cost:13,type:'dark',selfHeal:0.16},{name:'惡意突刺',dmg:125,cost:12,type:'dark',selfHeal:0.23},{name:'鐵頭功',dmg:130,cost:12,type:'steel',selfHeal:0.3}]},
  /* ── Mega 進化擴充（Legends Z-A / 原有 46 種缺漏補完） ── */
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:51,cost:2,type:'flying',megaBoost:true,bonusEnergy:6},{name:'疾風拳',dmg:52,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:91,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'}]},
  ...
  { mega:{spriteId:10040, type:'bug', type2:'flying', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:127, name:'凱羅斯', type:'bug', hp:210, tier:1, ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}, attacks:[{name:'斷頭台',dmg:50,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'劍舞',cost:4,type:'bug',support:true,effect:'sword-dance'},{name:'角撞',dmg:89,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'石頭砸落',dmg:132,cost:13,type:'rock',status:{effect:'confusion', chance:0.25}}]},
  ...
  { mega:{spriteId:10066, type:'dark', type2:'ghost', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:302, name:'勾魂眼', type:'dark', type2:'ghost', hp:200, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:58,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'dark',support:true,effect:'thief'},{name:'寶石爆破',dmg:84,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:124,cost:12,type:'dark',selfHeal:0.25}]},
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'啃咬',dmg:51,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:54,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'steel',support:true,effect:'trick'},{name:'重磅衝撞',dmg:121,cost:11,type:'steel',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}, attacks:[{name:'空手劈',dmg:56,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:59,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'fighting',support:true,effect:'thief'},{name:'惡意彈珠',dmg:126,cost:12,type:'dark',selfHeal:0.3}]},
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:70,cost:5,type:'electric',megaBoost:true,bonusEnergy:8},{name:'集氣',cost:3,type:'electric',support:true,effect:'focus-energy',bonusEnergy:9},{name:'十萬伏特',dmg:103,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'火焰牙',dmg:147,cost:15,type:'fire',selfHeal:0.26}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 ×1.06'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水槍',dmg:65,cost:4,type:'water',megaBoost:true,bonusEnergy:7},{name:'小偷',cost:5,type:'water',support:true,effect:'thief'},{name:'衝浪',dmg:102,cost:10,type:'water',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:147,cost:14,type:'ice',selfHeal:0.18}]},
  ...
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:59,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'集氣',cost:3,type:'ghost',support:true,effect:'focus-energy',bonusEnergy:9},{name:'暗黑爆破',dmg:88,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:124,cost:12,type:'psychic',selfHeal:0.19}]},
  ...
  { mega:{spriteId:10089, type:'dragon', type2:'flying', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:373, name:'暴飛龍', type:'dragon', type2:'flying', hp:340, tier:3, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'咬碎',dmg:95,cost:8,type:'dark',megaBoost:true,bonusEnergy:6},{name:'龍息',dmg:138,cost:13,type:'dragon',selfHeal:0.27},{name:'逆鱗',dmg:135,cost:13,type:'dragon',status:{effect:'freeze', chance:0.15}},{name:'暴風',dmg:135,cost:13,type:'flying',status:{effect:'confusion', chance:0.25}}]},
  ...
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'連續拳',dmg:56,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速星星拳',dmg:53,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速旋轉踢',dmg:95,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'電磁波',cost:1,type:'normal',support:true,effect:'debuff',status:{effect:'paralysis', chance:1}}]},
  ...
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:51,cost:2,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'小偷',cost:5,type:'psychic',support:true,effect:'thief'},{name:'未來預知',dmg:89,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:129,cost:13,type:'normal',selfHeal:0.25}]},
  { mega:{spriteId:10311, type:'fire', type2:'steel', ability:{id:'blaze-boost', name:'熾熱核心', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:485, name:'席多藍恩', type:'fire', type2:'steel', hp:330, tier:3, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'金屬爪',dmg:85,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'熔岩爆發',dmg:125,cost:12,type:'fire',selfHeal:0.18},{name:'大字爆炎',dmg:129,cost:12,type:'fire',status:{effect:'poison', chance:0.3}},{name:'隕石衝擊',dmg:130,cost:12,type:'rock',status:{effect:'confusion', chance:0.25}}]},
  ...
  { mega:{spriteId:10289, type:'dark', type2:'fighting', ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:560, name:'頭巾混混', type:'dark', type2:'fighting', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 ×1.04'}, attacks:[{name:'小偷',cost:5,type:'dark',support:true,effect:'thief'},{name:'惡意彈珠',dmg:83,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:81,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:125,cost:11,type:'dark',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:52,cost:0,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'劍舞',cost:4,type:'fairy',support:true,effect:'sword-dance'},{name:'月亮之力',dmg:80,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'葉暴風',dmg:120,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:61,cost:3,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'毒粉',cost:1,type:'psychic',support:true,effect:'debuff',status:{effect:'poison', chance:1}},{name:'未來預知',dmg:97,cost:9,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:144,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.06'}, attacks:[{name:'空手劈',dmg:69,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'近身戰',dmg:103,cost:10,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:150,cost:15,type:'flying',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10301, type:'dragon', type2:'ground', ability:{id:'solid-rock', name:'極巨腺體', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:718, name:'基格爾德', type:'dragon', type2:'ground', hp:360, tier:3, ability:{id:'solid-rock', name:'終結之地', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'咬碎',dmg:104,cost:10,type:'dark',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:149,cost:15,type:'ground',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:146,cost:15,type:'ground',status:{effect:'paralysis', chance:0.2}},{name:'龍爪',dmg:144,cost:14,type:'dragon',selfHeal:0.21}]},
  ...
  { mega:{spriteId:10303, type:'fighting', type2:null, ability:{id:'guts', name:'不服輸', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.06'}}, id:870, name:'列陣兵', type:'fighting', hp:230, tier:1, ability:{id:'sturdy', name:'戰鬥盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'空手劈',dmg:68,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'詭計',cost:3,type:'fighting',support:true,effect:'trick'},{name:'近身戰',dmg:103,cost:10,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'超強衝擊',dmg:150,cost:15,type:'fighting',selfHeal:0.18}]},
  { mega:{spriteId:10320, type:'grass', type2:'fire', ability:{id:'blaze-boost', name:'辣椒噴霧', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:952, name:'狠辣椒', type:'grass', type2:'fire', hp:220, tier:1, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'藤鞭',dmg:60,cost:2,type:'grass',megaBoost:true,bonusEnergy:6},{name:'冥想',cost:3,type:'grass',support:true,effect:'meditate'},{name:'葉刃',dmg:88,cost:8,type:'grass',megaBoost:true,bonusEnergy:6},{name:'大字爆炎',dmg:132,cost:12,type:'fire',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { mega:{spriteId:10322, type:'dragon', type2:'water', ability:{id:'huge-power', name:'指揮', trigger:'onAttack', desc:'攻擊傷害固定 ×1.05'}}, id:978, name:'米立龍', type:'dragon', type2:'water', hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.02'}, attacks:[{name:'水槍',dmg:60,cost:1,type:'water',megaBoost:true,bonusEnergy:5},{name:'龍之氣息',dmg:54,cost:1,type:'dragon',megaBoost:true,bonusEnergy:5},{name:'影舞',cost:2,type:'dragon',support:true,effect:'shadow-dance'},{name:'龍之波動',dmg:129,cost:11,type:'dragon',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10325, type:'dragon', type2:'ice', ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.06'}}, id:998, name:'戟脊龍', type:'dragon', type2:'ice', hp:340, tier:3, ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.06'}, attacks:[{name:'冰霜拳',dmg:89,cost:8,type:'ice',megaBoost:true,bonusEnergy:6},{name:'龍息',dmg:130,cost:13,type:'dragon',status:{effect:'confusion', chance:0.25}},{name:'冰凍光束',dmg:133,cost:12,type:'ice',selfHeal:0.23},{name:'逆鱗',dmg:129,cost:12,type:'dragon',selfHeal:0.17}]},
];
const EFF = {
