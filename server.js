...
const POKEMON = [
  ...
  { id:700, name:'仙子伊布',   type:'fairy',    hp:300, tier:2, ability:{id:'fairy-domain', name:'妖精支配', trigger:'onEnter', desc:'上場時場地切換為妖精結界原野；妖精屬性攻擊傷害額外 +40'}, attacks:[{name:'妖精風',dmg:61,cost:3,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:95,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'毒牙',dmg:141,cost:13,type:'poison',status:{effect:'poison', chance:0.3}},{name:'暗影球',dmg:137,cost:14,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'冰凍光束',dmg:51,cost:0,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'怒風',dmg:82,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'幽靈之爪',dmg:122,cost:11,type:'ghost',status:{effect:'sleep', chance:0.2}},{name:'激流威壓擊',dmg:24,cost:3,type:'water',rider:'weaken'}]},
  ...
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'夜斬',dmg:61,cost:3,type:'dark',megaBoost:true,bonusEnergy:6},{name:'暴風',dmg:100,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'催眠術',dmg:145,cost:14,type:'psychic',selfHeal:0.22},{name:'毒粉刺',dmg:139,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:466, name:'電擊魔獸',   type:'electric', hp:300, tier:2, ability:{id:'electric-domain', name:'雷霆支配', trigger:'onEnter', desc:'上場時場地切換為雷雲庇護所；電屬性攻擊傷害額外 +40'}, attacks:[{name:'電磁衝浪',dmg:56,cost:3,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'動感拳',dmg:96,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:138,cost:14,type:'psychic',selfHeal:0.18},{name:'冰凍拳',dmg:138,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  ...
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'flying-domain', name:'疾風支配', trigger:'onEnter', desc:'上場時場地切換為疾風之翼；飛行屬性攻擊傷害額外 +40'}, attacks:[{name:'怒風',dmg:56,cost:3,type:'flying',status:{effect:'paralysis', chance:0.2}},{name:'聖焰',dmg:93,cost:8,type:'fire',status:{effect:'burn', chance:0.3}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'空間扭曲',dmg:140,cost:13,type:'dragon',selfHeal:0.22}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'念力',dmg:55,cost:3,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:92,cost:8,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:88,cost:9,type:'ice',rider:'guard-up'},{name:'幽靈球',dmg:138,cost:13,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:305, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'妖精之風',dmg:57,cost:3,type:'fairy'},{name:'閃電拳',dmg:94,cost:8,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'飛葉快刀',dmg:90,cost:9,type:'grass',rider:'card-steal'},{name:'冰耳光',dmg:139,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:265, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'惡意波動',dmg:58,cost:3,type:'dark'},{name:'空氣斬',dmg:91,cost:8,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'大地虹吸',dmg:85,cost:9,type:'ground',rider:'life-drain'},{name:'幽靈球',dmg:141,cost:13,type:'ghost',selfHeal:0.25}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:76,cost:12,type:'steel',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:95,cost:10,type:'dragon',selfHeal:0.19},{name:'閃電拳',dmg:81,cost:5,type:'electric',selfHeal:0.21},{name:'幽靈球',dmg:95,cost:10,type:'ghost',selfHeal:0.2}]},
  ...
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, ability:{id:'dark-domain', name:'暗夜支配', trigger:'onEnter', desc:'上場時場地切換為暗夜詛咒領域；惡屬性攻擊傷害額外 +40'}, attacks:[{name:'火焰噴射',dmg:59,cost:3,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'暗黑強打',dmg:95,cost:9,type:'dark',megaBoost:true,bonusEnergy:7},{name:'超強衝擊',dmg:135,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}},{name:'劇毒威壓擊',dmg:138,cost:13,type:'poison',selfHeal:0.2}]},
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:62,cost:1,type:'normal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:31,cost:5,type:'fire',rider:'life-drain'},{name:'地震',dmg:97,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'惡意波動',dmg:151,cost:12,type:'dark',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'疾風威壓擊',dmg:32,cost:3,type:'flying',rider:'weaken'},{name:'噴火',dmg:98,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:96,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:144,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電球',dmg:59,cost:2,type:'electric',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'能量球',dmg:91,cost:8,type:'grass',status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:89,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'神速吸能擊',dmg:26,cost:3,type:'normal',rider:'energy-steal'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:66,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:64,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'砂子攻擊',dmg:96,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:12,cost:5,type:'steel',rider:'guard-up'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'蟲毒強奪擊',dmg:29,cost:3,type:'bug',rider:'card-steal'},{name:'毒液',dmg:74,cost:4,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:7},{name:'衝浪',dmg:120,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:170,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'妖精吸血擊',dmg:22,cost:1,type:'fairy',rider:'life-drain'},{name:'突擊',dmg:83,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:125,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'劇毒威壓擊',dmg:179,cost:14,type:'poison',selfHeal:0.27}]},
  { id:553, name:'流氓鱷',     type:'ground',   type2:'dark',    hp:270, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'岩石滑落',dmg:69,cost:4,type:'rock',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:7},{name:'激流威壓擊',dmg:38,cost:3,type:'water',rider:'weaken'},{name:'地震',dmg:102,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'夜斬',dmg:147,cost:14,type:'dark',selfHeal:0.24}]},
  ...
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'神速吸能擊',dmg:65,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'暴風',dmg:97,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:50,cost:8,type:'grass',rider:'energy-steal'},{name:'夜騷動',dmg:148,cost:12,type:'dark',selfHeal:0.25}]},
  ...
  { mega:{spriteId:10047, type:'bug', type2:'fighting', ability:{id:'huge-power', name:'連續攻擊', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:214, name:'赫拉克羅斯', type:'bug',      type2:'fighting',hp:270, tier:2, ability:{id:'guts', name:'毅力', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'妖精強奪擊',dmg:33,cost:1,type:'fairy',rider:'card-steal'},{name:'地震',dmg:98,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'聖甲蟲衝擊',dmg:102,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:143,cost:14,type:'fighting',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10046, type:'bug', type2:'steel', ability:{id:'technician', name:'技術高手', trigger:'onAttack', desc:'威力 60 以下的招式，傷害 ×1.1'}}, id:212, name:'巨鉗螳螂',   type:'bug',      type2:'steel',   hp:260, tier:2, ability:{id:'blaze-boost', name:'蟲之預感', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'疾風吸血擊',dmg:38,cost:2,type:'flying',rider:'life-drain'},{name:'子彈拳',dmg:89,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'蟲刃剪',dmg:89,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'破魂吸血擊',dmg:130,cost:12,type:'fighting',selfHeal:0.23}]},
  ...
  { id:526, name:'龐岩怪',     type:'rock',                      hp:280, tier:2, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:52,cost:1,type:'steel',megaBoost:true,bonusEnergy:5},{name:'逆鱗護甲擊',dmg:28,cost:3,type:'dragon',rider:'guard-up'},{name:'地震',dmg:121,cost:12,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'岩石炮',dmg:120,cost:11,type:'rock',status:{effect:'poison', chance:0.3}}]},
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'暗影爪',dmg:72,cost:3,type:'ghost',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:72,cost:3,type:'ice',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'月亮力量',dmg:113,cost:8,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:11,cost:3,type:'flying',rider:'card-steal'}]},
  { mega:{spriteId:10291, type:'ghost', type2:'fire', ability:{id:'frisk-ward', name:'穿透', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:609, name:'水晶燈火靈', type:'ghost',    type2:'fire',    hp:260, tier:2, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'冰霜吸血擊',dmg:22,cost:5,type:'ice',rider:'life-drain'},{name:'噴火',dmg:86,cost:7,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:5},{name:'暗影爪',dmg:89,cost:8,type:'ghost',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'精神強擊',dmg:128,cost:12,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:70,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'光合作用強擊',dmg:68,cost:4,type:'grass',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:27,cost:3,type:'fairy',rider:'weaken'},{name:'鐵頭',dmg:163,cost:14,type:'steel',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:67,cost:3,type:'normal',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:33,cost:2,type:'steel',rider:'energy-steal'},{name:'居合斬',dmg:112,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'暗黑脈衝',dmg:157,cost:13,type:'dark',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'壓制',dmg:55,cost:1,type:'normal',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:84,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'魔法閃耀',dmg:125,cost:12,type:'fairy',selfHeal:0.22},{name:'蟲毒護甲擊',dmg:27,cost:3,type:'bug',rider:'guard-up'}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'神速強奪擊',dmg:23,cost:3,type:'normal',rider:'card-steal'},{name:'夜斬',dmg:70,cost:1,type:'dark',megaBoost:true,bonusEnergy:5},{name:'水手裏劍',dmg:104,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:158,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'砂子攻擊',dmg:79,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'灼熱吸血擊',dmg:34,cost:5,type:'fire',rider:'life-drain'},{name:'高周波音',dmg:125,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:175,cost:14,type:'rock',selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'bug-domain', name:'蟲群支配', trigger:'onEnter', desc:'上場時場地切換為蟲群巢穴；蟲屬性攻擊傷害額外 +40'}, attacks:[{name:'冰霜威壓擊',dmg:11,cost:5,type:'ice',rider:'weaken'},{name:'金屬爪',dmg:70,cost:1,type:'steel',megaBoost:true,bonusEnergy:5},{name:'蟲鳴',dmg:100,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:150,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'蟲咬',dmg:64,cost:0,type:'bug',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:10,cost:1,type:'grass',rider:'energy-steal'},{name:'岩石封鎖',dmg:102,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'烈火強衝',dmg:150,cost:12,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'蟲毒護甲擊',dmg:11,cost:3,type:'bug',rider:'guard-up'},{name:'喊叫',dmg:66,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:115,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:160,cost:14,type:'ghost',selfHeal:0.25}]},
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'夜襲',dmg:77,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'念力',dmg:77,cost:4,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:125,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'疾風強奪擊',dmg:33,cost:1,type:'flying',rider:'card-steal'}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'岩崩吸血擊',dmg:17,cost:3,type:'rock',rider:'life-drain'},{name:'音爆拳',dmg:68,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:107,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:154,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'咬住',dmg:61,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'龍之隕星',dmg:96,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'破魂威壓擊',dmg:11,cost:3,type:'fighting',rider:'weaken'},{name:'火焰牙',dmg:98,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'水槍',dmg:54,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'迴旋踢',dmg:95,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'暗影吸能擊',dmg:16,cost:5,type:'dark',rider:'energy-steal'},{name:'冰凍光束',dmg:97,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'針刺',dmg:60,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'毒針',dmg:68,cost:1,type:'poison',megaBoost:true,bonusEnergy:5},{name:'閃電拳',dmg:103,cost:7,type:'electric',megaBoost:true,bonusEnergy:5},{name:'冰霜護甲擊',dmg:19,cost:5,type:'ice',rider:'guard-up'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'金屬音',dmg:67,cost:3,type:'steel',megaBoost:true,bonusEnergy:6},{name:'頭槌',dmg:68,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:108,cost:8,type:'rock',megaBoost:true,bonusEnergy:6},{name:'妖精強奪擊',dmg:21,cost:5,type:'fairy',rider:'card-steal'}]},
  ...
  { id:407, name:'羅絲雷朵', type:'grass', type2:'poison', hp:270, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'激流吸血擊',dmg:31,cost:4,type:'water',rider:'life-drain'},{name:'魔法葉',dmg:99,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'毒粉刺',dmg:99,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'噴火',dmg:141,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'飛葉快刀',dmg:50,cost:1,type:'grass',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:90,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'烈焰衝浪腳',dmg:133,cost:12,type:'fire',status:{effect:'burn', chance:0.25}},{name:'暴風',dmg:128,cost:13,type:'flying',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'毒針',dmg:54,cost:0,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:80,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'疾風威壓擊',dmg:27,cost:5,type:'flying',rider:'weaken'},{name:'骨棒',dmg:120,cost:11,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  { id:862, name:'堵攔熊', type:'dark', type2:'normal', hp:300, tier:2, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'夜斬',dmg:62,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'連續切',dmg:98,cost:8,type:'normal',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:141,cost:14,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'空間扭曲',dmg:142,cost:14,type:'dragon',selfHeal:0.2}]},
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'蟲咬',dmg:64,cost:4,type:'bug',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:99,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'幽冥威壓擊',dmg:96,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'妖精吸能擊',dmg:25,cost:5,type:'fairy',rider:'energy-steal'}]},
  ...
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'水槍',dmg:70,cost:5,type:'water',megaBoost:true,bonusEnergy:8},{name:'念力',dmg:104,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'蟲毒護甲擊',dmg:33,cost:3,type:'bug',rider:'guard-up'},{name:'近身戰',dmg:150,cost:15,type:'fighting',selfHeal:0.15}]},
  { mega:{spriteId:10045, type:'electric', type2:'dragon', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:181, name:'電龍', type:'electric',  hp:300, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:55,cost:2,type:'electric',megaBoost:true,bonusEnergy:6},{name:'電光一閃',dmg:90,cost:8,type:'normal',megaBoost:true,bonusEnergy:6},{name:'冰霜護甲擊',dmg:134,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'精神護甲擊',dmg:138,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  ...
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'魔法葉',dmg:68,cost:4,type:'grass',megaBoost:true,bonusEnergy:7},{name:'灼熱吸血擊',dmg:100,cost:10,type:'fire',megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:149,cost:15,type:'normal',status:{effect:'confusion', chance:0.25}},{name:'毒粉刺',dmg:144,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10050, type:'fire', type2:'fighting', ability:{id:'huge-power', name:'加速', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:257, name:'火焰雞', type:'fire', type2:'fighting', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'踢腿',dmg:59,cost:4,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:95,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:98,cost:9,type:'dark',megaBoost:true,bonusEnergy:7},{name:'冰霜強奪擊',dmg:34,cost:5,type:'ice',rider:'card-steal'}]},
  { mega:{spriteId:10066, type:'dark', type2:'ghost', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:302, name:'勾魂眼', type:'dark', type2:'ghost', hp:200, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:70,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'蟲毒吸血擊',dmg:30,cost:5,type:'bug',rider:'life-drain'},{name:'寶石爆破',dmg:101,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:149,cost:12,type:'dark',selfHeal:0.25}]},
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'啃咬',dmg:61,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:65,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'幽冥威壓擊',dmg:12,cost:3,type:'ghost',rider:'weaken'},{name:'毒牙',dmg:145,cost:11,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10053, type:'steel', type2:null, ability:{id:'solid-rock', name:'過濾', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:306, name:'波士可多拉', type:'steel', type2:'rock', hp:200, tier:2, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'金屬爪',dmg:67,cost:5,type:'steel',megaBoost:true,bonusEnergy:8},{name:'岩石滑落',dmg:105,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'幽冥威壓擊',dmg:146,cost:15,type:'ghost',selfHeal:0.18},{name:'雪崩',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'空手劈',dmg:67,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:71,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'岩崩吸能擊',dmg:15,cost:5,type:'rock',rider:'energy-steal'},{name:'惡意彈珠',dmg:151,cost:12,type:'dark',selfHeal:0.3}]},
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:84,cost:5,type:'electric',megaBoost:true,bonusEnergy:8},{name:'大地護甲擊',dmg:10,cost:3,type:'ground',rider:'guard-up'},{name:'吼叫',dmg:124,cost:10,type:'normal',megaBoost:true,bonusEnergy:8},{name:'火焰牙',dmg:176,cost:15,type:'fire',selfHeal:0.26}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水槍',dmg:78,cost:4,type:'water',megaBoost:true,bonusEnergy:7},{name:'劇毒強奪擊',dmg:34,cost:5,type:'poison',rider:'card-steal'},{name:'惡意彈珠',dmg:122,cost:10,type:'dark',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:176,cost:14,type:'ice',selfHeal:0.18}]},
  { mega:{spriteId:10087, type:'fire', type2:'ground', ability:{id:'tough-claws', name:'強行', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:323, name:'噴火駝', type:'fire', type2:'ground', hp:260, tier:2, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'火花',dmg:59,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:97,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽冥吸血擊',dmg:24,cost:3,type:'ghost',rider:'life-drain'},{name:'鐵頭',dmg:139,cost:13,type:'steel',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10067, type:'dragon', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:334, name:'七夕青鳥', type:'dragon', type2:'flying', hp:270, tier:2, ability:{id:'frisk-ward', name:'自然回復', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:66,cost:4,type:'flying',megaBoost:true,bonusEnergy:7},{name:'龍之氣息',dmg:101,cost:10,type:'dragon',megaBoost:true,bonusEnergy:8},{name:'劇毒強奪擊',dmg:104,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:50,cost:8,type:'grass',rider:'weaken'}]},
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:71,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'雷光吸能擊',dmg:24,cost:3,type:'electric',rider:'energy-steal'},{name:'暗黑爆破',dmg:106,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:149,cost:12,type:'psychic',selfHeal:0.19}]},
  { mega:{spriteId:10074, type:'ice', type2:null, ability:{id:'adaptability', name:'冰肌', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:362, name:'冰鬼護', type:'ice', hp:260, tier:2, ability:{id:'thick-fat', name:'冰凍之軀', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'冰霜拳',dmg:52,cost:3,type:'ice',megaBoost:true,bonusEnergy:6},{name:'激流護甲擊',dmg:35,cost:2,type:'water',rider:'guard-up'},{name:'鐵尾',dmg:90,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'夜斬',dmg:136,cost:13,type:'dark',selfHeal:0.2}]},
  ...
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'連續拳',dmg:67,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'連續啃咬',dmg:64,cost:2,type:'bug',megaBoost:true,bonusEnergy:6},{name:'高速旋轉踢',dmg:114,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'精神強奪擊',dmg:25,cost:1,type:'psychic',rider:'card-steal'}]},
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'冰霜拳',dmg:52,cost:1,type:'ice',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:80,cost:6,type:'grass',megaBoost:true,bonusEnergy:4},{name:'劇毒強奪擊',dmg:120,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'破魂吸血擊',dmg:38,cost:4,type:'fighting',rider:'life-drain'}]},
  { mega:{spriteId:10068, type:'psychic', type2:'fighting', ability:{id:'huge-power', name:'精神力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:475, name:'艾路雷朵', type:'psychic', type2:'fighting', hp:260, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'空手劈',dmg:51,cost:3,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:89,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'妖精威壓擊',dmg:16,cost:2,type:'fairy',rider:'weaken'},{name:'電磁砲',dmg:133,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10069, type:'normal', type2:'fairy', ability:{id:'thick-fat', name:'治癒之心', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:531, name:'差不多娃娃', type:'normal', hp:300, tier:2, ability:{id:'thick-fat', name:'回復力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'拍打',dmg:58,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'大地護甲擊',dmg:94,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'妖精風',dmg:139,cost:13,type:'fairy',selfHeal:0.28},{name:'日光束',dmg:133,cost:13,type:'grass',selfHeal:0.29}]},
  { mega:{spriteId:10075, type:'rock', type2:'fairy', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:719, name:'蒂安希', type:'rock', type2:'fairy', hp:300, tier:3, ability:{id:'solid-rock', name:'恆淨之軀', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'岩石滑落',dmg:62,cost:4,type:'rock',megaBoost:true,bonusEnergy:7},{name:'魔法閃耀',dmg:101,cost:9,type:'fairy',megaBoost:true,bonusEnergy:7},{name:'破魂強奪擊',dmg:141,cost:14,type:'fighting',status:{effect:'sleep', chance:0.2}},{name:'鐵頭',dmg:142,cost:14,type:'steel',selfHeal:0.21}]},
  { mega:{spriteId:10278, type:'fairy', type2:'flying', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:36, name:'皮可西', type:'fairy', hp:280, tier:2, ability:{id:'magic-guard', name:'魔法防守', trigger:'onStatus', desc:'不會受到中毒／燒傷的傷害'}, attacks:[{name:'拍打',dmg:56,cost:1,type:'normal',megaBoost:true,bonusEnergy:5},{name:'疾風吸能擊',dmg:13,cost:2,type:'flying',rider:'energy-steal'},{name:'妖精吸能擊',dmg:127,cost:11,type:'fairy',selfHeal:0.2},{name:'毒液',dmg:127,cost:12,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10279, type:'grass', type2:'poison', ability:{id:'tough-claws', name:'揭露之貌', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:71, name:'大食花', type:'grass', type2:'poison', hp:230, tier:1, ability:{id:'blaze-boost', name:'葉綠素', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'激流護甲擊',dmg:34,cost:4,type:'water',rider:'guard-up'},{name:'毒液',dmg:82,cost:4,type:'poison',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:125,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'鐵頭',dmg:178,cost:15,type:'steel',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10284, type:'steel', type2:'flying', ability:{id:'solid-rock', name:'頑強', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:227, name:'盔甲鳥', type:'steel', type2:'flying', hp:270, tier:2, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'啄',dmg:69,cost:5,type:'flying',megaBoost:true,bonusEnergy:8},{name:'鐵頭',dmg:105,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'蟲鳴',dmg:105,cost:10,type:'bug',megaBoost:true,bonusEnergy:8},{name:'破魂強奪擊',dmg:63,cost:8,type:'fighting',rider:'card-steal'}]},
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:61,cost:2,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'大地吸血擊',dmg:14,cost:5,type:'ground',rider:'life-drain'},{name:'破魂威壓擊',dmg:107,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:155,cost:13,type:'normal',selfHeal:0.25}]},
  ...
  { mega:{spriteId:10312, type:'dark', type2:null, ability:{id:'tough-claws', name:'暗影', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:491, name:'達克萊伊', type:'dark', hp:310, tier:3, ability:{id:'tough-claws', name:'惡夢', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'惡意彈珠',dmg:66,cost:5,type:'dark',megaBoost:true,bonusEnergy:8},{name:'暗影球',dmg:105,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'泥巴射擊',dmg:149,cost:14,type:'ground',selfHeal:0.26},{name:'火焰牙',dmg:150,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  ...
  { mega:{spriteId:10288, type:'bug', type2:'poison', ability:{id:'sturdy', name:'硬殼盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}}, id:545, name:'蜈蚣王', type:'bug', type2:'poison', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'連續啃咬',dmg:53,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'逆鱗威壓擊',dmg:27,cost:5,type:'dragon',rider:'weaken'},{name:'毒液',dmg:91,cost:8,type:'poison',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:131,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10289, type:'dark', type2:'fighting', ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:560, name:'頭巾混混', type:'dark', type2:'fighting', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'灼熱吸能擊',dmg:36,cost:5,type:'fire',rider:'energy-steal'},{name:'惡意彈珠',dmg:100,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:97,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'冰凍拳',dmg:150,cost:11,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10290, type:'electric', type2:null, ability:{id:'motor-drive', name:'電鰻升格', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:604, name:'麻麻鰻魚王', type:'electric', hp:270, tier:2, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'咬碎',dmg:69,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:105,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'毒針',dmg:101,cost:10,type:'poison',megaBoost:true,bonusEnergy:8},{name:'破魂護甲擊',dmg:19,cost:3,type:'fighting',rider:'guard-up'}]},
  { mega:{spriteId:10292, type:'grass', type2:'fighting', ability:{id:'solid-rock', name:'防彈', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:652, name:'布里卡隆', type:'grass', type2:'fighting', hp:300, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'藤鞭',dmg:53,cost:2,type:'grass',megaBoost:true,bonusEnergy:6},{name:'空手劈',dmg:93,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'連環巴掌',dmg:134,cost:12,type:'normal',selfHeal:0.19},{name:'破空飛翔',dmg:134,cost:13,type:'flying',selfHeal:0.16}]},
  { mega:{spriteId:10293, type:'fire', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:655, name:'妖火紅狐', type:'fire', type2:'psychic', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火花',dmg:60,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:98,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'暗影強奪擊',dmg:31,cost:2,type:'dark',rider:'card-steal'},{name:'毒針',dmg:136,cost:14,type:'poison',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10295, type:'fire', type2:'normal', ability:{id:'blaze-boost', name:'火鬃', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:668, name:'火炎獅', type:'fire', type2:'normal', hp:270, tier:2, ability:{id:'pressure', name:'緊張感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'拍打',dmg:70,cost:5,type:'normal',megaBoost:true,bonusEnergy:8},{name:'破魂吸血擊',dmg:14,cost:5,type:'fighting',rider:'life-drain'},{name:'大字爆炎',dmg:105,cost:10,type:'fire',megaBoost:true,bonusEnergy:8},{name:'夜斬',dmg:150,cost:15,type:'dark',selfHeal:0.24}]},
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:62,cost:0,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:40,cost:4,type:'electric',rider:'weaken'},{name:'橫衝直撞',dmg:96,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'葉暴風',dmg:144,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:73,cost:3,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'大地吸能擊',dmg:20,cost:1,type:'ground',rider:'energy-steal'},{name:'火花',dmg:116,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:173,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10297, type:'dark', type2:'psychic', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:687, name:'烏賊王', type:'dark', type2:'psychic', hp:260, tier:2, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'惡意彈珠',dmg:54,cost:2,type:'dark',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:95,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'神速護甲擊',dmg:13,cost:3,type:'normal',rider:'guard-up'},{name:'大地波動',dmg:131,cost:13,type:'ground',selfHeal:0.21}]},
  { mega:{spriteId:10298, type:'rock', type2:'fighting', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:689, name:'龜足巨鎧', type:'rock', type2:'water', hp:260, tier:2, ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'岩石滑落',dmg:55,cost:3,type:'rock',megaBoost:true,bonusEnergy:6},{name:'鋼影強奪擊',dmg:39,cost:3,type:'steel',rider:'card-steal'},{name:'源起之波',dmg:96,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'妖精吸能擊',dmg:140,cost:14,type:'fairy',selfHeal:0.21}]},
  { mega:{spriteId:10299, type:'poison', type2:'dragon', ability:{id:'thick-fat', name:'再生力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:691, name:'毒藻龍', type:'poison', type2:'dragon', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'毒液',dmg:61,cost:4,type:'poison',megaBoost:true,bonusEnergy:7},{name:'破魂吸血擊',dmg:34,cost:3,type:'fighting',rider:'life-drain'},{name:'逆鱗護甲擊',dmg:100,cost:9,type:'dragon',megaBoost:true,bonusEnergy:7},{name:'十字剪',dmg:142,cost:14,type:'bug',selfHeal:0.15}]},
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'空手劈',dmg:83,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'大地威壓擊',dmg:63,cost:8,type:'ground',rider:'weaken'},{name:'疾風吸能擊',dmg:124,cost:10,type:'flying',megaBoost:true,bonusEnergy:8},{name:'毒液',dmg:180,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
