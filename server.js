...
const POKEMON = [
  // Tier 1
  { id:3,   name:'妙蛙花',    type:'grass',    hp:250, tier:1, attacks:[{name:'太陽射線',dmg:40,type:'grass',   status:{effect:'sleep',    chance:0.20}},{name:'大地之力',   dmg:58,type:'ground', status:{effect:'poison',   chance:0.30}}]},
  { id:94,  name:'耿鬼',      type:'ghost',    hp:220, tier:1, attacks:[{name:'幽靈之爪',dmg:40,type:'ghost',   status:{effect:'poison',   chance:0.20}},{name:'咬碎',       dmg:52,type:'dark'}]},
  { id:68,  name:'怪力',      type:'fighting', hp:260, tier:1, attacks:[{name:'動感拳',  dmg:42,type:'fighting'                                       },{name:'地震',       dmg:58,type:'ground'}]},
  { id:65,  name:'胡地',      type:'psychic',  hp:200, tier:1, attacks:[{name:'超能力',  dmg:40,type:'psychic', status:{effect:'confusion', chance:0.30}},{name:'閃電拳',     dmg:52,type:'electric',status:{effect:'paralysis',chance:0.20}}]},
  { id:26,  name:'雷丘',      type:'electric', hp:200, tier:1, attacks:[{name:'十萬伏特',dmg:40,type:'electric',status:{effect:'paralysis',chance:0.30}},{name:'鐵尾',       dmg:52,type:'steel'}]},
  { id:376, name:'巨金怪',    type:'steel',    hp:260, tier:1, attacks:[{name:'子彈拳',  dmg:42,type:'steel'                                          },{name:'隕石衝擊',   dmg:58,type:'rock'}]},
  { id:448, name:'路卡利歐',  type:'fighting', hp:220, tier:1, attacks:[{name:'波導彈',  dmg:40,type:'fighting'                                       },{name:'金屬爪',     dmg:58,type:'steel'}]},
  { id:130, name:'暴鯉龍',    type:'water',    hp:260, tier:1, attacks:[{name:'大浪',    dmg:42,type:'water'                                          },{name:'咬碎',       dmg:58,type:'dark'}]},
  { id:35,  name:'皮皮',      type:'fairy',    hp:220, tier:1, attacks:[{name:'月亮力量',dmg:40,type:'fairy',   status:{effect:'confusion', chance:0.25}},{name:'元氣拳',     dmg:52,type:'normal'}]},
  { id:39,  name:'胖丁',      type:'fairy',    hp:240, tier:1, attacks:[{name:'歌唱衝擊',dmg:40,type:'fairy',   status:{effect:'sleep',    chance:0.35}},{name:'破壞光線',   dmg:58,type:'normal'}]},
  { id:209, name:'布魯',      type:'fairy',    hp:220, tier:1, attacks:[{name:'仙女之氣',dmg:40,type:'fairy'                                          },{name:'咬碎',       dmg:52,type:'dark'}]},
  { id:87,  name:'白海獅',    type:'ice',      hp:240, tier:1, attacks:[{name:'冷凍光線',dmg:40,type:'ice',     status:{effect:'freeze',    chance:0.15}},{name:'衝浪',       dmg:52,type:'water'}]},
  { id:82,  name:'三合磁怪',  type:'electric', hp:210, tier:1, attacks:[{name:'電磁炮',  dmg:40,type:'electric',status:{effect:'paralysis',chance:0.30}},{name:'閃光炮',     dmg:52,type:'steel'}]},
  { id:28,  name:'沙包蛇',    type:'ground',   hp:240, tier:1, attacks:[{name:'地震',    dmg:40,type:'ground'                                         },{name:'岩石滑落',   dmg:52,type:'rock'}]},
  { id:80,  name:'呆殼獸',    type:'water',    hp:260, tier:1, attacks:[{name:'衝浪',    dmg:40,type:'water'                                          },{name:'念力',       dmg:52,type:'psychic',status:{effect:'confusion',chance:0.20}}]},
  // Tier 2
  { id:6,   name:'噴火龍',    type:'fire',     hp:290, tier:2, attacks:[{name:'火焰噴射',dmg:45,type:'fire',    status:{effect:'burn',      chance:0.25}},{name:'破空飛翔',   dmg:70,type:'flying'}]},
  { id:9,   name:'水箭龜',    type:'water',    hp:280, tier:2, attacks:[{name:'水砲',    dmg:45,type:'water'                                          },{name:'冰凍光束',   dmg:65,type:'ice',    status:{effect:'freeze',   chance:0.15}}]},
  { id:150, name:'超夢',      type:'psychic',  hp:320, tier:2, attacks:[{name:'念力衝擊',dmg:45,type:'psychic', status:{effect:'confusion', chance:0.30}},{name:'暗影球',     dmg:75,type:'ghost'}]},
  { id:149, name:'快龍',      type:'dragon',   hp:320, tier:2, attacks:[{name:'龍息',    dmg:45,type:'dragon'                                         },{name:'破壞光線',   dmg:75,type:'normal'}]},
  { id:143, name:'卡比獸',    type:'normal',   hp:380, tier:2, attacks:[{name:'磚塊',    dmg:45,type:'rock'                                           },{name:'破壞光線',   dmg:68,type:'normal'}]},
  { id:59,  name:'風速狗',    type:'fire',     hp:260, tier:2, attacks:[{name:'夜斬',    dmg:45,type:'dark'                                           },{name:'噴射火焰',   dmg:65,type:'fire',   status:{effect:'burn',     chance:0.25}}]},
  { id:131, name:'拉普拉斯',  type:'ice',      hp:290, tier:2, attacks:[{name:'衝浪',    dmg:45,type:'water'                                          },{name:'暴風雪',     dmg:65,type:'ice',    status:{effect:'freeze',   chance:0.20}}]},
  { id:445, name:'烈咬陸鯊',  type:'dragon',   hp:280, tier:2, attacks:[{name:'龍爪',    dmg:45,type:'dragon'                                         },{name:'地震',       dmg:68,type:'ground'}]},
  { id:210, name:'布比獸',    type:'fairy',    hp:300, tier:2, attacks:[{name:'仙女之力',dmg:45,type:'fairy'                                          },{name:'地震',       dmg:68,type:'ground'}]},
  { id:700, name:'仙子伊布',  type:'fairy',    hp:300, tier:2, attacks:[{name:'妖精風',  dmg:45,type:'fairy'                                          },{name:'暗影球',     dmg:68,type:'ghost'}]},
  { id:478, name:'雪妖女',    type:'ice',      hp:280, tier:2, attacks:[{name:'冰凍光束',dmg:45,type:'ice',     status:{effect:'freeze',    chance:0.15}},{name:'暗影球',     dmg:68,type:'ghost'}]},
  { id:614, name:'冰熊王',    type:'ice',      hp:320, tier:2, attacks:[{name:'冰耳光',  dmg:45,type:'ice',     status:{effect:'freeze',    chance:0.15}},{name:'地震',       dmg:68,type:'ground'}]},
  { id:430, name:'夜巡使',    type:'dark',     hp:300, tier:2, attacks:[{name:'夜斬',    dmg:45,type:'dark'                                           },{name:'怒風',       dmg:68,type:'flying'}]},
  { id:466, name:'電擊魔獸',  type:'electric', hp:300, tier:2, attacks:[{name:'電磁衝浪',dmg:45,type:'electric',status:{effect:'paralysis',chance:0.25}},{name:'冰凍拳',     dmg:68,type:'ice',    status:{effect:'freeze',   chance:0.15}}]},
  { id:467, name:'鴨嘴火獸',  type:'fire',     hp:300, tier:2, attacks:[{name:'火焰衝擊',dmg:45,type:'fire',    status:{effect:'burn',      chance:0.25}},{name:'雷電',       dmg:68,type:'electric',status:{effect:'paralysis',chance:0.20}}]},
  // Tier 3
  { id:383, name:'固拉多',    type:'ground',   hp:340, tier:3, attacks:[{name:'地震',    dmg:50,type:'ground'                                         },{name:'原始大地',   dmg:90,type:'fire',   status:{effect:'burn',     chance:0.30}}]},
  { id:382, name:'蓋歐卡',    type:'water',    hp:340, tier:3, attacks:[{name:'源起之波',dmg:50,type:'water'                                          },{name:'原始海洋',   dmg:90,type:'ice',    status:{effect:'freeze',   chance:0.20}}]},
  { id:384, name:'列空座',    type:'dragon',   hp:360, tier:3, attacks:[{name:'神速',    dmg:48,type:'normal'                                         },{name:'龍之隕星',   dmg:95,type:'dragon'}]},
  { id:1008,name:'密勒頓',    type:'electric', hp:360, tier:3, attacks:[{name:'電磁衝浪',dmg:52,type:'electric',status:{effect:'paralysis',chance:0.25}},{name:'未來雷霆',   dmg:92,type:'psychic',status:{effect:'confusion',chance:0.25}}]},
  { id:250, name:'鳳王',      type:'fire',     hp:340, tier:3, attacks:[{name:'聖焰',    dmg:52,type:'fire',    status:{effect:'burn',      chance:0.30}},{name:'神聖之焰',   dmg:92,type:'flying'}]},
  { id:249, name:'路奇亞',    type:'flying',   hp:340, tier:3, attacks:[{name:'怒風',    dmg:50,type:'flying'                                         },{name:'心靈衝擊',   dmg:90,type:'psychic',status:{effect:'confusion',chance:0.30}}]},
  { id:1007,name:'故勒頓',    type:'fighting', hp:360, tier:3, attacks:[{name:'決勝衝擊',dmg:52,type:'fighting'                                       },{name:'遠古之力',   dmg:92,type:'rock'}]},
  { id:282, name:'沙奈朵',    type:'fairy',    hp:320, tier:3, attacks:[{name:'妖精之力',dmg:50,type:'fairy'                                          },{name:'精神強擊',   dmg:90,type:'psychic',status:{effect:'confusion',chance:0.30}}]},
  { id:144, name:'急凍鳥',    type:'ice',      hp:340, tier:3, attacks:[{name:'暴風雪',  dmg:50,type:'ice',     status:{effect:'freeze',    chance:0.25}},{name:'怒風',       dmg:88,type:'flying'}]},
  { id:145, name:'閃電鳥',    type:'electric', hp:340, tier:3, attacks:[{name:'雷霆',    dmg:50,type:'electric',status:{effect:'paralysis',chance:0.30}},{name:'怒風',       dmg:88,type:'flying'}]},
  { id:146, name:'火焰鳥',    type:'fire',     hp:340, tier:3, attacks:[{name:'火焰衝擊',dmg:50,type:'fire',    status:{effect:'burn',      chance:0.30}},{name:'怒風',       dmg:88,type:'flying'}]},
  { id:716, name:'哲爾尼亞斯',type:'fairy',    hp:370, tier:3, attacks:[{name:'月亮力量',dmg:52,type:'fairy'                                          },{name:'精神強擊',   dmg:92,type:'psychic',status:{effect:'confusion',chance:0.25}}]},
  { id:378, name:'雷吉艾斯',  type:'ice',      hp:370, tier:3, attacks:[{name:'暴風雪',  dmg:50,type:'ice',     status:{effect:'freeze',    chance:0.20}},{name:'電磁砲',     dmg:88,type:'electric',status:{effect:'paralysis',chance:0.30}}]},
];

const EFF = {
  fire:     {grass:2, ice:2, steel:2, water:0.5, fire:0.5, rock:0.5, dragon:0.5},
  ...
  fighting: {normal:2, ice:2, rock:2, steel:2, dark:2, psychic:0.5, flying:0.5, fairy:0.5, ghost:0},
  ...
  flying:   {fighting:2, grass:2, electric:0.5, rock:0.5, steel:0.5},
  ground:   {fire:2, electric:2, rock:2, steel:2, grass:0.5, flying:0},
  rock:     {fire:2, ice:2, flying:2, fighting:0.5, ground:0.5, steel:0.5},
...
function srvEff(atkType, defType) {
  return (EFF[atkType] || {})[defType] ?? 1;
}
...
wss.on('connection', ws => {
  ...
  ws.on('message', raw => {
    ...
    if (type === 'attack') {
      ...
      doAttack(attacker, defender, atk, aBuff, dBuff, log);
      G[`${role}SuppUsed`]  = false;
      G[`${role}FreeSwitch`] = false;
