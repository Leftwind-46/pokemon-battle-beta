...
const POKEMON = [
  // Tier 1
  { mega:{spriteId:10033, type:'grass', type2:'poison', ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:3,   name:'妙蛙花',     type:'grass',    type2:'poison',  hp:250, tier:1, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'逆鱗吸能擊',dmg:43,cost:3,type:'dragon',rider:'energy-steal'},{name:'毒粉刺',dmg:84,cost:7,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:5},{name:'葉刃',dmg:72,cost:5,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'大地之力',dmg:152,cost:12,type:'ground',status:{effect:'burn', chance:0.25}}]},
  ...
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'衝撞',dmg:19,cost:0,type:'normal',rider:'type-draw',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:14,cost:1,type:'electric',rider:'energy-steal',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'石刃',dmg:120,cost:6,type:'rock',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'逆鱗威壓擊',dmg:71,cost:5,type:'dragon',rider:'mega-charge'}]},
  ...
  { id:82,  name:'三合一磁怪',   type:'electric', type2:'steel',   hp:210, tier:1, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'電磁炮',dmg:29,cost:2,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:39,cost:3,type:'poison',rider:'mega-charge'},{name:'子彈拳',dmg:108,cost:8,type:'steel',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'衝浪',dmg:157,cost:12,type:'water',selfHeal:0.18}]},
  ...
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'磚塊',dmg:69,cost:6,type:'rock',megaBoost:true,bonusEnergy:8},{name:'連踢',dmg:27,cost:2,type:'normal',rider:'self-cure',selfHeal:0.25},{name:'地震',dmg:155,cost:14,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'鐵頭',dmg:155,cost:14,type:'steel',selfHeal:0.29}]},
  { id:59,  name:'風速狗',     type:'fire',     hp:260, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'夜斬',dmg:13,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'冰霜強奪擊',dmg:23,cost:2,type:'ice',rider:'type-draw'},{name:'衝撞',dmg:90,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'噴射火焰',dmg:134,cost:12,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:131, name:'拉普拉斯',   type:'water',    type2:'ice',     hp:290, tier:2, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:14,cost:1,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'冷凍光線',dmg:24,cost:2,type:'ice',rider:'energy-steal',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:132,cost:12,type:'electric',selfHeal:0.21},{name:'岩石炮',dmg:154,cost:13,type:'rock',selfHeal:0.17}]},
  { mega:{spriteId:10058, type:'dragon', type2:'ground', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:445, name:'烈咬陸鯊',   type:'dragon',   type2:'ground',  hp:280, tier:2, ability:{id:'frisk-ward', name:'沙隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'龍爪',dmg:13,cost:1,type:'dragon',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'疾風吸血擊',dmg:35,cost:3,type:'flying',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:146,cost:11,type:'ground',selfHeal:0.23},{name:'毒針',dmg:146,cost:11,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:210, name:'布魯皇',     type:'fairy',    hp:300, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'仙女之力',dmg:42,cost:3,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'雷電',dmg:12,cost:1,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'咬碎',dmg:143,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}},{name:'地震',dmg:138,cost:13,type:'ground',status:{effect:'confusion', chance:0.25}}]},
  ...
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'夜斬',dmg:38,cost:3,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'暴風',dmg:43,cost:3,type:'flying',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'催眠術',dmg:145,cost:14,type:'psychic',selfHeal:0.22},{name:'毒粉刺',dmg:139,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:466, name:'電擊魔獸',   type:'electric', hp:300, tier:2, ability:{id:'electric-domain', name:'雷霆支配', trigger:'onEnter', desc:'上場時場地切換為雷雲庇護所；電屬性攻擊傷害額外 +40'}, attacks:[{name:'電磁衝浪',dmg:39,cost:3,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'動感拳',dmg:34,cost:3,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:138,cost:14,type:'psychic',selfHeal:0.18},{name:'冰凍拳',dmg:138,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  { id:467, name:'鴨嘴炎獸',   type:'fire',     hp:300, tier:2, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'火焰衝擊',dmg:42,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:25,cost:2,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'電磁炮',dmg:141,cost:14,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'污泥炸彈',dmg:143,cost:14,type:'poison',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'神速',dmg:66,cost:5,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:135,cost:11,type:'fire',status:{effect:'freeze', chance:0.15}},{name:'怒風',dmg:135,cost:11,type:'flying',status:{effect:'poison', chance:0.3}},{name:'龍之隕星',dmg:35,cost:3,type:'dragon',rider:'self-cure',status:{effect:'burn', chance:0.25}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:135,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'逆鱗護甲擊',dmg:73,cost:6,type:'dragon',selfHeal:0.17},{name:'毒牙',dmg:131,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'未來雷霆',dmg:42,cost:3,type:'psychic',rider:'mega-charge',selfHeal:0.23}]},
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'flying-domain', name:'疾風支配', trigger:'onEnter', desc:'上場時場地切換為疾風之翼；飛行屬性攻擊傷害額外 +40'}, attacks:[{name:'怒風',dmg:34,cost:3,type:'flying',rider:'self-cure',status:{effect:'paralysis', chance:0.2}},{name:'聖焰',dmg:39,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.3}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'空間扭曲',dmg:140,cost:13,type:'dragon',selfHeal:0.22}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'念力',dmg:41,cost:3,type:'psychic',rider:'mega-charge',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:49,cost:4,type:'flying',rider:'type-draw',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:88,cost:9,type:'ice',rider:'guard-up'},{name:'幽靈球',dmg:138,cost:13,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  { id:1007,name:'故勒頓',     type:'fighting', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'緋紅脈動', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'決勝衝擊',dmg:87,cost:6,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:83,cost:10,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:83,cost:10,type:'ground',status:{effect:'sleep', chance:0.2}},{name:'遠古之力',dmg:53,cost:4,type:'rock',rider:'energy-steal',selfHeal:0.3}]},
  ...
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'暴風雪',dmg:61,cost:6,type:'ice',status:{effect:'freeze', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:131,cost:11,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'幽冥威壓擊',dmg:131,cost:11,type:'ghost',selfHeal:0.22},{name:'高速星星拳',dmg:73,cost:6,type:'normal',selfHeal:0.25}]},
  ...
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:305, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'妖精之風',dmg:39,cost:3,type:'fairy',rider:'type-draw'},{name:'閃電拳',dmg:57,cost:5,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.2}},{name:'飛葉快刀',dmg:90,cost:9,type:'grass',rider:'card-steal'},{name:'冰耳光',dmg:139,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:142,cost:12,type:'steel',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:95,cost:10,type:'dragon',selfHeal:0.19},{name:'閃電拳',dmg:62,cost:5,type:'electric',rider:'mega-charge',selfHeal:0.21},{name:'幽靈球',dmg:84,cost:6,type:'ghost',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:26,cost:2,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:70,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'超能力',dmg:131,cost:11,type:'psychic',selfHeal:0.25},{name:'鐵翼',dmg:131,cost:11,type:'steel',selfHeal:0.15}]},
  ...
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:14,cost:1,type:'normal',rider:'energy-steal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:63,cost:5,type:'fire',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:97,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'惡意波動',dmg:151,cost:12,type:'dark',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'疾風威壓擊',dmg:40,cost:3,type:'flying',rider:'self-cure'},{name:'噴火',dmg:98,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:96,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:144,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電球',dmg:24,cost:2,type:'electric',rider:'mega-charge',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'能量球',dmg:91,cost:8,type:'grass',status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:89,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'神速吸能擊',dmg:41,cost:3,type:'normal',rider:'self-cure'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:21,cost:0,type:'normal',rider:'mega-charge',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:19,cost:0,type:'poison',rider:'type-draw',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'砂子攻擊',dmg:96,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:62,cost:5,type:'steel',ignoreReflect:true,rider:'guard-up'}]},
  ...
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'妖精吸血擊',dmg:12,cost:1,type:'fairy',rider:'mega-charge'},{name:'突擊',dmg:54,cost:4,type:'dark',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:125,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'劇毒威壓擊',dmg:179,cost:14,type:'poison',selfHeal:0.27}]},
  ...
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'暗影爪',dmg:40,cost:3,type:'ghost',ignoreReflect:true,status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:35,cost:3,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'月亮力量',dmg:113,cost:8,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:35,cost:3,type:'flying',rider:'energy-steal'}]},
  { mega:{spriteId:10291, type:'ghost', type2:'fire', ability:{id:'frisk-ward', name:'穿透', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:609, name:'水晶燈火靈', type:'ghost',    type2:'fire',    hp:260, tier:2, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'冰霜吸血擊',dmg:66,cost:5,type:'ice',ignoreReflect:true,rider:'life-drain'},{name:'噴火',dmg:46,cost:4,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:5},{name:'暗影爪',dmg:89,cost:8,type:'ghost',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'精神強擊',dmg:131,cost:12,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:53,cost:4,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'光合作用強擊',dmg:46,cost:4,type:'grass',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:40,cost:3,type:'fairy',rider:'energy-steal'},{name:'鐵頭',dmg:163,cost:14,type:'steel',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:36,cost:3,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:28,cost:2,type:'steel',ignoreReflect:true,rider:'energy-steal'},{name:'居合斬',dmg:112,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'暗黑脈衝',dmg:157,cost:13,type:'dark',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'壓制',dmg:12,cost:1,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:84,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'魔法閃耀',dmg:134,cost:12,type:'fairy',selfHeal:0.22},{name:'蟲毒護甲擊',dmg:41,cost:3,type:'bug',rider:'energy-steal'}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'神速強奪擊',dmg:42,cost:3,type:'normal',ignoreReflect:true,rider:'card-steal'},{name:'夜斬',dmg:12,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'水手裏劍',dmg:104,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:158,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'砂子攻擊',dmg:70,cost:5,type:'ground',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'灼熱吸血擊',dmg:62,cost:5,type:'fire',rider:'type-draw'},{name:'高周波音',dmg:125,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:175,cost:14,type:'rock',selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'bug-domain', name:'蟲群支配', trigger:'onEnter', desc:'上場時場地切換為蟲群巢穴；蟲屬性攻擊傷害額外 +40'}, attacks:[{name:'冰霜威壓擊',dmg:73,cost:5,type:'ice',rider:'move-reflect'},{name:'金屬爪',dmg:13,cost:1,type:'steel',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'蟲鳴',dmg:100,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:150,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'岩崩吸血擊',dmg:43,cost:3,type:'rock',rider:'energy-steal'},{name:'音爆拳',dmg:13,cost:1,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:107,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:154,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  ...
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'水槍',dmg:39,cost:3,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'迴旋踢',dmg:95,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'暗影吸能擊',dmg:66,cost:5,type:'dark',rider:'energy-steal'},{name:'冰凍光束',dmg:97,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  ...
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'飛葉快刀',dmg:14,cost:1,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:37,cost:3,type:'ghost',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'烈焰衝浪腳',dmg:133,cost:12,type:'fire',status:{effect:'burn', chance:0.25}},{name:'暴風',dmg:147,cost:13,type:'flying',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'毒針',dmg:20,cost:0,type:'poison',ignoreReflect:true,status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:80,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'疾風威壓擊',dmg:67,cost:5,type:'flying',rider:'energy-steal'},{name:'骨棒',dmg:135,cost:11,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  { id:862, name:'堵攔熊', type:'dark', type2:'normal', hp:300, tier:2, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'夜斬',dmg:50,cost:4,type:'dark',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'連續切',dmg:43,cost:3,type:'normal',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:141,cost:14,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'空間扭曲',dmg:142,cost:14,type:'dragon',selfHeal:0.2}]},
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'蟲咬',dmg:54,cost:4,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:99,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'幽冥威壓擊',dmg:96,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'妖精吸能擊',dmg:60,cost:5,type:'fairy',ignoreReflect:true,rider:'energy-steal'}]},
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'泥巴射擊',dmg:64,cost:5,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'影子偷襲',dmg:29,cost:2,type:'ghost',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'百萬針',dmg:150,cost:15,type:'bug',selfHeal:0.22},{name:'冰霜拳',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'水槍',dmg:72,cost:5,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:8},{name:'念力',dmg:104,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'蟲毒護甲擊',dmg:43,cost:3,type:'bug',rider:'self-cure'},{name:'近身戰',dmg:150,cost:15,type:'fighting',selfHeal:0.15}]},
  { mega:{spriteId:10045, type:'electric', type2:'dragon', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:181, name:'電龍', type:'electric',  hp:300, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:27,cost:2,type:'electric',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'電光一閃',dmg:73,cost:6,type:'normal',megaBoost:true,bonusEnergy:6},{name:'冰霜護甲擊',dmg:134,cost:13,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'精神護甲擊',dmg:138,cost:13,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10316, type:'bug', type2:'steel', ability:{id:'solid-rock', name:'重甲化', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:768, name:'具甲武者', type:'bug', type2:'water', hp:290, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'水流手裏劍',dmg:23,cost:2,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'蟲咬',dmg:13,cost:1,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'聖焰',dmg:159,cost:13,type:'fire',selfHeal:0.17},{name:'雷光威壓擊',dmg:131,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'魔法葉',dmg:48,cost:4,type:'grass',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'灼熱吸血擊',dmg:55,cost:4,type:'fire',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:149,cost:15,type:'normal',status:{effect:'confusion', chance:0.25}},{name:'毒粉刺',dmg:144,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'冰凍拳',dmg:85,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:132,cost:11,type:'rock',selfHeal:0.24},{name:'毒液',dmg:132,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'光合作用強擊',dmg:48,cost:4,type:'grass',rider:'mega-charge',selfHeal:0.17}]},
  ...
  { mega:{spriteId:10063, type:'dragon', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:381, name:'拉帝歐斯', type:'dragon', type2:'psychic', hp:320, tier:3, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'龍之隕星',dmg:80,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'念力',dmg:136,cost:11,type:'psychic',status:{effect:'burn', chance:0.25}},{name:'雪崩',dmg:136,cost:11,type:'ice',selfHeal:0.23},{name:'地震',dmg:73,cost:6,type:'ground',selfHeal:0.16}]},
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'連續拳',dmg:28,cost:2,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'連續啃咬',dmg:25,cost:2,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'高速旋轉踢',dmg:114,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'精神強奪擊',dmg:13,cost:1,type:'psychic',rider:'mega-charge'}]},
  ...
  { mega:{spriteId:10279, type:'grass', type2:'poison', ability:{id:'tough-claws', name:'揭露之貌', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:71, name:'大食花', type:'grass', type2:'poison', hp:230, tier:1, ability:{id:'blaze-boost', name:'葉綠素', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'激流護甲擊',dmg:57,cost:4,type:'water',rider:'type-draw'},{name:'毒液',dmg:51,cost:4,type:'poison',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:125,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'鐵頭',dmg:178,cost:15,type:'steel',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10284, type:'steel', type2:'flying', ability:{id:'solid-rock', name:'頑強', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:227, name:'盔甲鳥', type:'steel', type2:'flying', hp:270, tier:2, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'啄',dmg:66,cost:5,type:'flying',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'鐵頭',dmg:105,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'蟲鳴',dmg:105,cost:10,type:'bug',megaBoost:true,bonusEnergy:8},{name:'破魂強奪擊',dmg:47,cost:4,type:'fighting',rider:'energy-steal'}]},
  ...
  { mega:{spriteId:10311, type:'fire', type2:'steel', ability:{id:'blaze-boost', name:'熾熱核心', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:485, name:'席多藍恩', type:'fire', type2:'steel', hp:285, tier:3, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'金屬爪',dmg:64,cost:10,type:'steel',megaBoost:true,bonusEnergy:5},{name:'熔岩爆發',dmg:69,cost:8,type:'fire',selfHeal:0.18},{name:'毒針',dmg:43,cost:3,type:'poison',rider:'mega-charge',status:{effect:'poison', chance:0.3}},{name:'隕石衝擊',dmg:38,cost:3,type:'rock',rider:'type-draw',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10312, type:'dark', type2:null, ability:{id:'tough-claws', name:'暗影', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:491, name:'達克萊伊', type:'dark', hp:310, tier:3, ability:{id:'tough-claws', name:'惡夢', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'惡意彈珠',dmg:65,cost:5,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'暗影球',dmg:23,cost:2,type:'ghost',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'泥巴射擊',dmg:149,cost:14,type:'ground',selfHeal:0.26},{name:'火焰牙',dmg:150,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  ...
  { mega:{spriteId:10287, type:'ground', type2:'steel', ability:{id:'tough-claws', name:'貫穿之鑽', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:530, name:'龍頭地鼠', type:'ground', type2:'steel', hp:300, tier:2, ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'金屬爪',dmg:51,cost:4,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'泥巴射擊',dmg:72,cost:5,type:'ground',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'石刃',dmg:144,cost:14,type:'rock',selfHeal:0.18},{name:'雪崩',dmg:147,cost:14,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10290, type:'electric', type2:null, ability:{id:'motor-drive', name:'電鰻升格', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:604, name:'麻麻鰻魚王', type:'electric', hp:270, tier:2, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'咬碎',dmg:47,cost:4,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:105,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'毒針',dmg:101,cost:10,type:'poison',megaBoost:true,bonusEnergy:8},{name:'破魂護甲擊',dmg:41,cost:3,type:'fighting',rider:'self-cure'}]},
  { mega:{spriteId:10292, type:'grass', type2:'fighting', ability:{id:'solid-rock', name:'防彈', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:652, name:'布里卡隆', type:'grass', type2:'fighting', hp:300, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'藤鞭',dmg:27,cost:2,type:'grass',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'空手劈',dmg:35,cost:3,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'連環巴掌',dmg:134,cost:12,type:'normal',selfHeal:0.19},{name:'破空飛翔',dmg:134,cost:13,type:'flying',selfHeal:0.16}]},
  { mega:{spriteId:10293, type:'fire', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:655, name:'妖火紅狐', type:'fire', type2:'psychic', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火花',dmg:38,cost:3,type:'fire',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:98,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'暗影強奪擊',dmg:26,cost:2,type:'dark',rider:'mega-charge'},{name:'毒針',dmg:136,cost:14,type:'poison',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10295, type:'fire', type2:'normal', ability:{id:'blaze-boost', name:'火鬃', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:668, name:'火炎獅', type:'fire', type2:'normal', hp:270, tier:2, ability:{id:'pressure', name:'緊張感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'拍打',dmg:58,cost:5,type:'normal',rider:'move-reflect',megaBoost:true,bonusEnergy:8},{name:'破魂吸血擊',dmg:66,cost:5,type:'fighting',ignoreReflect:true,rider:'life-drain'},{name:'大字爆炎',dmg:105,cost:10,type:'fire',megaBoost:true,bonusEnergy:8},{name:'夜斬',dmg:150,cost:15,type:'dark',selfHeal:0.24}]},
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:21,cost:0,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:47,cost:4,type:'electric',ignoreReflect:true,rider:'weaken'},{name:'橫衝直撞',dmg:96,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'葉暴風',dmg:144,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
