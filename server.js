...
const POKEMON = [
  ...
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'healing-rainbow', name:'治癒彩虹', trigger:'onDefend', desc:'被擊倒後可以復活一次，HP 回復 50%（整場戰鬥限一次）；不會受到任何負面狀態'}, attacks:[{name:'怒風',dmg:34,cost:3,type:'flying',rider:'self-cure',status:{effect:'paralysis', chance:0.4}},{name:'聖焰',dmg:39,cost:3,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:1}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'妖精威壓擊',dmg:140,cost:13,type:'fairy',selfHeal:0.22}]},
