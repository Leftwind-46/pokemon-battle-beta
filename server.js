...
const POKEMON = [
  ...
  { id:376, name:'巨金怪',     type:'steel',    type2:'psychic', hp:260, tier:1, ability:{id:'clear-body', name:'恆淨之軀', trigger:'onDefend', desc:'不會被對手的威嚇降低攻擊力'}, attacks:[{name:'子彈拳',dmg:35,cost:1,type:'steel'},{name:'精神強擊',dmg:38,cost:1,type:'psychic',status:{effect:'confusion', chance:0.2}},{name:'閃光炮',dmg:74,cost:12,type:'steel'},{name:'隕石衝擊',dmg:80,cost:14,type:'rock'}]},
  ...
  { id:130, name:'暴鯉龍',     type:'water',    type2:'flying',  hp:260, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊威力 −15'}, attacks:[{name:'大浪',dmg:34,cost:1,type:'water'},{name:'龍息',dmg:38,cost:1,type:'dragon'},{name:'怒風',dmg:72,cost:12,type:'flying'},{name:'咬碎',dmg:80,cost:14,type:'dark'}]},
  ...
  { id:210, name:'布魯皇',     type:'fairy',    hp:300, tier:2, attacks:[{name:'仙女之力',dmg:35,cost:1,type:'fairy'},{name:'雷電',dmg:38,cost:1,type:'electric',status:{effect:'paralysis', chance:0.15}},{name:'咬碎',dmg:75,cost:13,type:'dark'},{name:'地震',dmg:82,cost:14,type:'ground'}]},
  ...
  { id:614, name:'凍原熊',     type:'ice',      hp:320, tier:2, attacks:[{name:'冰耳光',dmg:36,cost:1,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'大浪',dmg:40,cost:2,type:'water'},{name:'暴風雪',dmg:78,cost:14,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'地震',dmg:88,cost:16,type:'ground'}]},
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, attacks:[{name:'夜斬',dmg:35,cost:1,type:'dark'},{name:'夜騷動',dmg:39,cost:2,type:'dark'},{name:'空氣斬',dmg:76,cost:13,type:'flying'},{name:'怒風',dmg:86,cost:15,type:'flying'}]},
  ...
  { id:467, name:'鴨嘴炎獸',   type:'fire',     hp:300, tier:2, attacks:[{name:'火焰衝擊',dmg:35,cost:1,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:39,cost:2,type:'ground'},{name:'噴射火焰',dmg:76,cost:13,type:'fire',status:{effect:'burn', chance:0.2}},{name:'雷電',dmg:86,cost:15,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { id:154, name:'大竺葵',     type:'grass',                     hp:270, tier:2, attacks:[{name:'能量球',dmg:38,cost:1,type:'grass'},{name:'大地之力',dmg:41,cost:2,type:'ground'},{name:'花瓣風暴',dmg:82,cost:14,type:'grass'},{name:'葉刃',dmg:92,cost:16,type:'grass'}]},
  // Tier 3
  ...
  { id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, attacks:[{name:'神速',dmg:40,cost:2,type:'normal'},{name:'火焰噴射',dmg:44,cost:3,type:'fire',status:{effect:'burn', chance:0.25}},{name:'怒風',dmg:86,cost:16,type:'flying'},{name:'龍之隕星',dmg:99,cost:18,type:'dragon'}]},
  ...
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:340, tier:3, attacks:[{name:'怒風',dmg:40,cost:2,type:'flying'},{name:'冰凍光束',dmg:44,cost:3,type:'ice',status:{effect:'freeze', chance:0.2}},{name:'暴風',dmg:86,cost:16,type:'flying'},{name:'心靈衝擊',dmg:99,cost:18,type:'psychic',status:{effect:'confusion', chance:0.3}}]},
  ...
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, attacks:[{name:'鐵頭功',dmg:46,cost:3,type:'steel'},{name:'剛劍',dmg:48,cost:3,type:'steel'},{name:'接近戰',dmg:104,cost:19,type:'fighting'},{name:'神秘劍',dmg:110,cost:20,type:'fairy'}]},
  ...
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:350, tier:3, attacks:[{name:'惡之波動',dmg:42,cost:2,type:'dark',status:{effect:'confusion', chance:0.2}},{name:'朽滅之歌',dmg:46,cost:3,type:'flying'},{name:'空氣斬',dmg:90,cost:17,type:'flying'},{name:'夜騷動',dmg:103,cost:19,type:'dark'}]},
  ...
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, attacks:[{name:'火焰噴射',dmg:39,cost:2,type:'fire',status:{effect:'burn', chance:0.25}},{name:'暗黑強打',dmg:42,cost:2,type:'dark'},{name:'超強衝擊',dmg:85,cost:15,type:'fighting'},{name:'赤焰衝擊',dmg:95,cost:17,type:'fire',status:{effect:'burn', chance:0.2}}]},
  // 新增：補足各屬性
  ...
  { id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'夜斬',dmg:34,cost:1,type:'dark'},{name:'追影斬',dmg:38,cost:1,type:'dark'},{name:'精神力',dmg:73,cost:12,type:'psychic',status:{effect:'confusion', chance:0.2}},{name:'暗黑脈衝',dmg:80,cost:14,type:'dark'}]},
...
function triggerOnEnterSrv(poke, role, G, log) {
  ...
  if (poke.ability.id === 'intimidate') {
    ...
    if (opPoke?.ability?.id === 'clear-body') {
      log.push({ text: `${opPoke.name} 的恆淨之軀抵消了${poke.name}的威嚇！`, cls: 'special' });
    } else {
