...
const POKEMON = [
  ...
  { mega:{spriteId:10294, type:'water', type2:'dark', ability:{id:'adaptability', name:'變幻自如', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:658, name:'甲賀忍蛙',       type:'water',    type2:'dark',    hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水手裏劍',dmg:37,cost:3,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'夜斬',dmg:42,cost:3,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'影子偷襲',dmg:119,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:14,cost:1,type:'grass',rider:'mega-charge'}]},
  // Tier 2
  { mega:{spriteId:10034, type:'fire', type2:'dragon', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:6,   name:'噴火龍',     type:'fire',     type2:'flying',  hp:290, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火焰噴射',dmg:27,cost:2,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'龍爪',dmg:12,cost:1,type:'dragon',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:151,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'燕返',dmg:151,cost:12,type:'flying',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水砲',dmg:20,cost:0,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:4},{name:'蟲毒吸能擊',dmg:23,cost:2,type:'bug',rider:'type-draw'},{name:'妖精吸血擊',dmg:143,cost:11,type:'fairy',selfHeal:0.28},{name:'冰凍光束',dmg:143,cost:11,type:'ice',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'神速',dmg:66,cost:5,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:135,cost:11,type:'fire',status:{effect:'freeze', chance:0.15}},{name:'燕返',dmg:135,cost:11,type:'flying',status:{effect:'poison', chance:0.3}},{name:'龍之隕星',dmg:35,cost:3,type:'dragon',rider:'self-cure',status:{effect:'burn', chance:0.25}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:135,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'逆鱗護甲擊',dmg:73,cost:6,type:'dragon',selfHeal:0.17},{name:'毒牙',dmg:131,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'精神強擊',dmg:42,cost:3,type:'psychic',rider:'mega-charge',selfHeal:0.23}]},
  ...
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'暴風雪',dmg:61,cost:6,type:'ice',status:{effect:'freeze', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:131,cost:11,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'幽冥威壓擊',dmg:131,cost:11,type:'ghost',selfHeal:0.22},{name:'橫衝直撞',dmg:73,cost:6,type:'normal',selfHeal:0.25}]},
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:245, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:67,cost:5,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'猛禽炸彈',dmg:149,cost:12,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'龍爪',dmg:149,cost:12,type:'dragon',selfHeal:0.25},{name:'吼叫',dmg:12,cost:1,type:'normal',rider:'type-draw',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'steel-domain', name:'鋼鐵支配', trigger:'onEnter', desc:'上場時場地切換為鋼鐵堡壘；鋼屬性攻擊傷害額外 +40'}, attacks:[{name:'鐵頭功',dmg:81,cost:6,type:'steel',megaBoost:true,bonusEnergy:8},{name:'月亮力量',dmg:138,cost:11,type:'fairy',selfHeal:0.19},{name:'接近戰',dmg:138,cost:11,type:'fighting',selfHeal:0.21},{name:'劇毒威壓擊',dmg:80,cost:6,type:'poison',selfHeal:0.18}]},
  ...
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:142,cost:12,type:'steel',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:95,cost:10,type:'dragon',selfHeal:0.19},{name:'雷霆',dmg:62,cost:5,type:'electric',rider:'mega-charge',selfHeal:0.21},{name:'幽靈之爪',dmg:84,cost:6,type:'ghost',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:26,cost:2,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:70,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'空間扭曲',dmg:131,cost:11,type:'psychic',selfHeal:0.25},{name:'鐵翼',dmg:131,cost:11,type:'steel',selfHeal:0.15}]},
  ...
  { id:526, name:'龐岩怪',     type:'rock',                      hp:280, tier:2, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:12,cost:1,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'逆鱗護甲擊',dmg:42,cost:3,type:'dragon',rider:'energy-steal'},{name:'地震',dmg:138,cost:12,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'岩石炮',dmg:132,cost:11,type:'rock',status:{effect:'poison', chance:0.3}}]},
  ...
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'水槍',dmg:39,cost:3,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:95,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'暗影吸能擊',dmg:66,cost:5,type:'dark',rider:'energy-steal'},{name:'冰凍光束',dmg:97,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  ...
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'水槍',dmg:72,cost:5,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:8},{name:'精神強擊',dmg:104,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'蟲毒護甲擊',dmg:43,cost:3,type:'bug',rider:'self-cure'},{name:'近身戰',dmg:150,cost:15,type:'fighting',selfHeal:0.15}]},
  ...
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'雪崩',dmg:85,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:132,cost:11,type:'rock',selfHeal:0.24},{name:'毒液',dmg:132,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'光合作用強擊',dmg:48,cost:4,type:'grass',rider:'mega-charge',selfHeal:0.17}]},
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:12,cost:1,type:'psychic',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:14,cost:1,type:'electric',rider:'energy-steal'},{name:'幽冥威壓擊',dmg:140,cost:11,type:'ghost',selfHeal:0.2},{name:'冰耳光',dmg:147,cost:12,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10048, type:'dark', type2:'fire', ability:{id:'blaze-boost', name:'太陽之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:229, name:'黑魯加', type:'fire', type2:'dark', hp:280, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'惡意波動',dmg:12,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'火焰牙',dmg:85,cost:7,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'水之脈動',dmg:134,cost:12,type:'water',selfHeal:0.26},{name:'精神吸血擊',dmg:41,cost:3,type:'psychic',rider:'self-cure'}]},
  { id:464, name:'超甲狂犀', type:'ground', type2:'rock', hp:360, tier:3, ability:{id:'ground-domain', name:'風沙支配', trigger:'onEnter', desc:'上場時場地切換為沙塵暴；地面屬性攻擊傷害額外 +40'}, attacks:[{name:'角撞',dmg:141,cost:13,type:'normal',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:73,cost:6,type:'ground',selfHeal:0.18},{name:'岩崩',dmg:131,cost:11,type:'rock',status:{effect:'confusion', chance:0.25}},{name:'惡意突刺',dmg:13,cost:1,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'冰霜拳',dmg:14,cost:1,type:'ice',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:80,cost:6,type:'grass',megaBoost:true,bonusEnergy:4},{name:'劇毒強奪擊',dmg:139,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'破魂吸血擊',dmg:50,cost:4,type:'fighting',rider:'type-draw'}]},
  { mega:{spriteId:10068, type:'psychic', type2:'fighting', ability:{id:'huge-power', name:'精神力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:475, name:'艾路雷朵', type:'psychic', type2:'fighting', hp:260, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'踢腿',dmg:34,cost:3,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:89,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'妖精威壓擊',dmg:23,cost:2,type:'fairy',rider:'mega-charge'},{name:'十萬伏特',dmg:133,cost:13,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { mega:{spriteId:10284, type:'steel', type2:'flying', ability:{id:'solid-rock', name:'頑強', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:227, name:'盔甲鳥', type:'steel', type2:'flying', hp:270, tier:2, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'啄',dmg:66,cost:5,type:'flying',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'鐵頭',dmg:105,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'蟲刃剪',dmg:105,cost:10,type:'bug',megaBoost:true,bonusEnergy:8},{name:'破魂強奪擊',dmg:47,cost:4,type:'fighting',rider:'energy-steal'}]},
  ...
  { mega:{spriteId:10298, type:'rock', type2:'fighting', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:689, name:'龜足巨鎧', type:'rock', type2:'water', hp:260, tier:2, ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'岩石滑落',dmg:43,cost:3,type:'rock',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'鋼影強奪擊',dmg:39,cost:3,type:'steel',rider:'type-draw'},{name:'衝浪',dmg:96,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'妖精吸能擊',dmg:140,cost:14,type:'fairy',selfHeal:0.21}]},
  { mega:{spriteId:10299, type:'poison', type2:'dragon', ability:{id:'thick-fat', name:'再生力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:691, name:'毒藻龍', type:'poison', type2:'dragon', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'惡意突刺',dmg:52,cost:4,type:'poison',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'破魂吸血擊',dmg:34,cost:3,type:'fighting',rider:'energy-steal'},{name:'逆鱗護甲擊',dmg:100,cost:9,type:'dragon',megaBoost:true,bonusEnergy:7},{name:'十字剪',dmg:142,cost:14,type:'bug',selfHeal:0.15}]},
