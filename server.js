...
const POKEMON = [
  ...
  { id:68,  name:'怪力',       type:'fighting', hp:260, tier:1, ability:{id:'guts', name:'毅力', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.3'}, attacks:[{name:'動感拳',dmg:23,cost:2,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'岩石滑落',dmg:62,cost:7,type:'rock',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'詭計',cost:3,type:'fighting',support:true,effect:'trick'},{name:'超強衝擊',dmg:105,cost:12,type:'fighting',selfHeal:0.21}]},
  { mega:{spriteId:10037, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:65,  name:'胡地',       type:'psychic',  hp:200, tier:1, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'超能力',dmg:16,cost:1,type:'psychic',status:{effect:'confusion', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'念力',dmg:15,cost:0,type:'psychic',status:{effect:'confusion', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:55,cost:6,type:'ghost',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'psychic',support:true,effect:'trick'}]},
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'衝撞',dmg:10,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:10,cost:1,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:54,cost:6,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'electric',support:true,effect:'brace'}]},
  ...
  { id:823, name:'鋼鎧鴉',     type:'steel',    type2:'flying',  hp:250, tier:1, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'鐵翼',dmg:17,cost:1,type:'steel',megaBoost:true,bonusEnergy:5},{name:'鋼鐵身壓',dmg:54,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'steel',support:true,effect:'thief'},{name:'颶風飛翔',dmg:92,cost:12,type:'flying',selfHeal:0.28}]},
  ...
  // Tier 2
  { mega:{spriteId:10034, type:'fire', type2:'dragon', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:6,   name:'噴火龍',     type:'fire',     type2:'flying',  hp:290, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'火焰噴射',dmg:16,cost:2,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'龍息',dmg:58,cost:7,type:'dragon',megaBoost:true,bonusEnergy:5},{name:'火焰衝擊',dmg:95,cost:12,type:'fire',status:{effect:'paralysis', chance:0.2}},{name:'破空飛翔',dmg:100,cost:12,type:'flying',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'水砲',dmg:10,cost:0,type:'water',megaBoost:true,bonusEnergy:4},{name:'影舞',cost:2,type:'water',support:true,effect:'shadow-dance'},{name:'衝浪',dmg:90,cost:11,type:'water',selfHeal:0.28},{name:'冰凍光束',dmg:93,cost:11,type:'ice',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10281, type:'dragon', type2:'flying', ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害減半'}}, id:149, name:'快龍',       type:'dragon',   type2:'flying',  hp:320, tier:2, ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害減半'}, attacks:[{name:'龍息',dmg:52,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'雷電',dmg:94,cost:12,type:'electric',status:{effect:'burn', chance:0.25}},{name:'怒風',dmg:96,cost:12,type:'flying',status:{effect:'paralysis', chance:0.2}},{name:'破壞光線',dmg:96,cost:11,type:'normal',status:{effect:'poison', chance:0.3}}]},
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}, attacks:[{name:'磚塊',dmg:75,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'連踢',dmg:120,cost:15,type:'normal',selfHeal:0.25},{name:'地震',dmg:119,cost:15,type:'ground',status:{effect:'freeze', chance:0.15}},{name:'破壞光線',dmg:120,cost:15,type:'normal',selfHeal:0.29}]},
  ...
  { id:157, name:'火爆獸',     type:'fire',                      hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'詭計',cost:3,type:'fire',support:true,effect:'trick'},{name:'地震',dmg:61,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'爆炸火焰',dmg:64,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'烈火強衝',dmg:106,cost:13,type:'fire',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10282, type:'grass', type2:'fairy', ability:{id:'huge-power', name:'太陽核心', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:154, name:'大竺葵',     type:'grass',                     hp:270, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'詭計',cost:3,type:'grass',support:true,effect:'trick'},{name:'大地之力',dmg:73,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'花瓣風暴',dmg:72,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:115,cost:15,type:'grass',status:{effect:'paralysis', chance:0.2}}]},
  // Tier 3
  { id:383, name:'固拉多',     type:'ground',   hp:340, tier:3, ability:{id:'huge-power', name:'日照', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'地震',dmg:58,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:101,cost:13,type:'rock',selfHeal:0.22},{name:'火焰噴射',dmg:102,cost:13,type:'fire',status:{effect:'confusion', chance:0.25}},{name:'原始大地',dmg:105,cost:13,type:'fire',selfHeal:0.26}]},
  { id:382, name:'蓋歐卡',     type:'water',    hp:340, tier:3, ability:{id:'adaptability', name:'降雨', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}, attacks:[{name:'源起之波',dmg:56,cost:7,type:'water',megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:101,cost:12,type:'electric',status:{effect:'burn', chance:0.25}},{name:'大浪',dmg:98,cost:12,type:'water',selfHeal:0.16},{name:'原始海洋',dmg:97,cost:13,type:'ice',selfHeal:0.21}]},
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:360, tier:3, ability:{id:'huge-power', name:'氣閘', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'神速',dmg:69,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:109,cost:14,type:'fire',status:{effect:'freeze', chance:0.15}},{name:'怒風',dmg:108,cost:14,type:'flying',status:{effect:'poison', chance:0.3}},{name:'龍之隕星',dmg:109,cost:14,type:'dragon',status:{effect:'burn', chance:0.25}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'電磁衝浪',dmg:73,cost:9,type:'electric',status:{effect:'paralysis', chance:0.25},megaBoost:true,bonusEnergy:7},{name:'龍息',dmg:118,cost:14,type:'dragon',selfHeal:0.17},{name:'電磁炮',dmg:118,cost:14,type:'electric',status:{effect:'poison', chance:0.3}},{name:'未來雷霆',dmg:115,cost:15,type:'psychic',selfHeal:0.23}]},
  ...
  { id:1007,name:'故勒頓',     type:'fighting', type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'緋紅脈動', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'決勝衝擊',dmg:69,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:113,cost:14,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:113,cost:14,type:'ground',status:{effect:'sleep', chance:0.2}},{name:'遠古之力',dmg:116,cost:14,type:'rock',selfHeal:0.3}]},
  ...
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'huge-power', name:'不撓之劍', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'鐵頭功',dmg:75,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'剛劍',dmg:120,cost:15,type:'steel',selfHeal:0.19},{name:'接近戰',dmg:120,cost:15,type:'fighting',selfHeal:0.21},{name:'神秘劍',dmg:120,cost:14,type:'fairy',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:330, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}, attacks:[{name:'月亮力量',dmg:60,cost:7,type:'fairy',megaBoost:true,bonusEnergy:5},{name:'仙子之息',dmg:101,cost:12,type:'fairy',status:{effect:'paralysis', chance:0.2}},{name:'光之波動',dmg:99,cost:12,type:'fairy',status:{effect:'freeze', chance:0.15}},{name:'精神強擊',dmg:102,cost:12,type:'psychic',selfHeal:0.15}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}, attacks:[{name:'暴風雪',dmg:74,cost:10,type:'ice',status:{effect:'freeze', chance:0.2},megaBoost:true,bonusEnergy:8},{name:'閃光炮',dmg:119,cost:15,type:'steel',status:{effect:'paralysis', chance:0.2}},{name:'冰耳光',dmg:118,cost:14,type:'ice',status:{effect:'confusion', chance:0.25}},{name:'電磁砲',dmg:115,cost:15,type:'electric',status:{effect:'burn', chance:0.25}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:350, tier:3, ability:{id:'adaptability', name:'暗黑氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}, attacks:[{name:'惡之波動',dmg:68,cost:9,type:'dark',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'朽滅之歌',dmg:112,cost:14,type:'flying',selfHeal:0.16},{name:'空氣斬',dmg:108,cost:14,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'夜騷動',dmg:112,cost:14,type:'dark',selfHeal:0.26}]},
  ...
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'火焰噴射',dmg:29,cost:3,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'暗黑強打',dmg:65,cost:9,type:'dark',megaBoost:true,bonusEnergy:7},{name:'超強衝擊',dmg:105,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}},{name:'赤焰衝擊',dmg:108,cost:13,type:'fire',selfHeal:0.2}]},
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'橫衝直撞',dmg:12,cost:1,type:'normal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'normal',support:true,effect:'brace'},{name:'地震',dmg:51,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'強力碰撞',dmg:96,cost:12,type:'normal',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'frisk-ward', name:'隔音', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'噴火',dmg:52,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:50,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:90,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'電球',dmg:19,cost:2,type:'electric',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'能量球',dmg:61,cost:8,type:'grass',status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:59,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'冥想',cost:3,type:'grass',support:true,effect:'meditate'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'纏繞',dmg:12,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:12,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:50,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'}]},
  ...
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'連續攻擊',dmg:26,cost:3,type:'normal',megaBoost:true,bonusEnergy:6},{name:'影舞',cost:2,type:'fighting',support:true,effect:'shadow-dance'},{name:'居合斬',dmg:63,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:101,cost:13,type:'fighting',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}, attacks:[{name:'壓制',dmg:15,cost:1,type:'normal',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:54,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'豪腕',dmg:95,cost:12,type:'fighting',selfHeal:0.22},{name:'集氣',cost:3,type:'fighting',support:true,effect:'focus-energy',bonusEnergy:9}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×2（原本 ×1.5）'}, attacks:[{name:'冥想',cost:3,type:'water',support:true,effect:'meditate'},{name:'夜斬',dmg:17,cost:1,type:'dark',megaBoost:true,bonusEnergy:5},{name:'亂爪',dmg:57,cost:8,type:'dark',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:102,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'砂子攻擊',dmg:36,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'小偷',cost:5,type:'normal',support:true,effect:'thief'},{name:'地震',dmg:74,cost:9,type:'ground',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:116,cost:14,type:'rock',selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'撐住',cost:5,type:'steel',support:true,effect:'brace'},{name:'金屬爪',dmg:17,cost:1,type:'steel',megaBoost:true,bonusEnergy:5},{name:'鋼鐵頭',dmg:53,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'蟲之抵抗',dmg:95,cost:12,type:'bug',status:{effect:'paralysis', chance:0.2}}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'蟲咬',dmg:12,cost:0,type:'bug',megaBoost:true,bonusEnergy:4},{name:'灼熱',cost:1,type:'bug',support:true,effect:'debuff',status:{effect:'burn', chance:1}},{name:'岩石封鎖',dmg:55,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'X 剪刀',dmg:95,cost:12,type:'bug',status:{effect:'burn', chance:0.25}}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.3'}, attacks:[{name:'集氣',cost:3,type:'ground',support:true,effect:'focus-energy',bonusEnergy:9},{name:'喊叫',dmg:25,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:66,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'骨棒',dmg:103,cost:14,type:'ground',selfHeal:0.25}]},
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'夜襲',dmg:34,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'念力',dmg:34,cost:4,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:74,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'灼熱',cost:1,type:'rock',support:true,effect:'debuff',status:{effect:'burn', chance:1}}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'音爆拳',dmg:16,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:59,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:98,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'咬住',dmg:10,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'吼叫',dmg:50,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'normal',support:true,effect:'trick'},{name:'火焰牙',dmg:52,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'water-absorb', name:'儲水', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'水槍',dmg:24,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'迴旋踢',dmg:65,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'撐住',cost:5,type:'water',support:true,effect:'brace'},{name:'冰凍光束',dmg:67,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'針刺',dmg:17,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'毒針',dmg:16,cost:1,type:'poison',megaBoost:true,bonusEnergy:5},{name:'十字剪',dmg:56,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'bug',support:true,effect:'brace'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'金屬音',dmg:26,cost:3,type:'steel',megaBoost:true,bonusEnergy:6},{name:'頭槌',dmg:27,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:60,cost:8,type:'rock',megaBoost:true,bonusEnergy:6},{name:'撐住',cost:5,type:'rock',support:true,effect:'brace'}]},
  { mega:{spriteId:10064, type:'water', type2:'ground', ability:{id:'huge-power', name:'飛毛腿', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:260, name:'巨沼怪', type:'water', type2:'ground', hp:300, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'水槍',dmg:29,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:62,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:106,cost:13,type:'ground',status:{effect:'confusion', chance:0.25}},{name:'冰凍拳',dmg:105,cost:13,type:'ice',status:{effect:'confusion', chance:0.25}}]},
  ...
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'blaze-boost', name:'摘取', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'飛葉快刀',dmg:20,cost:1,type:'grass',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:60,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'幽靈箭',dmg:103,cost:12,type:'ghost',status:{effect:'burn', chance:0.25}},{name:'光合作用強擊',dmg:98,cost:13,type:'grass',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'毒針',dmg:13,cost:0,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:50,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'},{name:'惡意突刺',dmg:90,cost:11,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  ...
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'蟲咬',dmg:34,cost:4,type:'bug',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:69,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'蟲鳴',dmg:66,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'撐住',cost:5,type:'bug',support:true,effect:'brace'}]},
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'泥巴射擊',dmg:38,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'影子偷襲',dmg:75,cost:10,type:'ghost',megaBoost:true,bonusEnergy:8},{name:'地震',dmg:120,cost:15,type:'ground',selfHeal:0.22},{name:'惡靈波動',dmg:116,cost:15,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'水槍',dmg:40,cost:5,type:'water',megaBoost:true,bonusEnergy:8},{name:'念力',dmg:74,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'集氣',cost:3,type:'water',support:true,effect:'focus-energy',bonusEnergy:9},{name:'精神強擊',dmg:120,cost:15,type:'psychic',selfHeal:0.15}]},
  ...
  { mega:{spriteId:10316, type:'bug', type2:'steel', ability:{id:'solid-rock', name:'重甲化', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:768, name:'具甲武者', type:'bug', type2:'water', hp:290, tier:2, ability:{id:'blaze-boost', name:'突襲', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'水流手裏劍',dmg:21,cost:2,type:'water',megaBoost:true,bonusEnergy:6},{name:'蟲咬',dmg:58,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'X 剪刀',dmg:98,cost:13,type:'bug',selfHeal:0.17},{name:'水炮',dmg:101,cost:13,type:'water',status:{effect:'paralysis', chance:0.2}}]},
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×2（原本 ×1.5）'}, attacks:[{name:'魔法葉',dmg:38,cost:4,type:'grass',megaBoost:true,bonusEnergy:7},{name:'藤鞭',dmg:70,cost:10,type:'grass',megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:119,cost:15,type:'normal',status:{effect:'confusion', chance:0.25}},{name:'能量球',dmg:114,cost:15,type:'grass',status:{effect:'poison', chance:0.3}}]},
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'冰凍拳',dmg:55,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:92,cost:11,type:'rock',selfHeal:0.24},{name:'暴風雪',dmg:96,cost:11,type:'ice',status:{effect:'poison', chance:0.3}},{name:'雪崩',dmg:92,cost:11,type:'ice',selfHeal:0.17}]},
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'念力',dmg:18,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'擾亂精神',cost:1,type:'psychic',support:true,effect:'debuff',status:{effect:'confusion', chance:1}},{name:'精神強擊',dmg:94,cost:11,type:'psychic',selfHeal:0.2},{name:'未來預知',dmg:99,cost:12,type:'psychic',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10048, type:'dark', type2:'fire', ability:{id:'blaze-boost', name:'太陽之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}}, id:229, name:'黑魯加', type:'fire', type2:'dark', hp:280, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'夜斬',dmg:18,cost:1,type:'dark',megaBoost:true,bonusEnergy:5},{name:'火焰牙',dmg:55,cost:7,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:95,cost:12,type:'dark',selfHeal:0.26},{name:'詭計',cost:3,type:'fire',support:true,effect:'trick'}]},
  { id:464, name:'超甲狂犀', type:'ground', type2:'rock', hp:360, tier:3, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'角撞',dmg:70,cost:10,type:'normal',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:116,cost:14,type:'ground',selfHeal:0.18},{name:'岩崩',dmg:116,cost:14,type:'rock',status:{effect:'confusion', chance:0.25}},{name:'地震',dmg:111,cost:14,type:'ground',status:{effect:'poison', chance:0.3}}]},
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:350, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}, attacks:[{name:'冰凍拳',dmg:66,cost:8,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:109,cost:14,type:'ground',selfHeal:0.28},{name:'雪崩',dmg:109,cost:14,type:'ice',selfHeal:0.25},{name:'冰牙',dmg:108,cost:14,type:'ice',status:{effect:'poison', chance:0.3}}]},
  { id:625, name:'劈斬司令', type:'dark', type2:'steel', hp:330, tier:3, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.3'}, attacks:[{name:'金屬爪',dmg:55,cost:7,type:'steel',megaBoost:true,bonusEnergy:5},{name:'夜斬',dmg:97,cost:13,type:'dark',selfHeal:0.16},{name:'惡意突刺',dmg:95,cost:12,type:'dark',selfHeal:0.23},{name:'鐵頭功',dmg:100,cost:12,type:'steel',selfHeal:0.3}]},
  /* ── Mega 進化擴充（Legends Z-A / 原有 46 種缺漏補完） ── */
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'啄',dmg:21,cost:2,type:'flying',megaBoost:true,bonusEnergy:6},{name:'疾風拳',dmg:22,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:61,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'}]},
  { mega:{spriteId:10039, type:'normal', type2:null, ability:{id:'huge-power', name:'親子羈絆', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:115, name:'袋獸', type:'normal', hp:280, tier:2, ability:{id:'guts', name:'根性', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.3'}, attacks:[{name:'扒',dmg:15,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'連環巴掌',dmg:55,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'normal',support:true,effect:'brace'},{name:'地震',dmg:96,cost:12,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10072, type:'steel', type2:'ground', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}}, id:208, name:'大鋼蛇', type:'steel', type2:'ground', hp:290, tier:2, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'綁緊',dmg:26,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'鐵尾',dmg:63,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:101,cost:13,type:'ground',selfHeal:0.17},{name:'重磅衝撞',dmg:106,cost:13,type:'steel',selfHeal:0.2}]},
  { mega:{spriteId:10050, type:'fire', type2:'fighting', ability:{id:'huge-power', name:'加速', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:257, name:'火焰雞', type:'fire', type2:'fighting', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'踢腿',dmg:29,cost:4,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:65,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'烈焰衝浪腳',dmg:68,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'小偷',cost:5,type:'fire',support:true,effect:'thief'}]},
  { mega:{spriteId:10066, type:'dark', type2:'ghost', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}}, id:302, name:'勾魂眼', type:'dark', type2:'ghost', hp:200, tier:1, ability:{id:'frisk-ward', name:'洞察力', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'暗影球',dmg:17,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'dark',support:true,effect:'thief'},{name:'寶石爆破',dmg:54,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:94,cost:12,type:'dark',selfHeal:0.25}]},
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'啃咬',dmg:10,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:14,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'steel',support:true,effect:'trick'},{name:'重磅衝撞',dmg:91,cost:11,type:'steel',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10053, type:'steel', type2:null, ability:{id:'solid-rock', name:'過濾', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:306, name:'波士可多拉', type:'steel', type2:'rock', hp:310, tier:2, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'金屬爪',dmg:37,cost:5,type:'steel',megaBoost:true,bonusEnergy:8},{name:'岩石滑落',dmg:75,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'重磅衝撞',dmg:116,cost:15,type:'steel',selfHeal:0.18},{name:'劈斬',dmg:116,cost:15,type:'steel',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'空手劈',dmg:15,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:18,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'fighting',support:true,effect:'thief'},{name:'惡意彈珠',dmg:96,cost:12,type:'dark',selfHeal:0.3}]},
  ...
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'連續拳',dmg:26,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速星星拳',dmg:23,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速旋轉踢',dmg:65,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'電磁波',cost:1,type:'normal',support:true,effect:'debuff',status:{effect:'paralysis', chance:1}}]},
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'冰霜拳',dmg:11,cost:1,type:'ice',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:50,cost:6,type:'grass',megaBoost:true,bonusEnergy:4},{name:'暴風雪',dmg:90,cost:11,type:'ice',status:{effect:'poison', chance:0.3}},{name:'劍舞',cost:4,type:'grass',support:true,effect:'sword-dance'}]},
  { mega:{spriteId:10068, type:'psychic', type2:'fighting', ability:{id:'huge-power', name:'精神力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:475, name:'艾路雷朵', type:'psychic', type2:'fighting', hp:260, tier:2, ability:{id:'guts', name:'不屈之心', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 ×1.3'}, attacks:[{name:'空手劈',dmg:21,cost:3,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:59,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'影舞',cost:2,type:'psychic',support:true,effect:'shadow-dance'},{name:'近身戰',dmg:103,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}}]},
  { mega:{spriteId:10069, type:'normal', type2:'fairy', ability:{id:'thick-fat', name:'治癒之心', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}}, id:531, name:'差不多娃娃', type:'normal', hp:300, tier:2, ability:{id:'thick-fat', name:'回復力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.6'}, attacks:[{name:'拍打',dmg:28,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'音爆拳',dmg:64,cost:8,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:109,cost:13,type:'normal',selfHeal:0.28},{name:'日光束',dmg:103,cost:13,type:'grass',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10312, type:'dark', type2:null, ability:{id:'tough-claws', name:'暗影', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:491, name:'達克萊伊', type:'dark', hp:310, tier:3, ability:{id:'tough-claws', name:'惡夢', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}, attacks:[{name:'惡意彈珠',dmg:36,cost:5,type:'dark',megaBoost:true,bonusEnergy:8},{name:'暗影球',dmg:75,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7},{name:'黑暗脈動',dmg:119,cost:14,type:'dark',selfHeal:0.26},{name:'暗黑爆破',dmg:120,cost:14,type:'dark',status:{effect:'burn', chance:0.25}}]},
  { mega:{spriteId:10286, type:'fire', type2:'fighting', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:500, name:'炎武王', type:'fire', type2:'fighting', hp:300, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'火花',dmg:27,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:62,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'熔岩爆發',dmg:103,cost:12,type:'fire',selfHeal:0.28},{name:'超級power',dmg:106,cost:13,type:'fighting',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'空手劈',dmg:39,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'詭計',cost:3,type:'fighting',support:true,effect:'trick'},{name:'近身戰',dmg:73,cost:10,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:120,cost:15,type:'flying',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10301, type:'dragon', type2:'ground', ability:{id:'solid-rock', name:'極巨腺體', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:718, name:'基格爾德', type:'dragon', type2:'ground', hp:360, tier:3, ability:{id:'solid-rock', name:'終結之地', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'咬碎',dmg:74,cost:10,type:'dark',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:119,cost:15,type:'ground',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:116,cost:15,type:'ground',status:{effect:'paralysis', chance:0.2}},{name:'龍爪',dmg:114,cost:14,type:'dragon',selfHeal:0.21}]},
  { mega:{spriteId:10315, type:'fighting', type2:'ice', ability:{id:'tough-claws', name:'鐵拳', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:740, name:'好勝毛蟹', type:'fighting', type2:'ice', hp:270, tier:2, ability:{id:'tough-claws', name:'鐵拳', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}, attacks:[{name:'撐住',cost:5,type:'fighting',support:true,effect:'brace'},{name:'空手劈',dmg:72,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'冰凍拳',dmg:70,cost:9,type:'ice',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:117,cost:14,type:'fighting',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10320, type:'grass', type2:'fire', ability:{id:'blaze-boost', name:'辣椒噴霧', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}}, id:952, name:'狠辣椒', type:'grass', type2:'fire', hp:220, tier:1, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'藤鞭',dmg:19,cost:2,type:'grass',megaBoost:true,bonusEnergy:6},{name:'冥想',cost:3,type:'grass',support:true,effect:'meditate'},{name:'葉刃',dmg:58,cost:8,type:'grass',megaBoost:true,bonusEnergy:6},{name:'大字爆炎',dmg:102,cost:12,type:'fire',status:{effect:'paralysis', chance:0.2}}]},
