...
const POKEMON = [
  // Tier 1
  { mega:{spriteId:10033, type:'grass', type2:'poison', ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:3,   name:'妙蛙花',     type:'grass',    type2:'poison',  hp:250, tier:1, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'逆鱗吸能擊',dmg:43,cost:3,type:'dragon',rider:'energy-steal'},{name:'惡意突刺',dmg:84,cost:7,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:5},{name:'藤鞭',dmg:72,cost:5,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'大地之力',dmg:152,cost:12,type:'ground',ignoreReflect:true,status:{effect:'burn', chance:0.25}}]},
  { mega:{spriteId:10038, type:'ghost', type2:'poison', ability:{id:'frisk-ward', name:'踩影', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:94,  name:'耿鬼',       type:'ghost',    type2:'poison',  hp:220, tier:1, ability:{id:'poison-heal', name:'毒療', trigger:'onStatus', desc:'中毒時每回合回復 1/8 最大HP，而非扣血'}, attacks:[{name:'催眠術',dmg:37,cost:3,type:'psychic',rider:'mega-charge',status:{effect:'sleep', chance:0.5},megaBoost:true,bonusEnergy:6},{name:'幽靈之爪',dmg:43,cost:3,type:'ghost',rider:'type-draw',status:{effect:'poison', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'污泥炸彈',dmg:118,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'妖精護甲擊',dmg:29,cost:2,type:'fairy',rider:'self-cure'}]},
  ...
  { mega:{spriteId:10037, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:65,  name:'胡地',       type:'psychic',  hp:200, tier:1, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'超能力',dmg:12,cost:1,type:'psychic',rider:'self-cure',status:{effect:'confusion', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'寶石爆破',dmg:21,cost:0,type:'rock',ignoreReflect:true,status:{effect:'confusion', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:102,cost:6,type:'ghost',megaBoost:true,bonusEnergy:4},{name:'冰霜吸血擊',dmg:42,cost:3,type:'ice',rider:'type-draw'}]},
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'橫衝直撞',dmg:19,cost:0,type:'normal',rider:'type-draw',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:14,cost:1,type:'electric',rider:'energy-steal',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'石刃',dmg:120,cost:6,type:'rock',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'逆鱗威壓擊',dmg:71,cost:5,type:'dragon',rider:'mega-charge'}]},
  ...
  { mega:{spriteId:10059, type:'fighting', type2:'steel', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:448, name:'路卡利歐',   type:'fighting', type2:'steel',   hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'灼熱護甲擊',dmg:13,cost:1,type:'fire',rider:'energy-steal'},{name:'金屬爪',dmg:44,cost:3,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'龍之脈動',dmg:115,cost:8,type:'dragon',megaBoost:true,bonusEnergy:6},{name:'暗影球',dmg:168,cost:14,type:'ghost',selfHeal:0.18}]},
  ...
  { id:87,  name:'白海獅',     type:'water',    type2:'ice',     hp:240, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害+40'}, attacks:[{name:'冷凍光線',dmg:38,cost:3,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'荒草吸血擊',dmg:43,cost:3,type:'grass',rider:'mega-charge'},{name:'大浪',dmg:100,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'未來雷霆',dmg:148,cost:11,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { id:82,  name:'三合一磁怪',   type:'electric', type2:'steel',   hp:210, tier:1, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'電磁炮',dmg:29,cost:2,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:39,cost:3,type:'poison',rider:'mega-charge'},{name:'金屬音',dmg:108,cost:8,type:'steel',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'衝浪',dmg:157,cost:12,type:'water',selfHeal:0.18}]},
  { id:28,  name:'穿山王',     type:'ground',   hp:240, tier:1, ability:{id:'ground-domain', name:'風沙支配', trigger:'onEnter', desc:'上場時場地切換為沙塵暴；地面屬性攻擊傷害額外 +40'}, attacks:[{name:'精神吸能擊',dmg:14,cost:1,type:'psychic',rider:'energy-steal'},{name:'地震',dmg:100,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'岩石碎裂',dmg:96,cost:6,type:'rock',megaBoost:true,bonusEnergy:4},{name:'水之脈動',dmg:144,cost:11,type:'water',status:{effect:'sleep', chance:0.2}}]},
  ...
  { id:823, name:'鋼鎧鴉',     type:'steel',    type2:'flying',  hp:250, tier:1, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'鐵翼',dmg:13,cost:1,type:'steel',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'空氣斬',dmg:87,cost:6,type:'flying',megaBoost:true,bonusEnergy:5},{name:'激流強奪擊',dmg:63,cost:8,type:'water',rider:'card-steal'},{name:'念力衝擊',dmg:142,cost:12,type:'psychic',selfHeal:0.28}]},
  ...
  { mega:{spriteId:10294, type:'water', type2:'dark', ability:{id:'adaptability', name:'變幻自如', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:658, name:'甲賀忍蛙',       type:'water',    type2:'dark',    hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水手裏劍',dmg:37,cost:3,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'夜斬',dmg:42,cost:3,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'影子偷襲',dmg:119,cost:9,type:'ghost',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:14,cost:1,type:'grass',rider:'mega-charge'}]},
  // Tier 2
  ...
  { id:614, name:'凍原熊',     type:'ice',      hp:215, tier:2, ability:{id:'ice-domain', name:'冰霜支配', trigger:'onEnter', desc:'上場時場地切換為永凍冰原；冰屬性攻擊傷害額外 +40'}, attacks:[{name:'冰耳光',dmg:43,cost:3,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'大浪',dmg:137,cost:12,type:'water',status:{effect:'poison', chance:0.3}},{name:'火焰噴射',dmg:87,cost:6,type:'fire',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:137,cost:12,type:'ground',status:{effect:'poison', chance:0.3}}]},
  ...
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'未來雷霆',dmg:41,cost:3,type:'psychic',rider:'mega-charge',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:49,cost:4,type:'flying',rider:'type-draw',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:88,cost:9,type:'ice',rider:'guard-up'},{name:'幽靈球',dmg:138,cost:13,type:'ghost',ignoreReflect:true,status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10051, type:'psychic', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:282, name:'沙奈朵',     type:'psychic',  type2:'fairy',   hp:205, tier:3, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'妖精之力',dmg:83,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:135,cost:11,type:'ghost',selfHeal:0.26},{name:'毒針',dmg:135,cost:11,type:'poison',status:{effect:'poison', chance:0.3}},{name:'精神強擊',dmg:39,cost:3,type:'psychic',rider:'energy-steal',selfHeal:0.24}]},
  ...
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:245, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:67,cost:5,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'猛禽炸彈',dmg:149,cost:12,type:'flying',ignoreReflect:true,status:{effect:'sleep', chance:0.2}},{name:'龍爪',dmg:149,cost:12,type:'dragon',selfHeal:0.25},{name:'吼叫',dmg:12,cost:1,type:'normal',rider:'type-draw',status:{effect:'paralysis', chance:0.2}}]},
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:200, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'火焰衝擊',dmg:135,cost:11,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:51,cost:4,type:'psychic',rider:'energy-steal',status:{effect:'confusion', chance:0.15},selfHeal:0.16},{name:'十萬伏特',dmg:76,cost:9,type:'electric',status:{effect:'paralysis', chance:0.2}},{name:'怒風',dmg:13,cost:1,type:'flying',ignoreReflect:true,selfHeal:0.28}]},
  ...
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:26,cost:2,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:70,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'空間扭曲',dmg:131,cost:11,type:'psychic',ignoreReflect:true,selfHeal:0.25},{name:'鐵翼',dmg:131,cost:11,type:'steel',selfHeal:0.15}]},
  ...
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:14,cost:1,type:'normal',rider:'energy-steal',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:63,cost:5,type:'fire',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:97,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'夜襲',dmg:151,cost:12,type:'dark',selfHeal:0.21}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'疾風威壓擊',dmg:40,cost:3,type:'flying',rider:'self-cure'},{name:'大字爆炎',dmg:98,cost:6,type:'fire',status:{effect:'burn', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:96,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'破壞光線',dmg:144,cost:11,type:'normal',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:21,cost:0,type:'normal',rider:'mega-charge',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:19,cost:0,type:'poison',rider:'type-draw',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'地震',dmg:96,cost:6,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:62,cost:5,type:'steel',ignoreReflect:true,rider:'guard-up'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'蟲毒強奪擊',dmg:39,cost:3,type:'bug',rider:'energy-steal'},{name:'毒液',dmg:58,cost:4,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:7},{name:'衝浪',dmg:120,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:170,cost:14,type:'fire',status:{effect:'burn', chance:0.25}}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'妖精吸血擊',dmg:12,cost:1,type:'fairy',rider:'mega-charge'},{name:'夜襲',dmg:54,cost:4,type:'dark',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:125,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'劇毒威壓擊',dmg:179,cost:14,type:'poison',selfHeal:0.27}]},
  ...
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'神速吸能擊',dmg:20,cost:0,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'暴風',dmg:97,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:50,cost:8,type:'grass',rider:'energy-steal'},{name:'夜騷動',dmg:148,cost:12,type:'dark',selfHeal:0.25}]},
  ...
  { id:469, name:'遠古巨蜓',   type:'bug',      type2:'flying',  hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'空氣斬',dmg:50,cost:4,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.2},megaBoost:true,bonusEnergy:7},{name:'雷光威壓擊',dmg:85,cost:6,type:'electric',rider:'weaken'},{name:'蟲鳴',dmg:120,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'實力全開',dmg:174,cost:14,type:'normal',selfHeal:0.25}]},
  ...
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'幽靈球',dmg:40,cost:3,type:'ghost',ignoreReflect:true,status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:35,cost:3,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'月亮力量',dmg:113,cost:8,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:35,cost:3,type:'flying',rider:'energy-steal'}]},
  ...
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:53,cost:4,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'光合作用強擊',dmg:46,cost:4,type:'grass',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:40,cost:3,type:'fairy',rider:'energy-steal'},{name:'鐵尾',dmg:163,cost:14,type:'steel',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:36,cost:3,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:28,cost:2,type:'steel',ignoreReflect:true,rider:'energy-steal'},{name:'碎岩',dmg:112,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'暗黑脈衝',dmg:157,cost:13,type:'dark',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'突擊',dmg:12,cost:1,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:84,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'魔法閃耀',dmg:134,cost:12,type:'fairy',selfHeal:0.22},{name:'蟲毒護甲擊',dmg:41,cost:3,type:'bug',rider:'energy-steal'}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'神速強奪擊',dmg:42,cost:3,type:'normal',ignoreReflect:true,rider:'card-steal'},{name:'夜斬',dmg:12,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'水槍',dmg:104,cost:8,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:158,cost:13,type:'ground',status:{effect:'burn', chance:0.25}}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'地震',dmg:70,cost:5,type:'ground',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'灼熱吸血擊',dmg:62,cost:5,type:'fire',rider:'type-draw'},{name:'衝撞',dmg:125,cost:9,type:'normal',megaBoost:true,bonusEnergy:7},{name:'岩崩',dmg:175,cost:14,type:'rock',ignoreReflect:true,selfHeal:0.21}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'bug-domain', name:'蟲群支配', trigger:'onEnter', desc:'上場時場地切換為蟲群巢穴；蟲屬性攻擊傷害額外 +40'}, attacks:[{name:'冰霜威壓擊',dmg:117,cost:8,type:'ice',rider:'move-reflect'},{name:'金屬爪',dmg:13,cost:1,type:'steel',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'蟲咬',dmg:100,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:150,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'蟲咬',dmg:19,cost:0,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:14,cost:1,type:'grass',rider:'self-cure'},{name:'岩石封鎖',dmg:102,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'烈火強衝',dmg:150,cost:12,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.25}}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'蟲毒護甲擊',dmg:38,cost:3,type:'bug',rider:'self-cure'},{name:'喊叫',dmg:29,cost:2,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'地震',dmg:115,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:160,cost:14,type:'ghost',selfHeal:0.25}]},
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'夜襲',dmg:54,cost:4,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'念力',dmg:48,cost:4,type:'psychic',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:125,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'疾風強奪擊',dmg:12,cost:1,type:'flying',rider:'mega-charge'}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'岩崩吸血擊',dmg:43,cost:3,type:'rock',rider:'energy-steal'},{name:'音爆拳',dmg:13,cost:1,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'啃咬',dmg:107,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'吼叫',dmg:154,cost:12,type:'normal',ignoreReflect:true,status:{effect:'confusion', chance:0.25}}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'咬住',dmg:19,cost:0,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'龍之隕星',dmg:96,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'破魂威壓擊',dmg:37,cost:3,type:'fighting',ignoreReflect:true,rider:'weaken'},{name:'火焰牙',dmg:98,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  ...
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'針刺',dmg:12,cost:1,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'毒針',dmg:14,cost:1,type:'poison',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'閃電拳',dmg:103,cost:7,type:'electric',megaBoost:true,bonusEnergy:5},{name:'冰霜護甲擊',dmg:70,cost:5,type:'ice',rider:'self-cure'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'金屬音',dmg:35,cost:3,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'頭槌',dmg:27,cost:2,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:108,cost:8,type:'rock',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'妖精強奪擊',dmg:68,cost:5,type:'fairy',rider:'self-cure'}]},
  ...
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:235, tier:3, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'雪崩',dmg:131,cost:11,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'地震',dmg:131,cost:12,type:'ground',selfHeal:0.28},{name:'啃咬',dmg:39,cost:3,type:'dark',ignoreReflect:true,status:{effect:'freeze', chance:0.15},selfHeal:0.25},{name:'毒針',dmg:34,cost:3,type:'poison',rider:'mega-charge',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'破空飛翔',dmg:23,cost:2,type:'flying',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'電光一閃',dmg:27,cost:2,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'幽冥威壓擊',dmg:109,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:50,cost:8,type:'poison',rider:'weaken'}]},
  ...
  { mega:{spriteId:10066, type:'dark', type2:'ghost', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:302, name:'勾魂眼', type:'dark', type2:'ghost', hp:200, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:13,cost:1,type:'ghost',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'蟲毒吸血擊',dmg:59,cost:5,type:'bug',ignoreReflect:true,rider:'life-drain'},{name:'寶石爆破',dmg:101,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:149,cost:12,type:'dark',selfHeal:0.25}]},
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'啃咬',dmg:22,cost:0,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:19,cost:0,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'幽冥威壓擊',dmg:43,cost:3,type:'ghost',ignoreReflect:true,rider:'weaken'},{name:'毒牙',dmg:145,cost:11,type:'poison',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10053, type:'steel', type2:null, ability:{id:'solid-rock', name:'過濾', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:306, name:'波士可多拉', type:'steel', type2:'rock', hp:200, tier:2, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'金屬爪',dmg:68,cost:5,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'岩石滑落',dmg:12,cost:1,type:'rock',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'幽冥威壓擊',dmg:146,cost:15,type:'ghost',selfHeal:0.18},{name:'雪崩',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'氣功拳',dmg:12,cost:1,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:14,cost:1,type:'psychic',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'岩崩吸能擊',dmg:62,cost:5,type:'rock',rider:'energy-steal'},{name:'惡意彈珠',dmg:151,cost:12,type:'dark',ignoreReflect:true,selfHeal:0.3}]},
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'十萬伏特',dmg:70,cost:5,type:'electric',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'大地護甲擊',dmg:37,cost:3,type:'ground',ignoreReflect:true,rider:'guard-up'},{name:'吼叫',dmg:124,cost:10,type:'normal',megaBoost:true,bonusEnergy:8},{name:'火焰牙',dmg:176,cost:15,type:'fire',selfHeal:0.26}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'衝浪',dmg:50,cost:4,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'劇毒強奪擊',dmg:114,cost:8,type:'poison',rider:'move-reflect'},{name:'咬碎',dmg:73,cost:6,type:'dark',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:176,cost:14,type:'ice',selfHeal:0.18}]},
  ...
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:12,cost:1,type:'ghost',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'雷光吸能擊',dmg:41,cost:3,type:'electric',rider:'type-draw'},{name:'暗黑爆破',dmg:106,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'空間扭曲',dmg:149,cost:12,type:'psychic',ignoreReflect:true,selfHeal:0.19}]},
  ...
  { mega:{spriteId:10089, type:'dragon', type2:'flying', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:373, name:'暴飛龍', type:'dragon', type2:'flying', hp:220, tier:3, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'咬碎',dmg:132,cost:11,type:'dark',megaBoost:true,bonusEnergy:6},{name:'龍之氣息',dmg:87,cost:6,type:'dragon',selfHeal:0.27},{name:'冰霜吸血擊',dmg:138,cost:12,type:'ice',status:{effect:'freeze', chance:0.15}},{name:'燕返',dmg:11,cost:1,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.25}}]},
  ...
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'破壞光線',dmg:28,cost:2,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'連續切',dmg:25,cost:2,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:114,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'精神強奪擊',dmg:13,cost:1,type:'psychic',rider:'mega-charge'}]},
  ...
  { mega:{spriteId:10279, type:'grass', type2:'poison', ability:{id:'tough-claws', name:'揭露之貌', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:71, name:'大食花', type:'grass', type2:'poison', hp:230, tier:1, ability:{id:'blaze-boost', name:'葉綠素', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'激流護甲擊',dmg:57,cost:4,type:'water',rider:'type-draw'},{name:'惡意突刺',dmg:51,cost:4,type:'poison',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:125,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'鐵頭',dmg:178,cost:15,type:'steel',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:24,cost:2,type:'psychic',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'大地吸血擊',dmg:70,cost:5,type:'ground',rider:'mega-charge'},{name:'破魂威壓擊',dmg:107,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:155,cost:13,type:'normal',selfHeal:0.25}]},
  ...
  { mega:{spriteId:10289, type:'dark', type2:'fighting', ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:560, name:'頭巾混混', type:'dark', type2:'fighting', hp:240, tier:1, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'灼熱吸能擊',dmg:112,cost:8,type:'fire',rider:'move-reflect'},{name:'惡意波動',dmg:100,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:85,cost:6,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'冰凍拳',dmg:150,cost:11,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:21,cost:0,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:47,cost:4,type:'electric',ignoreReflect:true,rider:'weaken'},{name:'突擊',dmg:96,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'日光束',dmg:144,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:43,cost:3,type:'psychic',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'大地吸能擊',dmg:13,cost:1,type:'ground',rider:'self-cure'},{name:'火花',dmg:116,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:173,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'空手劈',dmg:62,cost:5,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'大地威壓擊',dmg:28,cost:2,type:'ground',rider:'energy-steal'},{name:'疾風吸能擊',dmg:124,cost:10,type:'flying',megaBoost:true,bonusEnergy:8},{name:'惡意突刺',dmg:180,cost:15,type:'poison',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10303, type:'fighting', type2:null, ability:{id:'guts', name:'不服輸', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:870, name:'列陣兵', type:'fighting', hp:230, tier:1, ability:{id:'sturdy', name:'戰鬥盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'岩石碎裂',dmg:67,cost:5,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'精神護甲擊',dmg:35,cost:3,type:'psychic',ignoreReflect:true,rider:'guard-up'},{name:'大地威壓擊',dmg:124,cost:10,type:'ground',megaBoost:true,bonusEnergy:8},{name:'妖精之風',dmg:180,cost:15,type:'fairy',selfHeal:0.18}]},
  { mega:{spriteId:10320, type:'grass', type2:'fire', ability:{id:'blaze-boost', name:'辣椒噴霧', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:952, name:'狠辣椒', type:'grass', type2:'fire', hp:220, tier:1, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'能量球',dmg:27,cost:2,type:'grass',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'神速強奪擊',dmg:35,cost:3,type:'normal',rider:'mega-charge'},{name:'噴射火焰',dmg:106,cost:8,type:'fire',megaBoost:true,bonusEnergy:6},{name:'電擊',dmg:158,cost:12,type:'electric',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { mega:{spriteId:10322, type:'dragon', type2:'water', ability:{id:'huge-power', name:'指揮', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:978, name:'米立龍', type:'dragon', type2:'water', hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害+40'}, attacks:[{name:'水槍',dmg:14,cost:1,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'龍之脈動',dmg:13,cost:1,type:'dragon',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'劇毒威壓擊',dmg:29,cost:2,type:'poison',ignoreReflect:true,rider:'weaken'},{name:'雪崩',dmg:155,cost:11,type:'ice',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10325, type:'dragon', type2:'ice', ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:998, name:'戟脊龍', type:'dragon', type2:'ice', hp:245, tier:3, ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'冰耳光',dmg:57,cost:6,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'龍之波動',dmg:58,cost:4,type:'dragon',rider:'self-cure',status:{effect:'confusion', chance:0.25}},{name:'寶石爆破',dmg:88,cost:9,type:'rock',selfHeal:0.23},{name:'蟲毒吸能擊',dmg:72,cost:9,type:'bug',selfHeal:0.17}]},
];
const EFF = {
