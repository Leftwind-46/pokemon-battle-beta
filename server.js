...
const POKEMON = [
  ...
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:350, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'大地強奪擊',dmg:111,cost:11,type:'ground',rider:'card-steal'},{name:'朽滅之歌',dmg:79,cost:7,type:'flying',selfHeal:0.16},{name:'空氣斬',dmg:65,cost:7,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'夜騷動',dmg:93,cost:12,type:'dark',selfHeal:0.26}]},
