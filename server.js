...
const POKEMON = [
  ...
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'衝撞',dmg:10,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:20,cost:1,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:70,cost:6,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'electric',support:true,effect:'brace'}]},
  ...
  { mega:{spriteId:10041, type:'water', type2:'dark', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:130, name:'暴鯉龍',     type:'water',    type2:'flying',  hp:260, tier:1, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'龍息',dmg:64,cost:8,type:'dragon',megaBoost:true,bonusEnergy:6},{name:'怒風',dmg:63,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'咬碎',dmg:107,cost:13,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  { id:87,  name:'白海獅',     type:'water',    type2:'ice',     hp:240, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'冷凍光線',dmg:11,cost:1,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'集氣',cost:3,type:'water',support:true,effect:'focus-energy',bonusEnergy:9},{name:'大浪',dmg:53,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:93,cost:11,type:'water',status:{effect:'confusion', chance:0.25}}]},
  ...
  { mega:{spriteId:10281, type:'dragon', type2:'flying', ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害減半'}}, id:149, name:'快龍',       type:'dragon',   type2:'flying',  hp:320, tier:2, ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害減半'}, attacks:[{name:'龍息',dmg:52,cost:6,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'雷電',dmg:94,cost:12,type:'electric',status:{effect:'paralysis', chance:0.25}},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'破壞光線',dmg:96,cost:11,type:'normal',status:{effect:'paralysis', chance:0.3}}]},
  ...
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'纏繞',dmg:15,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:12,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:50,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'}]},
  ...
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'燕返',dmg:14,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'衝撞',dmg:51,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'勇鳥猛衝',dmg:93,cost:12,type:'flying',selfHeal:0.25}]},
  ...
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.5'}, attacks:[{name:'夜襲',dmg:34,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'念力',dmg:34,cost:4,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:74,cost:10,type:'rock',megaBoost:true,bonusEnergy:8},{name:'灼熱',cost:1,type:'rock',support:true,effect:'debuff',status:{effect:'burn', chance:1}}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'音爆拳',dmg:16,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:59,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:98,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  ...
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 ×1.25'}, attacks:[{name:'水槍',dmg:24,cost:3,type:'water',megaBoost:true,bonusEnergy:6},{name:'迴旋踢',dmg:65,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'撐住',cost:5,type:'water',support:true,effect:'brace'},{name:'冰凍光束',dmg:67,cost:9,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:7}]},
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'針刺',dmg:20,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'毒針',dmg:16,cost:1,type:'poison',megaBoost:true,bonusEnergy:5},{name:'十字剪',dmg:56,cost:7,type:'bug',megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'bug',support:true,effect:'brace'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.5'}, attacks:[{name:'金屬音',dmg:26,cost:3,type:'steel',megaBoost:true,bonusEnergy:6},{name:'頭槌',dmg:27,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:60,cost:8,type:'rock',megaBoost:true,bonusEnergy:6},{name:'撐住',cost:5,type:'rock',support:true,effect:'brace'}]},
  ...
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 ×1.25'}, attacks:[{name:'飛葉快刀',dmg:20,cost:1,type:'grass',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:60,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'幽靈箭',dmg:103,cost:12,type:'ghost',status:{effect:'burn', chance:0.25}},{name:'光合作用強擊',dmg:98,cost:13,type:'grass',selfHeal:0.25}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'毒針',dmg:13,cost:0,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:50,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'},{name:'惡意突刺',dmg:90,cost:11,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.5'}, attacks:[{name:'泥巴射擊',dmg:38,cost:5,type:'ground',megaBoost:true,bonusEnergy:8},{name:'影子偷襲',dmg:75,cost:10,type:'ghost',megaBoost:true,bonusEnergy:8},{name:'地震',dmg:120,cost:15,type:'ground',selfHeal:0.22},{name:'惡靈波動',dmg:116,cost:15,type:'ghost',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.5'}, attacks:[{name:'念力',dmg:18,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'擾亂精神',cost:1,type:'psychic',support:true,effect:'debuff',status:{effect:'confusion', chance:1}},{name:'精神強擊',dmg:94,cost:11,type:'psychic',selfHeal:0.2},{name:'未來預知',dmg:99,cost:12,type:'psychic',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'啄',dmg:21,cost:2,type:'flying',megaBoost:true,bonusEnergy:6},{name:'疾風拳',dmg:22,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:61,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'}]},
  { mega:{spriteId:10039, type:'normal', type2:null, ability:{id:'huge-power', name:'親子羈絆', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:115, name:'袋獸', type:'normal', hp:280, tier:2, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 ×1.2'}, attacks:[{name:'扒',dmg:15,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'連環巴掌',dmg:55,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'撐住',cost:5,type:'normal',support:true,effect:'brace'},{name:'地震',dmg:96,cost:12,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暗影球',dmg:18,cost:1,type:'ghost',megaBoost:true,bonusEnergy:5},{name:'集氣',cost:3,type:'ghost',support:true,effect:'focus-energy',bonusEnergy:9},{name:'暗黑爆破',dmg:58,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:94,cost:12,type:'psychic',selfHeal:0.19}]},
  ...
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.5'}, attacks:[{name:'念力',dmg:21,cost:2,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'小偷',cost:5,type:'psychic',support:true,effect:'thief'},{name:'未來預知',dmg:59,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:99,cost:13,type:'normal',selfHeal:0.25}]},
  ...
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.5'}, attacks:[{name:'念力',dmg:31,cost:3,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'毒粉',cost:1,type:'psychic',support:true,effect:'debuff',status:{effect:'poison', chance:1}},{name:'未來預知',dmg:67,cost:9,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:114,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10297, type:'dark', type2:'psychic', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:687, name:'烏賊王', type:'dark', type2:'psychic', hp:260, tier:2, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'惡意彈珠',dmg:24,cost:2,type:'dark',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:65,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'集氣',cost:3,type:'dark',support:true,effect:'focus-energy',bonusEnergy:9},{name:'未來預知',dmg:101,cost:13,type:'psychic',selfHeal:0.21}]},
  ...
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'空手劈',dmg:39,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'近身戰',dmg:73,cost:10,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:120,cost:15,type:'flying',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10322, type:'dragon', type2:'water', ability:{id:'huge-power', name:'指揮', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:978, name:'米立龍', type:'dragon', type2:'water', hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'水槍',dmg:19,cost:1,type:'water',megaBoost:true,bonusEnergy:5},{name:'龍之氣息',dmg:13,cost:1,type:'dragon',megaBoost:true,bonusEnergy:5},{name:'影舞',cost:2,type:'dragon',support:true,effect:'shadow-dance'},{name:'龍之波動',dmg:99,cost:11,type:'dragon',status:{effect:'freeze', chance:0.15}}]},
...
function doAttack(attacker, defender, atk, aBuff, dBuff, log, G, switchGuardMult = 1) {
  ...
  const abilityDmgMult = ((attacker.ability?.id === 'guts' && attacker.status) ? 1.3
    ...
    : (attacker.ability?.id === 'status-immune-once' && attacker._temperedHeart) ? 1.2
    : (attacker.ability?.id === 'item-synergy' && G[`${aRole}UsedItemThisTurn`]) ? 1.25
    : (attacker.ability?.id === 'drizzle-ocean' && (atkType === 'water' || atkType === 'ice')) ? 1.25
  ...
  if (mult === 0) {
    ...
    damage = Math.max(1, Math.floor((atk.dmg + aBuff.atkBonus + stadiumBonus + reversalBonus) * effectiveAtkMult * burnMult * mult * stabMult * switchGuardMult * abilityDmgMult * defAbilityMult * megaBoostMult * stadiumMult) - shieldTerm);
...
function triggerOnLeaveSrv(poke, role, G, log) {
  ...
  if (poke.ability.id === 'legacy-boost') {
    G[`${role}LegacyBuff`] = { energyMult: 0.5, dmgMult: 1.1 };
...
function triggerAttackerAbilitySrv(attacker, defender, log, dBuff) {
  ...
  if (attacker.ability.id === 'chance-debuff' && defender.cur > 0 && Math.random() < 0.25) {
    dBuff.atkMult = Math.min(dBuff.atkMult, 0.5);
    log.push({ text: `${attacker.name} 的穿透讓對方下次攻擊傷害 ×0.5！`, cls: 'special' });
  }
}
...
function triggerDefenderAbilitySrv(defender, attacker, log, dBuff) {
  ...
  if (defender.ability.id === 'static' && !attacker.status && Math.random() < 0.20) {
    ...
    dBuff.atkMult = Math.max(dBuff.atkMult, 1.5);
