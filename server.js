...
const POKEMON = [
  ...
  { id:727, name:'火爆獸',     type:'fire',     type2:'dark',    hp:300, tier:2, attacks:[{name:'暗黑強打',dmg:58,type:'dark'},{name:'火焰噴射',dmg:50,type:'fire',    status:{effect:'burn',     chance:0.25}},{name:'超強衝擊',dmg:60,type:'fighting'},{name:'地震',    dmg:65,type:'ground'}]},
  { id:724, name:'大竹葵',     type:'grass',    type2:'ghost',   hp:280, tier:2, attacks:[{name:'幽靈箭',  dmg:55,type:'ghost'},{name:'葉刃',    dmg:50,type:'grass'},{name:'暗影球',  dmg:62,type:'ghost'},{name:'疾風飛翔',dmg:60,type:'flying'}]},
  // Tier 3
  ...
  { id:888, name:'蒼響',       type:'fairy',    type2:'steel',   hp:370, tier:3, attacks:[{name:'剛劍',    dmg:85,type:'steel'},{name:'神秘劍',dmg:95,type:'fairy'},{name:'鐵頭功',dmg:75,type:'steel'},{name:'接近戰',dmg:90,type:'fighting'}]},
  ...
  { id:1020,name:'赤焰咆哮虎', type:'fire',     type2:'dragon',  hp:360, tier:3, attacks:[{name:'赤焰衝擊',dmg:95,type:'fire',    status:{effect:'burn',     chance:0.30}},{name:'龍爪',    dmg:82,type:'dragon'},{name:'火焰噴射',dmg:80,type:'fire',    status:{effect:'burn',     chance:0.25}},{name:'龍之隕星',dmg:90,type:'dragon'}]},
];
const EFF = {
