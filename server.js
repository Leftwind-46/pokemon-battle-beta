...
const POKEMON = [
  // Tier 1
  { mega:{spriteId:10033, type:'grass', type2:'poison', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:3,   name:'妙蛙花',     type:'grass',    type2:'poison',  hp:250, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'逆鱗吸能擊',dmg:58,cost:1,type:'dragon',rider:'energy-steal'},{name:'惡意突刺',dmg:87,cost:6,type:'poison',status:{effect:'poison', chance:0.4},megaBoost:true,bonusEnergy:5},{name:'藤鞭',dmg:94,cost:6,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'大地之力',dmg:123,cost:11,type:'ground',ignoreReflect:true,status:{effect:'burn', chance:0.4},bonusVsType:'electric',ignoreShield:true}]},
  { mega:{spriteId:10038, type:'ghost', type2:'poison', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:94,  name:'耿鬼',       type:'ghost',    type2:'poison',  hp:220, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'催眠術',dmg:66,cost:3,type:'psychic',rider:'mega-charge',status:{effect:'sleep', chance:0.5},megaBoost:true,bonusEnergy:6,status2:{effect:'confusion',chance:0.5}},{name:'幽靈之爪',dmg:106,cost:8,type:'ghost',rider:'type-draw',status:{effect:'poison', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'confusion',chance:0.4}},{name:'污泥炸彈',dmg:136,cost:13,type:'poison',megaBoost:true,bonusEnergy:7},{name:'妖精護甲擊',dmg:65,cost:3,type:'fairy',rider:'self-cure'}]},
  { id:68,  name:'怪力',       type:'fighting', hp:260, tier:1, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'動感拳',dmg:62,cost:2,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'岩石滑落',dmg:92,cost:7,type:'rock',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:5},{name:'疾風強奪擊',dmg:99,cost:7,type:'flying',ignoreReflect:true,rider:'card-steal'},{name:'幽靈之爪',dmg:128,cost:12,type:'ghost',selfHeal:0.21,bonusVsType:'psychic',ignoreReflect:true}]},
  { mega:{spriteId:10037, type:'psychic', type2:null, ability:{id:'guts', name:'不屈之心', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:65,  name:'胡地',       type:'psychic',  hp:200, tier:1, ability:{id:'vortex-pressure', name:'漩渦威壓', trigger:'onDefend', desc:'牠在場上時，對手攻擊消耗的能量持續 +3；每回合開始 50% 機率抽到一張大海之盾'}, attacks:[{name:'超能力',dmg:54,cost:0,type:'psychic',rider:'self-cure',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:5,status2:{effect:'poison',chance:0.4}},{name:'寶石爆破',dmg:50,cost:0,type:'rock',ignoreReflect:true,status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:4,status2:{effect:'poison',chance:0.4}},{name:'暗影球',dmg:119,cost:11,type:'ghost',megaBoost:true,bonusEnergy:4},{name:'冰霜吸血擊',dmg:93,cost:6,type:'ice',rider:'type-draw'}]},
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'tough-claws', name:'暗影', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'橫衝直撞',dmg:53,cost:0,type:'normal',rider:'type-draw',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:50,cost:0,type:'electric',rider:'energy-steal',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:5,status2:{effect:'burn',chance:0.4}},{name:'石刃',dmg:118,cost:11,type:'rock',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:4,bonusVsType:'bug'},{name:'逆鱗威壓擊',dmg:92,cost:6,type:'dragon',rider:'mega-charge'}]},
  { mega:{spriteId:10076, type:'steel', type2:'psychic', ability:{id:'blaze-boost', name:'熾熱核心', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:376, name:'巨金怪',     type:'steel',    type2:'psychic', hp:260, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'子彈拳',dmg:62,cost:2,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'冰霜吸能擊',dmg:98,cost:8,type:'ice',rider:'energy-steal'},{name:'念力',dmg:105,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'隕石衝擊',dmg:135,cost:13,type:'rock',ignoreReflect:true,selfHeal:0.25,bonusVsType:'fire',ignoreShield:true}]},
  { mega:{spriteId:10059, type:'fighting', type2:'steel', ability:{id:'motor-drive', name:'蓄電', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:448, name:'路卡利歐',   type:'fighting', type2:'steel',   hp:220, tier:1, ability:{id:'prankster-heart', name:'惡作劇之心', trigger:'onAttack', desc:'每回合開始 50% 機率抽到一張精神干擾；沒抽到時下次攻擊威力 +20'}, attacks:[{name:'灼熱護甲擊',dmg:70,cost:3,type:'fire',rider:'energy-steal'},{name:'金屬爪',dmg:66,cost:3,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'龍之脈動',dmg:106,cost:8,type:'dragon',megaBoost:true,bonusEnergy:6},{name:'暗影球',dmg:136,cost:13,type:'ghost',selfHeal:0.18,bonusVsType:'psychic',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10041, type:'water', type2:'dark', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:130, name:'暴鯉龍',     type:'water',    type2:'flying',  hp:260, tier:1, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'大地強奪擊',dmg:105,cost:8,type:'ground',rider:'card-steal',ignoreReflect:true},{name:'水砲',dmg:101,cost:8,type:'water',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'怒風',dmg:68,cost:2,type:'flying',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'咬碎',dmg:138,cost:13,type:'dark',status:{effect:'sleep', chance:0.4},bonusVsType:'psychic'}]},
  { id:87,  name:'白海獅',     type:'water',    type2:'ice',     hp:240, tier:1, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'冷凍光線',dmg:54,cost:0,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:5,status2:{effect:'paralysis',chance:0.4}},{name:'荒草吸血擊',dmg:90,cost:6,type:'grass',rider:'mega-charge'},{name:'大浪',dmg:86,cost:6,type:'water',megaBoost:true,bonusEnergy:4,rider:'energy-steal'},{name:'未來雷霆',dmg:126,cost:11,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting'}]},
  { id:82,  name:'三合一磁怪',   type:'electric', type2:'steel',   hp:210, tier:1, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'電磁炮',dmg:68,cost:2,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'sleep',chance:0.4}},{name:'劇毒威壓擊',dmg:64,cost:2,type:'poison',rider:'mega-charge'},{name:'金屬音',dmg:100,cost:8,type:'steel',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'衝浪',dmg:141,cost:13,type:'water',selfHeal:0.18,bonusVsType:'ground',ignoreReflect:true}]},
  { id:28,  name:'穿山王',     type:'ground',   hp:240, tier:1, ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'本系加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'精神吸能擊',dmg:53,cost:1,type:'psychic',rider:'energy-steal'},{name:'地震',dmg:100,cost:7,type:'ground',megaBoost:true,bonusEnergy:4,rider:'mega-charge'},{name:'岩石碎裂',dmg:96,cost:7,type:'rock',megaBoost:true,bonusEnergy:4},{name:'水之脈動',dmg:125,cost:12,type:'water',status:{effect:'sleep', chance:0.4},bonusVsType:'ground',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10071, type:'water', type2:'psychic', ability:{id:'tough-claws', name:'鐵拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:80,  name:'呆殼獸',     type:'water',    type2:'psychic', hp:260, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:64,cost:2,type:'water',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'精神強擊',dmg:94,cost:7,type:'psychic',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:5,rider:'move-reflect'},{name:'灼熱護甲擊',dmg:101,cost:7,type:'fire',rider:'mega-charge'},{name:'連續切',dmg:130,cost:12,type:'bug',ignoreReflect:true,status:{effect:'confusion', chance:0.4},bonusVsType:'psychic'}]},
  { id:823, name:'鋼鎧鴉',     type:'steel',    type2:'flying',  hp:250, tier:1, ability:{id:'tough-claws', name:'惡夢', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'鐵翼',dmg:65,cost:2,type:'steel',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'空氣斬',dmg:95,cost:7,type:'flying',megaBoost:true,bonusEnergy:5},{name:'激流強奪擊',dmg:102,cost:7,type:'water',rider:'card-steal'},{name:'念力衝擊',dmg:131,cost:12,type:'psychic',selfHeal:0.28,bonusVsType:'fighting',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10283, type:'water', type2:'dragon', ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:160, name:'大力鱷',     type:'water',    hp:260, tier:1, ability:{id:'poison-heal', name:'毒療', trigger:'onStatus', desc:'中毒時每回合回復 1/8 最大HP，而非扣血'}, attacks:[{name:'灼熱吸血擊',dmg:59,cost:2,type:'fire',rider:'self-cure',bonusVsType:'bug'},{name:'冰凍拳',dmg:106,cost:8,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:6,rider:'card-steal'},{name:'衝浪',dmg:102,cost:8,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'電擊',dmg:132,cost:13,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water'}]},
  { mega:{spriteId:10294, type:'water', type2:'dark', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:658, name:'甲賀忍蛙',       type:'water',    type2:'dark',    hp:220, tier:1, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水手裏劍',dmg:72,cost:3,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6,bonusVsType:'ground'},{name:'夜斬',dmg:108,cost:9,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'影子偷襲',dmg:148,cost:14,type:'ghost',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:71,cost:3,type:'grass',rider:'mega-charge'}]},
  // Tier 2
  { mega:{spriteId:10034, type:'fire', type2:'dragon', ability:{id:'guts', name:'崩潰', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:6,   name:'噴火龍',     type:'fire',     type2:'flying',  hp:290, tier:2, ability:{id:'bug-domain', name:'蟲群支配', trigger:'onEnter', desc:'上場時場地切換為蟲群巢穴；蟲屬性攻擊傷害額外 +40'}, attacks:[{name:'火焰噴射',dmg:93,cost:7,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'龍爪',dmg:60,cost:1,type:'dragon',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:129,cost:12,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'flying'},{name:'燕返',dmg:125,cost:12,type:'flying',status:{effect:'freeze', chance:0.4},bonusVsType:'bug',ignoreReflect:true}]},
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'solid-rock', name:'頑強', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'水砲',dmg:52,cost:0,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:4},{name:'蟲毒吸能擊',dmg:88,cost:6,type:'bug',rider:'type-draw'},{name:'妖精吸血擊',dmg:128,cost:11,type:'fairy',selfHeal:0.28,bonusVsType:'dark'},{name:'冰凍光束',dmg:124,cost:11,type:'ice',selfHeal:0.29,bonusVsType:'dragon',ignoreReflect:true}]},
  { mega:{spriteId:10043, type:'psychic', type2:'fighting', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:150, name:'超夢',       type:'psychic',  hp:320, tier:2, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'念力衝擊',dmg:121,cost:11,type:'psychic',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:4},{name:'氣功拳',dmg:128,cost:11,type:'fighting',selfHeal:0.19,bonusVsType:'rock'},{name:'閃電拳',dmg:124,cost:11,type:'electric',status:{effect:'sleep', chance:0.4},bonusVsType:'flying',ignoreReflect:true},{name:'暗影球',dmg:87,cost:6,type:'ghost',rider:'type-draw',status:{effect:'poison', chance:0.4},status2:{effect:'burn',chance:0.4}}]},
  { mega:{spriteId:10281, type:'dragon', type2:'flying', ability:{id:'blaze-boost', name:'辣椒噴霧', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:149, name:'快龍',       type:'dragon',   type2:'flying',  hp:320, tier:2, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'逆鱗護甲擊',dmg:119,cost:11,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'雷電',dmg:126,cost:11,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'flying',ignoreReflect:true},{name:'冰霜護甲擊',dmg:89,cost:6,type:'ice',rider:'energy-steal'},{name:'破壞光線',dmg:118,cost:11,type:'normal',status:{effect:'paralysis', chance:0.4},ignoreReflect:true,ignoreShield:true}]},
  { id:143, name:'卡比獸',     type:'normal',   hp:380, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'磚塊',dmg:145,cost:15,type:'rock',megaBoost:true,bonusEnergy:8},{name:'喊叫',dmg:119,cost:10,type:'normal',rider:'self-cure',selfHeal:0.25},{name:'地震',dmg:148,cost:15,type:'ground',status:{effect:'freeze', chance:0.4},bonusVsType:'poison'},{name:'鐵頭',dmg:150,cost:15,type:'steel',selfHeal:0.29,bonusVsType:'rock',ignoreReflect:true,ignoreShield:true}]},
  { id:59,  name:'風速狗',     type:'fire',     hp:260, tier:2, ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}, attacks:[{name:'連續啃咬',dmg:66,cost:2,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'冰霜強奪擊',dmg:102,cost:8,type:'ice',rider:'type-draw'},{name:'頭槌',dmg:98,cost:8,type:'normal',megaBoost:true,bonusEnergy:5},{name:'噴射火焰',dmg:139,cost:13,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.4},bonusVsType:'ice',ignoreShield:true}]},
  { id:131, name:'拉普拉斯',   type:'water',    type2:'ice',     hp:290, tier:2, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'衝浪',dmg:61,cost:1,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'冷凍光線',dmg:97,cost:7,type:'ice',rider:'energy-steal',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:126,cost:12,type:'electric',selfHeal:0.21,bonusVsType:'water'},{name:'遠古之力',dmg:133,cost:12,type:'rock',selfHeal:0.17,bonusVsType:'flying',ignoreReflect:true}]},
  { mega:{spriteId:10058, type:'dragon', type2:'ground', ability:{id:'technician', name:'技術高手', trigger:'onAttack', desc:'威力 60 以下的招式，傷害 ×1.1'}}, id:445, name:'烈咬陸鯊',   type:'dragon',   type2:'ground',  hp:280, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'龍爪',dmg:62,cost:1,type:'dragon',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'疾風吸血擊',dmg:98,cost:7,type:'flying',rider:'life-drain'},{name:'地震',dmg:127,cost:12,type:'ground',selfHeal:0.23,bonusVsType:'fire'},{name:'惡意突刺',dmg:134,cost:12,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true}]},
  { id:210, name:'布魯皇',     type:'fairy',    hp:300, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'妖精之力',dmg:94,cost:7,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'雷電',dmg:67,cost:2,type:'electric',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'poison',chance:0.4}},{name:'咬碎',dmg:130,cost:12,type:'dark',status:{effect:'sleep', chance:0.4},bonusVsType:'ghost',ignoreReflect:true},{name:'地震',dmg:126,cost:12,type:'ground',status:{effect:'confusion', chance:0.4},bonusVsType:'steel'}]},
  { id:700, name:'仙子伊布',   type:'fairy',    hp:300, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'妖精風',dmg:68,cost:3,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:108,cost:8,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'poison',chance:0.4}},{name:'毒牙',dmg:138,cost:13,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true},{name:'暗影球',dmg:134,cost:13,type:'ghost',status:{effect:'freeze', chance:0.4},bonusVsType:'psychic'}]},
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'冰凍光束',dmg:62,cost:1,type:'ice',rider:'energy-steal',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:4,status2:{effect:'sleep',chance:0.4}},{name:'怒風',dmg:131,cost:12,type:'flying',megaBoost:true,bonusEnergy:4},{name:'幽靈球',dmg:127,cost:12,type:'ghost',ignoreReflect:true,status:{effect:'sleep', chance:0.4},bonusVsType:'ghost'},{name:'激流威壓擊',dmg:101,cost:7,type:'water',rider:'mega-charge'}]},
  { id:614, name:'凍原熊',     type:'ice',      hp:215, tier:2, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'冰耳光',dmg:65,cost:2,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:5,status2:{effect:'confusion',chance:0.4}},{name:'大浪',dmg:101,cost:8,type:'water',status:{effect:'poison', chance:0.4},bonusVsType:'rock',ignoreReflect:true},{name:'火焰噴射',dmg:68,cost:2,type:'fire',status:{effect:'burn', chance:0.4}},{name:'地震',dmg:138,cost:13,type:'ground',status:{effect:'poison', chance:0.4},bonusVsType:'poison'}]},
  { id:430, name:'烏鴉頭頭',     type:'dark',     type2:'flying',  hp:300, tier:2, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'夜斬',dmg:67,cost:3,type:'dark',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'暴風',dmg:114,cost:9,type:'flying',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:143,cost:14,type:'psychic',selfHeal:0.22,bonusVsType:'fighting',ignoreReflect:true},{name:'毒粉刺',dmg:139,cost:14,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'grass'}]},
  { id:466, name:'電擊魔獸',   type:'electric', hp:300, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'電磁衝浪',dmg:113,cost:9,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'決勝衝擊',dmg:69,cost:3,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:138,cost:14,type:'psychic',selfHeal:0.18,bonusVsType:'fighting'},{name:'冰凍拳',dmg:145,cost:14,type:'ice',status:{effect:'poison', chance:0.4},bonusVsType:'ground',ignoreReflect:true}]},
  { id:467, name:'鴨嘴炎獸',   type:'fire',     hp:300, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'火焰衝擊',dmg:108,cost:8,type:'fire',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'sleep',chance:0.4}},{name:'地震',dmg:71,cost:3,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'閃電拳',dmg:134,cost:13,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water',ignoreReflect:true},{name:'惡意突刺',dmg:141,cost:13,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy'}]},
  { id:157, name:'火爆獸',     type:'fire',                      hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'疾風吸能擊',dmg:104,cost:8,type:'flying',ignoreReflect:true,rider:'energy-steal'},{name:'地震',dmg:100,cost:8,type:'ground',megaBoost:true,bonusEnergy:7,rider:'self-cure'},{name:'爆炸火焰',dmg:74,cost:3,type:'fire',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'毒粉刺',dmg:137,cost:13,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy'}]},
  { mega:{spriteId:10282, type:'grass', type2:'fairy', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:154, name:'大竺葵',     type:'grass',                     hp:270, tier:2, ability:{id:'electric-domain', name:'雷霆支配', trigger:'onEnter', desc:'上場時場地切換為雷雲庇護所；電屬性攻擊傷害額外 +40'}, attacks:[{name:'逆鱗護甲擊',dmg:78,cost:5,type:'dragon',rider:'mega-charge',bonusVsType:'dragon'},{name:'大地之力',dmg:119,cost:10,type:'ground',megaBoost:true,bonusEnergy:8,rider:'mega-charge'},{name:'花瓣風暴',dmg:115,cost:10,type:'grass',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'閃電拳',dmg:150,cost:15,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water'}]},
  // Tier 3
  { id:383, name:'固拉多',     type:'ground',   hp:300, tier:3, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'地震',dmg:139,cost:13,type:'ground',megaBoost:true,bonusEnergy:6,bonusVsType:'fire',ignoreReflect:true},{name:'岩石碎裂',dmg:68,cost:3,type:'rock',selfHeal:0.22},{name:'火焰噴射',dmg:108,cost:8,type:'fire',ignoreReflect:true,status:{effect:'confusion', chance:0.4},status2:{effect:'sleep',chance:0.4}},{name:'妖精威壓擊',dmg:138,cost:13,type:'fairy',rider:'move-reflect',status:{effect:'burn', chance:0.4},selfHeal:0.26}]},
  { id:382, name:'蓋歐卡',     type:'water',    hp:290, tier:3, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'源起之波',dmg:103,cost:8,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:5,ignoreReflect:true},{name:'雷電',dmg:133,cost:13,type:'electric',status:{effect:'burn', chance:0.4},bonusVsType:'water'},{name:'橫衝直撞',dmg:140,cost:13,type:'normal',selfHeal:0.16,ignoreReflect:true},{name:'原始海洋',dmg:62,cost:2,type:'ice',rider:'type-draw',selfHeal:0.21}]},
  { mega:{spriteId:10079, type:'dragon', type2:'flying', ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:384, name:'烈空坐',     type:'dragon',   type2:'flying',  hp:320, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'神速',dmg:127,cost:11,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'火焰噴射',dmg:123,cost:11,type:'fire',status:{effect:'freeze', chance:0.4},bonusVsType:'steel'},{name:'燕返',dmg:119,cost:11,type:'flying',status:{effect:'poison', chance:0.4},bonusVsType:'bug'},{name:'龍之隕星',dmg:93,cost:6,type:'dragon',rider:'self-cure',status:{effect:'burn', chance:0.4},status2:{effect:'confusion',chance:0.4}}]},
  { id:1008,name:'密勒頓',     type:'electric', type2:'dragon',  hp:360, tier:3, ability:{id:'poison-point', name:'毒素碎片', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'電磁衝浪',dmg:135,cost:13,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:7,bonusVsType:'flying'},{name:'逆鱗護甲擊',dmg:142,cost:13,type:'dragon',selfHeal:0.17},{name:'毒牙',dmg:138,cost:13,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true},{name:'精神強擊',dmg:100,cost:8,type:'psychic',rider:'mega-charge',selfHeal:0.23}]},
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:260, tier:3, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'怒風',dmg:70,cost:3,type:'flying',rider:'self-cure',status:{effect:'paralysis', chance:0.4}},{name:'聖焰',dmg:99,cost:8,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:1},status2:{effect:'poison',chance:1}},{name:'大地波動',dmg:106,cost:8,type:'ground',rider:'energy-steal'},{name:'妖精威壓擊',dmg:136,cost:13,type:'fairy',selfHeal:0.22,bonusVsType:'dragon'}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:255, tier:3, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'未來雷霆',dmg:55,cost:1,type:'psychic',rider:'mega-charge',status:{effect:'confusion', chance:0.4}},{name:'暴風',dmg:102,cost:7,type:'flying',rider:'type-draw',status:{effect:'sleep', chance:0.4}},{name:'冰凍光束',dmg:98,cost:7,type:'ice',rider:'guard-up'},{name:'幽靈球',dmg:127,cost:12,type:'ghost',ignoreReflect:true,status:{effect:'freeze', chance:0.4},bonusVsType:'ghost'}]},
  { id:1007,name:'故勒頓',     type:'fighting', type2:'dragon',  hp:360, tier:3, ability:{id:'solid-rock', name:'恆淨之軀', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'決勝衝擊',dmg:139,cost:14,type:'fighting',megaBoost:true,bonusEnergy:7,bonusVsType:'steel',ignoreReflect:true},{name:'火焰噴射',dmg:146,cost:14,type:'fire',status:{effect:'burn', chance:0.4},bonusVsType:'bug'},{name:'泥巴射擊',dmg:142,cost:14,type:'ground',status:{effect:'sleep', chance:0.4},bonusVsType:'electric'},{name:'遠古之力',dmg:105,cost:9,type:'rock',rider:'energy-steal',selfHeal:0.3}]},
  { mega:{spriteId:10051, type:'psychic', type2:'fairy', ability:{id:'sturdy', name:'硬殼盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}}, id:282, name:'沙奈朵',     type:'psychic',  type2:'fairy',   hp:205, tier:3, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'妖精之力',dmg:55,cost:1,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'暗影球',dmg:102,cost:7,type:'ghost',selfHeal:0.26,bonusVsType:'psychic'},{name:'毒針',dmg:131,cost:12,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true,ignoreShield:true},{name:'精神強擊',dmg:54,cost:1,type:'psychic',rider:'energy-steal',selfHeal:0.24}]},
  { id:144, name:'急凍鳥',     type:'ice',      type2:'flying',  hp:340, tier:3, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'暴風雪',dmg:100,cost:8,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:141,cost:13,type:'flying',ignoreReflect:true,status:{effect:'sleep', chance:0.4},bonusVsType:'bug'},{name:'幽冥威壓擊',dmg:137,cost:13,type:'ghost',selfHeal:0.22,bonusVsType:'ghost',ignoreReflect:true,ignoreShield:true},{name:'橫衝直撞',dmg:133,cost:13,type:'normal',selfHeal:0.25}]},
  { id:145, name:'閃電鳥',     type:'electric', type2:'flying',  hp:245, tier:3, ability:{id:'pressure', name:'緊張感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'雷霆',dmg:96,cost:7,type:'electric',rider:'type-draw',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'猛禽炸彈',dmg:92,cost:7,type:'flying',status:{effect:'sleep', chance:0.4},bonusVsType:'fighting'},{name:'龍爪',dmg:132,cost:12,type:'dragon',selfHeal:0.25,bonusVsType:'dragon'},{name:'吼叫',dmg:55,cost:1,type:'normal',rider:'type-draw',status:{effect:'paralysis', chance:0.4},status2:{effect:'poison',chance:0.4}}]},
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:200, tier:3, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害+40'}, attacks:[{name:'火焰衝擊',dmg:124,cost:11,type:'fire',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6,bonusVsType:'ice',ignoreReflect:true},{name:'超能力',dmg:50,cost:0,type:'psychic',rider:'energy-steal',status:{effect:'confusion', chance:0.4},selfHeal:0.16,status2:{effect:'burn',chance:0.4}},{name:'十萬伏特',dmg:94,cost:6,type:'electric',status:{effect:'paralysis', chance:0.4}},{name:'怒風',dmg:50,cost:0,type:'flying',ignoreReflect:true,selfHeal:0.28}]},
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'鐵頭功',dmg:143,cost:14,type:'steel',megaBoost:true,bonusEnergy:8},{name:'月亮力量',dmg:139,cost:14,type:'fairy',ignoreReflect:true,selfHeal:0.19,bonusVsType:'dark'},{name:'接近戰',dmg:146,cost:14,type:'fighting',selfHeal:0.21,bonusVsType:'normal',ignoreReflect:true,ignoreShield:true},{name:'劇毒威壓擊',dmg:109,cost:9,type:'poison',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:305, tier:3, ability:{id:'sturdy', name:'結實', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'魔法閃耀',dmg:74,cost:4,type:'fairy',rider:'type-draw'},{name:'十萬伏特',dmg:121,cost:10,type:'electric',status:{effect:'paralysis', chance:0.4},status2:{effect:'burn',chance:0.4}},{name:'飛葉快刀',dmg:150,cost:15,type:'grass',rider:'card-steal'},{name:'冰耳光',dmg:146,cost:15,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'flying',ignoreReflect:true}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'暴風雪',dmg:146,cost:14,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:8,bonusVsType:'grass'},{name:'閃光炮',dmg:109,cost:9,type:'steel',rider:'self-cure',status:{effect:'paralysis', chance:0.4}},{name:'未來雷霆',dmg:138,cost:14,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting'},{name:'電磁砲',dmg:145,cost:14,type:'electric',rider:'mega-charge',status:{effect:'burn', chance:0.4},status2:{effect:'freeze',chance:0.4}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:265, tier:3, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'惡意波動',dmg:69,cost:3,type:'dark',ignoreReflect:true},{name:'空氣斬',dmg:105,cost:9,type:'flying',rider:'mega-charge',status:{effect:'freeze', chance:0.4},status2:{effect:'paralysis',chance:0.4}},{name:'大地虹吸',dmg:112,cost:9,type:'ground',rider:'life-drain'},{name:'幽靈球',dmg:141,cost:14,type:'ghost',selfHeal:0.25,bonusVsType:'ghost'}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'blaze-boost', name:'蟲之預感', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'閃光炮',dmg:141,cost:13,type:'steel',ignoreReflect:true,megaBoost:true,bonusEnergy:7,bonusVsType:'fairy',ignoreShield:true},{name:'龍之脈動',dmg:137,cost:13,type:'dragon',selfHeal:0.19,bonusVsType:'dragon'},{name:'雷霆',dmg:99,cost:8,type:'electric',rider:'mega-charge',selfHeal:0.21},{name:'幽靈之爪',dmg:140,cost:13,type:'ghost',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'衝浪',dmg:52,cost:1,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:59,cost:1,type:'dragon',status:{effect:'paralysis', chance:0.4}},{name:'空間扭曲',dmg:95,cost:7,type:'psychic',ignoreReflect:true,selfHeal:0.25,bonusVsType:'fighting',ignoreShield:true},{name:'鐵翼',dmg:135,cost:12,type:'steel',selfHeal:0.15,bonusVsType:'ice'}]},
  { id:727, name:'熾焰咆哮虎', type:'fire',     type2:'dark',    hp:300, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'火焰噴射',dmg:74,cost:4,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'sleep',chance:0.4}},{name:'暗黑強打',dmg:114,cost:9,type:'dark',megaBoost:true,bonusEnergy:7},{name:'超強衝擊',dmg:143,cost:14,type:'fighting',status:{effect:'paralysis', chance:0.4},bonusVsType:'dark',ignoreReflect:true},{name:'劇毒威壓擊',dmg:139,cost:14,type:'poison',selfHeal:0.2,bonusVsType:'fairy'}]},
  // 新增：補足各屬性
  { id:128, name:'肯泰羅',     type:'normal',                    hp:240, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'橫衝直撞',dmg:50,cost:0,type:'normal',rider:'energy-steal',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:5},{name:'灼熱吸血擊',dmg:95,cost:6,type:'fire',ignoreReflect:true,rider:'life-drain'},{name:'地震',dmg:91,cost:6,type:'ground',megaBoost:true,bonusEnergy:5},{name:'夜襲',dmg:120,cost:11,type:'dark',selfHeal:0.21,bonusVsType:'psychic',ignoreReflect:true}]},
  { id:295, name:'爆音怪',     type:'normal',                    hp:240, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'疾風威壓擊',dmg:59,cost:1,type:'flying',rider:'self-cure'},{name:'大字爆炎',dmg:95,cost:7,type:'fire',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:4,rider:'card-steal'},{name:'衝浪',dmg:102,cost:7,type:'water',megaBoost:true,bonusEnergy:4,rider:'self-cure'},{name:'破壞光線',dmg:131,cost:12,type:'normal',status:{effect:'paralysis', chance:0.4},ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'frisk-ward', name:'沙隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'閃電拳',dmg:60,cost:2,type:'electric',rider:'mega-charge',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'confusion',chance:0.4}},{name:'能量球',dmg:141,cost:13,type:'grass',ignoreReflect:true,status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:103,cost:8,type:'ground',megaBoost:true,bonusEnergy:5,rider:'move-reflect'},{name:'神速吸能擊',dmg:99,cost:8,type:'normal',rider:'self-cure'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:50,cost:0,type:'normal',rider:'mega-charge',status:{effect:'sleep', chance:0.4},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:50,cost:0,type:'poison',rider:'type-draw',status:{effect:'poison', chance:0.4},megaBoost:true,bonusEnergy:4,status2:{effect:'confusion',chance:0.4}},{name:'地震',dmg:125,cost:11,type:'ground',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:88,cost:6,type:'steel',ignoreReflect:true,rider:'guard-up'}]},
  { id:73,  name:'毒刺水母',   type:'water',    type2:'poison',  hp:220, tier:1, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'蟲毒強奪擊',dmg:68,cost:3,type:'bug',rider:'energy-steal'},{name:'毒液',dmg:75,cost:3,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'freeze',chance:0.4}},{name:'衝浪',dmg:111,cost:9,type:'water',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:140,cost:14,type:'fire',status:{effect:'burn', chance:0.4},bonusVsType:'bug',ignoreReflect:true}]},
  { id:454, name:'毒骷蛙',     type:'fighting', type2:'poison',  hp:230, tier:1, ability:{id:'flash-fire', name:'引火', trigger:'onDefend', desc:'受到火屬性攻擊時完全免疫，下次攻擊威力 +20'}, attacks:[{name:'妖精吸血擊',dmg:84,cost:5,type:'fairy',rider:'mega-charge',bonusVsType:'dragon'},{name:'夜襲',dmg:80,cost:5,type:'dark',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'十字劈',dmg:121,cost:10,type:'fighting',megaBoost:true,bonusEnergy:7,rider:'mega-charge'},{name:'劇毒威壓擊',dmg:150,cost:15,type:'poison',selfHeal:0.27,bonusVsType:'grass'}]},
  { id:553, name:'流氓鱷',     type:'ground',   type2:'dark',    hp:270, tier:2, ability:{id:'motor-drive', name:'蓄電', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'岩石滑落',dmg:118,cost:10,type:'rock',rider:'energy-steal',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'freeze',chance:0.4}},{name:'激流威壓擊',dmg:80,cost:5,type:'water',rider:'self-cure'},{name:'地震',dmg:121,cost:10,type:'ground',megaBoost:true,bonusEnergy:7},{name:'暗黑強打',dmg:150,cost:15,type:'dark',ignoreReflect:true,selfHeal:0.24,bonusVsType:'ghost'}]},
  { id:641, name:'龍捲雲',     type:'flying',                    hp:290, tier:2, ability:{id:'huge-power', name:'心之力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'空氣斬',dmg:64,cost:2,type:'flying',rider:'type-draw',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:5},{name:'雷電',dmg:94,cost:7,type:'electric',rider:'energy-steal',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'蟲刃剪',dmg:134,cost:12,type:'bug',selfHeal:0.22,bonusVsType:'psychic'},{name:'飛葉快刀',dmg:130,cost:12,type:'grass',selfHeal:0.18,bonusVsType:'water',ignoreReflect:true}]},
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'adaptability', name:'冰肌', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'神速吸能擊',dmg:56,cost:1,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'暴風',dmg:85,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:92,cost:6,type:'grass',rider:'energy-steal'},{name:'夜騷動',dmg:121,cost:11,type:'dark',selfHeal:0.25,bonusVsType:'psychic',ignoreReflect:true,ignoreShield:true}]},
  { id:663, name:'烈箭鷹',     type:'fire',     type2:'flying',  hp:260, tier:2, ability:{id:'weaken-buffs', name:'威壓氣場', trigger:'onDefend', desc:'對手的攻擊力提升效果減半'}, attacks:[{name:'炎翼衝刺',dmg:64,cost:2,type:'fire',rider:'energy-steal',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'freeze',chance:0.4}},{name:'空氣斬',dmg:94,cost:7,type:'flying',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:7},{name:'荒草護甲擊',dmg:101,cost:7,type:'grass',rider:'mega-charge'},{name:'幽靈球',dmg:130,cost:12,type:'ghost',selfHeal:0.2,bonusVsType:'ghost',ignoreReflect:true}]},
  { mega:{spriteId:10047, type:'bug', type2:'fighting', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:214, name:'赫拉克羅斯', type:'bug',      type2:'fighting',hp:270, tier:2, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'妖精強奪擊',dmg:88,cost:5,type:'fairy',rider:'mega-charge'},{name:'地震',dmg:118,cost:10,type:'ground',megaBoost:true,bonusEnergy:8,rider:'card-steal'},{name:'聖甲蟲衝擊',dmg:114,cost:10,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:150,cost:15,type:'fighting',ignoreReflect:true,status:{effect:'sleep', chance:0.4},bonusVsType:'normal'}]},
  { mega:{spriteId:10046, type:'bug', type2:'steel', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:212, name:'巨鉗螳螂',   type:'bug',      type2:'steel',   hp:260, tier:2, ability:{id:'frisk-ward', name:'自然回復', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'疾風吸血擊',dmg:71,cost:3,type:'flying',ignoreReflect:true,rider:'life-drain'},{name:'子彈拳',dmg:100,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'蟲刃剪',dmg:107,cost:8,type:'bug',megaBoost:true,bonusEnergy:5},{name:'破魂吸血擊',dmg:137,cost:13,type:'fighting',selfHeal:0.23,bonusVsType:'rock',ignoreReflect:true,ignoreShield:true}]},
  { id:469, name:'遠古巨蜓',   type:'bug',      type2:'flying',  hp:230, tier:1, ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'空氣斬',dmg:81,cost:5,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'freeze',chance:0.4}},{name:'雷光威壓擊',dmg:88,cost:5,type:'electric',rider:'weaken'},{name:'蟲鳴',dmg:118,cost:10,type:'bug',megaBoost:true,bonusEnergy:7},{name:'實力全開',dmg:147,cost:15,type:'normal',selfHeal:0.25,ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10049, type:'rock', type2:'dark', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:248, name:'班基拉斯',   type:'rock',     type2:'dark',    hp:300, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'碎岩',dmg:139,cost:14,type:'rock',rider:'move-reflect',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:8},{name:'咬碎',dmg:113,cost:9,type:'dark',ignoreReflect:true,status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'sleep',chance:0.4}},{name:'地震',dmg:69,cost:3,type:'ground',selfHeal:0.21},{name:'踢腿',dmg:138,cost:14,type:'fighting',status:{effect:'sleep', chance:0.4},bonusVsType:'dark',ignoreReflect:true}]},
  { mega:{spriteId:10042, type:'rock', type2:'flying', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:142, name:'化石翼龍',   type:'rock',     type2:'flying',  hp:260, tier:2, ability:{id:'ice-domain', name:'冰霜支配', trigger:'onEnter', desc:'上場時場地切換為永凍冰原；冰屬性攻擊傷害額外 +40'}, attacks:[{name:'咬碎',dmg:74,cost:3,type:'dark',ignoreReflect:true,status:{effect:'confusion', chance:0.4},megaBoost:true,bonusEnergy:7,status2:{effect:'paralysis',chance:0.4}},{name:'翼擊',dmg:110,cost:9,type:'flying',megaBoost:true,bonusEnergy:6},{name:'精神吸能擊',dmg:106,cost:9,type:'psychic',rider:'type-draw'},{name:'岩石炮',dmg:146,cost:14,type:'rock',selfHeal:0.2,bonusVsType:'ice',ignoreReflect:true}]},
  { id:526, name:'龐岩怪',     type:'rock',                      hp:280, tier:2, ability:{id:'water-absorb', name:'乾燥皮膚', trigger:'onDefend', desc:'受到水屬性攻擊時完全免疫，並回復最大HP的1/4'}, attacks:[{name:'閃光炮',dmg:59,cost:1,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'逆鱗護甲擊',dmg:95,cost:7,type:'dragon',rider:'energy-steal'},{name:'地震',dmg:135,cost:12,type:'ground',status:{effect:'freeze', chance:0.4},bonusVsType:'rock'},{name:'岩石炮',dmg:131,cost:12,type:'rock',status:{effect:'poison', chance:0.4},bonusVsType:'ice',ignoreReflect:true}]},
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'hadron-engine', name:'強子引擎', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1；每回合開始必定額外抽到一張電光石火'}, attacks:[{name:'幽靈球',dmg:106,cost:8,type:'ghost',ignoreReflect:true,status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'sleep',chance:0.4}},{name:'冰凍拳',dmg:62,cost:2,type:'ice',rider:'mega-charge',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:6,status2:{effect:'paralysis',chance:0.4}},{name:'月亮力量',dmg:132,cost:13,type:'fairy',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:65,cost:2,type:'flying',rider:'energy-steal'}]},
  { mega:{spriteId:10291, type:'ghost', type2:'fire', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:609, name:'水晶燈火靈', type:'ghost',    type2:'fire',    hp:260, tier:2, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'冰霜吸血擊',dmg:106,cost:8,type:'ice',rider:'life-drain'},{name:'噴火',dmg:62,cost:2,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:5,status2:{effect:'confusion',chance:0.4}},{name:'暗影球',dmg:98,cost:8,type:'ghost',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'空間扭曲',dmg:139,cost:13,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting',ignoreReflect:true}]},
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'motor-drive', name:'電鰻升格', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'夜斬',dmg:101,cost:8,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'光合作用強擊',dmg:75,cost:3,type:'grass',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:71,cost:3,type:'fairy',rider:'energy-steal'},{name:'鐵尾',dmg:134,cost:13,type:'steel',selfHeal:0.26,bonusVsType:'rock',ignoreReflect:true}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'連續攻擊',dmg:75,cost:4,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:82,cost:4,type:'steel',ignoreReflect:true,rider:'energy-steal'},{name:'碎岩',dmg:111,cost:9,type:'fighting',status:{effect:'paralysis', chance:0.4},megaBoost:true,bonusEnergy:6},{name:'暗黑脈衝',dmg:140,cost:14,type:'dark',selfHeal:0.18,bonusVsType:'ghost',ignoreReflect:true}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'ground-domain', name:'風沙支配', trigger:'onEnter', desc:'上場時場地切換為沙塵暴；地面屬性攻擊傷害額外 +40'}, attacks:[{name:'突擊',dmg:52,cost:1,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:99,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'魔法閃耀',dmg:128,cost:12,type:'fairy',selfHeal:0.22,bonusVsType:'dark',ignoreReflect:true,ignoreShield:true},{name:'蟲毒護甲擊',dmg:102,cost:7,type:'bug',rider:'energy-steal'}]},
  { id:342, name:'鐵螯龍蝦', type:'water', type2:'dark', hp:210, tier:1, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'神速強奪擊',dmg:54,cost:1,type:'normal',ignoreReflect:true,rider:'card-steal'},{name:'夜斬',dmg:61,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'水槍',dmg:97,cost:7,type:'water',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:126,cost:12,type:'ground',status:{effect:'burn', chance:0.4},bonusVsType:'rock',ignoreReflect:true}]},
  { id:660, name:'掘地兔', type:'normal', type2:'ground', hp:230, tier:1, ability:{id:'normal-domain', name:'神域支配', trigger:'onEnter', desc:'上場時場地切換為莊嚴神社；一般屬性攻擊傷害額外 +40'}, attacks:[{name:'地震',dmg:72,cost:4,type:'ground',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'灼熱吸血擊',dmg:79,cost:4,type:'fire',rider:'type-draw'},{name:'衝撞',dmg:108,cost:9,type:'normal',megaBoost:true,bonusEnergy:7,rider:'life-drain'},{name:'岩崩',dmg:148,cost:14,type:'rock',ignoreReflect:true,selfHeal:0.21,bonusVsType:'fire'}]},
  { id:632, name:'鐵蟻', type:'steel', type2:'bug', hp:200, tier:1, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'冰霜威壓擊',dmg:95,cost:6,type:'ice',rider:'move-reflect'},{name:'金屬爪',dmg:58,cost:1,type:'steel',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'蟲咬',dmg:54,cost:1,type:'bug',megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:127,cost:11,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water',ignoreReflect:true,ignoreShield:true}]},
  { id:558, name:'岩殿居蟹', type:'bug', type2:'rock', hp:240, tier:1, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'蟲咬',dmg:90,cost:6,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'荒草吸能擊',dmg:50,cost:0,type:'grass',rider:'self-cure'},{name:'岩石封鎖',dmg:93,cost:6,type:'rock',megaBoost:true,bonusEnergy:5},{name:'烈火強衝',dmg:122,cost:11,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.4},bonusVsType:'steel',ignoreShield:true}]},
  { id:105, name:'嘎啦嘎啦', type:'ground',  hp:220, tier:1, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'蟲毒護甲擊',dmg:66,cost:3,type:'bug',rider:'self-cure'},{name:'喊叫',dmg:73,cost:3,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'地震',dmg:102,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:132,cost:13,type:'ghost',selfHeal:0.25,bonusVsType:'ghost',ignoreReflect:true,ignoreShield:true}]},
  { id:338, name:'太陽岩', type:'rock', type2:'psychic', hp:230, tier:1, ability:{id:'grass-domain', name:'密林支配', trigger:'onEnter', desc:'上場時場地切換為邪惡森林；草屬性攻擊傷害額外 +40'}, attacks:[{name:'夜襲',dmg:117,cost:10,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:7,ignoreReflect:true},{name:'念力',dmg:79,cost:5,type:'psychic',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'岩石炮',dmg:150,cost:15,type:'rock',megaBoost:true,bonusEnergy:8,bonusVsType:'bug'},{name:'疾風強奪擊',dmg:82,cost:5,type:'flying',rider:'mega-charge'}]},
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'岩崩吸血擊',dmg:65,cost:2,type:'rock',rider:'energy-steal'},{name:'音爆拳',dmg:61,cost:2,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'啃咬',dmg:102,cost:7,type:'dark',megaBoost:true,bonusEnergy:5,rider:'guard-up'},{name:'吼叫',dmg:131,cost:12,type:'normal',ignoreReflect:true,status:{effect:'confusion', chance:0.4},ignoreShield:true}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'drought-lava', name:'熔岩大地', trigger:'onEnter', desc:'上場時場地切換為熔岩火山；地面／火屬性攻擊傷害額外 +40'}, attacks:[{name:'咬住',dmg:56,cost:1,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'龍之隕星',dmg:92,cost:7,type:'dragon',megaBoost:true,bonusEnergy:4,rider:'self-cure'},{name:'破魂威壓擊',dmg:99,cost:7,type:'fighting',ignoreReflect:true,rider:'weaken'},{name:'火焰牙',dmg:128,cost:12,type:'fire',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:5,bonusVsType:'grass'}]},
  { id:134, name:'水伊布', type:'water',  hp:260, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'水槍',dmg:69,cost:3,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:6,bonusVsType:'rock'},{name:'岩石碎裂',dmg:98,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6,rider:'move-reflect'},{name:'暗影吸能擊',dmg:105,cost:8,type:'dark',rider:'energy-steal'},{name:'冰凍光束',dmg:135,cost:13,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:7}]},
  { mega:{spriteId:10090, type:'bug', type2:'poison', ability:{id:'tough-claws', name:'隱形拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:15, name:'大針蜂', type:'bug', type2:'poison', hp:200, tier:1, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'針刺',dmg:53,cost:0,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5,bonusVsType:'dark'},{name:'毒針',dmg:50,cost:0,type:'poison',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'閃電拳',dmg:118,cost:11,type:'electric',megaBoost:true,bonusEnergy:5,bonusVsType:'water'},{name:'冰霜護甲擊',dmg:92,cost:6,type:'ice',rider:'self-cure'}]},
  { id:411, name:'護城龍', type:'rock', type2:'steel', hp:220, tier:1, ability:{id:'frisk-ward', name:'神秘之守', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'金屬音',dmg:73,cost:3,type:'steel',rider:'type-draw',megaBoost:true,bonusEnergy:6,bonusVsType:'fairy'},{name:'頭槌',dmg:69,cost:3,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'岩崩',dmg:132,cost:13,type:'rock',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'妖精強奪擊',dmg:105,cost:8,type:'fairy',rider:'self-cure'}]},
  { mega:{spriteId:10064, type:'water', type2:'ground', ability:{id:'huge-power', name:'指揮', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:260, name:'巨沼怪', type:'water', type2:'ground', hp:300, tier:2, ability:{id:'fairy-domain', name:'妖精支配', trigger:'onEnter', desc:'上場時場地切換為妖精結界原野；妖精屬性攻擊傷害額外 +40'}, attacks:[{name:'水槍',dmg:68,cost:3,type:'water',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:115,cost:9,type:'ground',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'精神吸血擊',dmg:144,cost:14,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting',ignoreReflect:true},{name:'冰凍拳',dmg:140,cost:14,type:'ice',status:{effect:'confusion', chance:0.4},bonusVsType:'flying'}]},
  { id:407, name:'羅絲雷朵', type:'grass', type2:'poison', hp:270, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'激流吸血擊',dmg:105,cost:9,type:'water',ignoreReflect:true,rider:'life-drain'},{name:'魔法葉',dmg:112,cost:9,type:'grass',megaBoost:true,bonusEnergy:7,rider:'weaken'},{name:'毒粉刺',dmg:75,cost:4,type:'poison',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'噴火',dmg:148,cost:14,type:'fire',status:{effect:'burn', chance:0.4},bonusVsType:'ice'}]},
  { id:724, name:'狙射樹梟', type:'grass', type2:'ghost', hp:290, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'飛葉快刀',dmg:65,cost:2,type:'grass',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'影子偷襲',dmg:101,cost:8,type:'ghost',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'烈焰衝浪腳',dmg:142,cost:13,type:'fire',status:{effect:'burn', chance:0.4},bonusVsType:'ice',ignoreReflect:true},{name:'猛禽炸彈',dmg:138,cost:13,type:'flying',selfHeal:0.25,bonusVsType:'fighting'}]},
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'sync-status', name:'同步', trigger:'onDefend', desc:'陷入中毒／麻痺／燒傷時，會將該狀態傳染給攻擊者'}, attacks:[{name:'毒針',dmg:50,cost:0,type:'poison',ignoreReflect:true,status:{effect:'poison', chance:0.4},megaBoost:true,bonusEnergy:4,status2:{effect:'sleep',chance:0.4}},{name:'夜斬',dmg:127,cost:11,type:'dark',megaBoost:true,bonusEnergy:4},{name:'疾風威壓擊',dmg:90,cost:6,type:'flying',rider:'energy-steal'},{name:'地震',dmg:119,cost:11,type:'ground',status:{effect:'sleep', chance:0.4},bonusVsType:'rock',ignoreReflect:true}]},
  { id:862, name:'堵攔熊', type:'dark', type2:'normal', hp:300, tier:2, ability:{id:'guts', name:'崩潰', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'夜斬',dmg:113,cost:9,type:'dark',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'高周波音',dmg:76,cost:4,type:'normal',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:138,cost:14,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting'},{name:'空間扭曲',dmg:145,cost:14,type:'dragon',selfHeal:0.2,bonusVsType:'dragon',ignoreReflect:true}]},
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'蟲咬',dmg:74,cost:4,type:'bug',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'電磁炮',dmg:147,cost:14,type:'electric',megaBoost:true,bonusEnergy:8,bonusVsType:'water'},{name:'幽冥威壓擊',dmg:110,cost:9,type:'ghost',megaBoost:true,bonusEnergy:7,rider:'type-draw'},{name:'妖精吸能擊',dmg:106,cost:9,type:'fairy',ignoreReflect:true,rider:'energy-steal'}]},
  { mega:{spriteId:10313, type:'ground', type2:'ghost', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:623, name:'泥偶巨人', type:'ground', type2:'ghost', hp:310, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'大地虹吸',dmg:115,cost:10,type:'ground',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'幽靈球',dmg:88,cost:5,type:'ghost',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'百萬針',dmg:150,cost:15,type:'bug',selfHeal:0.22,bonusVsType:'psychic'},{name:'冰霜拳',dmg:147,cost:15,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'grass',ignoreReflect:true}]},
  { mega:{spriteId:10280, type:'water', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:121, name:'寶石海星', type:'water', type2:'psychic', hp:270, tier:2, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'水槍',dmg:112,cost:10,type:'water',rider:'type-draw',megaBoost:true,bonusEnergy:8},{name:'精神強擊',dmg:119,cost:10,type:'psychic',megaBoost:true,bonusEnergy:8},{name:'蟲毒護甲擊',dmg:81,cost:5,type:'bug',rider:'self-cure'},{name:'近身戰',dmg:150,cost:15,type:'fighting',ignoreReflect:true,selfHeal:0.15,bonusVsType:'ice',ignoreShield:true}]},
  { mega:{spriteId:10045, type:'electric', type2:'dragon', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:181, name:'電龍', type:'electric',  hp:300, tier:2, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'電擊',dmg:82,cost:4,type:'electric',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'衝撞',dmg:111,cost:9,type:'normal',megaBoost:true,bonusEnergy:6},{name:'冰霜護甲擊',dmg:140,cost:14,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'flying',ignoreReflect:true},{name:'精神護甲擊',dmg:147,cost:14,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting',ignoreReflect:true}]},
  { mega:{spriteId:10316, type:'bug', type2:'steel', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:768, name:'具甲武者', type:'bug', type2:'water', hp:290, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'大浪',dmg:99,cost:7,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'蟲咬',dmg:55,cost:1,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'聖焰',dmg:135,cost:12,type:'fire',selfHeal:0.17,bonusVsType:'ice'},{name:'雷光威壓擊',dmg:131,cost:12,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water',ignoreReflect:true}]},
  { id:465, name:'巨蔓藤', type:'grass',  hp:310, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'光合作用強擊',dmg:78,cost:4,type:'grass',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'灼熱吸血擊',dmg:107,cost:9,type:'fire',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'實力全開',dmg:147,cost:14,type:'normal',status:{effect:'confusion', chance:0.4},ignoreReflect:true},{name:'惡意突刺',dmg:143,cost:14,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true}]},
  { id:713, name:'冰岩怪', type:'ice',  hp:320, tier:2, ability:{id:'retaliate-boost', name:'反骨', trigger:'onDefend', desc:'受到攻擊後，下次攻擊傷害 ×1.1'}, attacks:[{name:'雪崩',dmg:132,cost:12,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:4},{name:'碎岩',dmg:128,cost:12,type:'rock',ignoreReflect:true,selfHeal:0.24,bonusVsType:'flying',ignoreShield:true},{name:'毒液',dmg:135,cost:12,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'grass'},{name:'光合作用強擊',dmg:98,cost:7,type:'grass',rider:'mega-charge',selfHeal:0.17}]},
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'thick-fat', name:'回復力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'念力',dmg:53,cost:0,type:'psychic',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'雷光強奪擊',dmg:89,cost:6,type:'electric',rider:'energy-steal'},{name:'幽冥威壓擊',dmg:118,cost:11,type:'ghost',selfHeal:0.2,bonusVsType:'ghost'},{name:'冰耳光',dmg:125,cost:11,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.4},bonusVsType:'flying'}]},
  { mega:{spriteId:10048, type:'dark', type2:'fire', ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:229, name:'黑魯加', type:'fire', type2:'dark', hp:280, tier:2, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'惡意波動',dmg:59,cost:1,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'火焰牙',dmg:128,cost:12,type:'fire',status:{effect:'burn', chance:0.4},megaBoost:true,bonusEnergy:5,bonusVsType:'ice'},{name:'水之脈動',dmg:135,cost:12,type:'water',ignoreReflect:true,selfHeal:0.26,bonusVsType:'ground'},{name:'精神吸血擊',dmg:98,cost:7,type:'psychic',rider:'self-cure'}]},
  { id:464, name:'超甲狂犀', type:'ground', type2:'rock', hp:360, tier:3, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'角撞',dmg:142,cost:14,type:'normal',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:138,cost:14,type:'ground',selfHeal:0.18},{name:'岩崩',dmg:145,cost:14,type:'rock',status:{effect:'confusion', chance:0.4},bonusVsType:'flying',ignoreReflect:true},{name:'惡意突刺',dmg:108,cost:9,type:'poison',rider:'self-cure',status:{effect:'poison', chance:0.4},status2:{effect:'confusion',chance:0.4}}]},
  { id:473, name:'象牙豬', type:'ice', type2:'ground', hp:235, tier:3, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'雪崩',dmg:85,cost:6,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:6,bonusVsType:'ground'},{name:'地震',dmg:125,cost:11,type:'ground',selfHeal:0.28,bonusVsType:'steel'},{name:'啃咬',dmg:88,cost:6,type:'dark',status:{effect:'freeze', chance:0.4},selfHeal:0.25,status2:{effect:'sleep',chance:0.4}},{name:'毒針',dmg:55,cost:0,type:'poison',rider:'mega-charge',status:{effect:'poison', chance:0.4},status2:{effect:'freeze',chance:0.4}}]},
  { id:625, name:'劈斬司令', type:'dark', type2:'steel', hp:295, tier:3, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'金屬爪',dmg:139,cost:13,type:'steel',megaBoost:true,bonusEnergy:5,bonusVsType:'ice'},{name:'夜斬',dmg:135,cost:13,type:'dark',ignoreReflect:true,selfHeal:0.16,bonusVsType:'ghost'},{name:'水炮',dmg:75,cost:3,type:'water',rider:'mega-charge',selfHeal:0.23},{name:'念力衝擊',dmg:104,cost:8,type:'psychic',rider:'type-draw',selfHeal:0.3}]},
  /* ── Mega 進化擴充（Legends Z-A / 原有 46 種缺漏補完） ── */
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'sturdy', name:'硬殼盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'rock-domain', name:'磐岩支配', trigger:'onEnter', desc:'上場時場地切換為岩石地帶；岩石屬性攻擊傷害額外 +40'}, attacks:[{name:'破空飛翔',dmg:68,cost:3,type:'flying',rider:'energy-steal',megaBoost:true,bonusEnergy:6,bonusVsType:'bug'},{name:'電光一閃',dmg:75,cost:3,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'幽冥威壓擊',dmg:138,cost:13,type:'ghost',megaBoost:true,bonusEnergy:6,bonusVsType:'ghost'},{name:'劇毒威壓擊',dmg:100,cost:8,type:'poison',rider:'weaken'}]},
  { mega:{spriteId:10039, type:'normal', type2:null, ability:{id:'frisk-ward', name:'惡作劇之心', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:115, name:'袋獸', type:'normal', hp:280, tier:2, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'拍打',dmg:62,cost:1,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'咬碎',dmg:131,cost:12,type:'dark',megaBoost:true,bonusEnergy:5},{name:'破魂吸能擊',dmg:94,cost:7,type:'fighting',ignoreReflect:true,rider:'energy-steal'},{name:'地震',dmg:134,cost:12,type:'ground',status:{effect:'sleep', chance:0.4},bonusVsType:'steel',ignoreReflect:true}]},
  { mega:{spriteId:10040, type:'bug', type2:'flying', ability:{id:'huge-power', name:'飛毛腿', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:127, name:'凱羅斯', type:'bug', hp:210, tier:1, ability:{id:'healing-rainbow', name:'治癒彩虹', trigger:'onDefend', desc:'被擊倒後可以復活一次，HP 回復 50%（整場戰鬥限一次）；不會受到任何負面狀態'}, attacks:[{name:'斷頭台',dmg:59,cost:2,type:'bug',ignoreReflect:true,megaBoost:true,bonusEnergy:5,rider:'self-cure'},{name:'精神護甲擊',dmg:66,cost:2,type:'psychic',rider:'mega-charge'},{name:'綁緊',dmg:102,cost:8,type:'normal',megaBoost:true,bonusEnergy:5,rider:'card-steal'},{name:'石頭砸落',dmg:132,cost:13,type:'rock',status:{effect:'confusion', chance:0.4},bonusVsType:'flying'}]},
  { mega:{spriteId:10072, type:'steel', type2:'ground', ability:{id:'solid-rock', name:'德爾塔氣流', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:208, name:'大鋼蛇', type:'steel', type2:'ground', hp:290, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'綁緊',dmg:74,cost:3,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'鐵尾',dmg:103,cost:8,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'地震',dmg:133,cost:13,type:'ground',selfHeal:0.17,bonusVsType:'poison'},{name:'大浪',dmg:140,cost:13,type:'water',selfHeal:0.2,bonusVsType:'ground',ignoreReflect:true}]},
  { mega:{spriteId:10050, type:'fire', type2:'fighting', ability:{id:'solid-rock', name:'揚沙', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:257, name:'火焰雞', type:'fire', type2:'fighting', hp:260, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'踢腿',dmg:106,cost:8,type:'fighting',ignoreReflect:true,megaBoost:true,bonusEnergy:7,rider:'move-reflect'},{name:'火花',dmg:69,cost:3,type:'fire',megaBoost:true,bonusEnergy:7,rider:'guard-up'},{name:'居合斬',dmg:98,cost:8,type:'dark',megaBoost:true,bonusEnergy:7,rider:'weaken'},{name:'冰霜強奪擊',dmg:139,cost:13,type:'ice',rider:'move-reflect'}]},
  { mega:{spriteId:10066, type:'dark', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:302, name:'勾魂眼', type:'dark', type2:'ghost', hp:200, tier:1, ability:{id:'solid-rock', name:'揚沙', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'暗影球',dmg:62,cost:1,type:'ghost',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'蟲毒吸血擊',dmg:58,cost:1,type:'bug',ignoreReflect:true,rider:'life-drain'},{name:'寶石爆破',dmg:94,cost:7,type:'rock',megaBoost:true,bonusEnergy:5},{name:'暗黑爆破',dmg:134,cost:12,type:'dark',selfHeal:0.25,bonusVsType:'psychic',ignoreReflect:true}]},
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'guts', name:'毅力', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'啃咬',dmg:50,cost:0,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:53,cost:0,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'幽冥威壓擊',dmg:89,cost:6,type:'ghost',rider:'weaken'},{name:'毒牙',dmg:118,cost:11,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true}]},
  { mega:{spriteId:10053, type:'steel', type2:null, ability:{id:'frisk-ward', name:'踩影', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:306, name:'波士可多拉', type:'steel', type2:'rock', hp:200, tier:2, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'金屬爪',dmg:59,cost:1,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'岩石滑落',dmg:55,cost:1,type:'rock',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'幽冥威壓擊',dmg:95,cost:6,type:'ghost',selfHeal:0.18,bonusVsType:'ghost'},{name:'雪崩',dmg:124,cost:11,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'ground',ignoreReflect:true}]},
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'氣功拳',dmg:58,cost:2,type:'fighting',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:65,cost:2,type:'psychic',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'岩崩吸能擊',dmg:95,cost:7,type:'rock',rider:'energy-steal'},{name:'惡意彈珠',dmg:135,cost:12,type:'dark',ignoreReflect:true,selfHeal:0.3,bonusVsType:'psychic'}]},
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'tough-claws', name:'貫穿之鑽', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'十萬伏特',dmg:82,cost:5,type:'electric',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'大地護甲擊',dmg:78,cost:5,type:'ground',ignoreReflect:true,rider:'guard-up'},{name:'吼叫',dmg:119,cost:10,type:'normal',megaBoost:true,bonusEnergy:8,rider:'mega-charge'},{name:'火焰牙',dmg:148,cost:15,type:'fire',selfHeal:0.26,bonusVsType:'steel'}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'衝浪',dmg:72,cost:4,type:'water',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'劇毒強奪擊',dmg:112,cost:9,type:'poison',rider:'move-reflect'},{name:'咬碎',dmg:75,cost:4,type:'dark',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:148,cost:14,type:'ice',selfHeal:0.18,bonusVsType:'grass',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10087, type:'fire', type2:'ground', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:323, name:'噴火駝', type:'fire', type2:'ground', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火花',dmg:73,cost:3,type:'fire',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:102,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽冥吸血擊',dmg:98,cost:8,type:'ghost',ignoreReflect:true,rider:'life-drain'},{name:'鐵頭',dmg:139,cost:13,type:'steel',status:{effect:'sleep', chance:0.4},bonusVsType:'rock',ignoreReflect:true}]},
  { mega:{spriteId:10067, type:'dragon', type2:'fairy', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:334, name:'七夕青鳥', type:'dragon', type2:'flying', hp:270, tier:2, ability:{id:'steel-domain', name:'鋼鐵支配', trigger:'onEnter', desc:'上場時場地切換為鋼鐵堡壘；鋼屬性攻擊傷害額外 +40'}, attacks:[{name:'啄',dmg:86,cost:5,type:'flying',rider:'mega-charge',megaBoost:true,bonusEnergy:7,bonusVsType:'fighting'},{name:'龍之氣息',dmg:116,cost:10,type:'dragon',megaBoost:true,bonusEnergy:8,rider:'mega-charge'},{name:'劇毒強奪擊',dmg:145,cost:15,type:'poison',megaBoost:true,bonusEnergy:7,bonusVsType:'fairy'},{name:'荒草威壓擊',dmg:119,cost:10,type:'grass',rider:'type-draw'}]},
  { mega:{spriteId:10056, type:'ghost', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:354, name:'詛咒娃娃', type:'ghost', hp:210, tier:1, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'暗影球',dmg:56,cost:1,type:'ghost',rider:'mega-charge',megaBoost:true,bonusEnergy:5},{name:'雷光吸能擊',dmg:52,cost:1,type:'electric',rider:'type-draw'},{name:'暗黑爆破',dmg:99,cost:7,type:'dark',megaBoost:true,bonusEnergy:5,rider:'life-drain'},{name:'空間扭曲',dmg:128,cost:12,type:'psychic',ignoreReflect:true,selfHeal:0.19,bonusVsType:'poison'}]},
  { mega:{spriteId:10074, type:'ice', type2:null, ability:{id:'thick-fat', name:'再生力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:362, name:'冰鬼護', type:'ice', hp:260, tier:2, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'冰耳光',dmg:107,cost:8,type:'ice',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'激流護甲擊',dmg:70,cost:3,type:'water',rider:'mega-charge'},{name:'鐵頭',dmg:99,cost:8,type:'steel',megaBoost:true,bonusEnergy:6},{name:'暗黑爆破',dmg:140,cost:13,type:'dark',selfHeal:0.2,bonusVsType:'psychic',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10089, type:'dragon', type2:'flying', ability:{id:'huge-power', name:'太陽核心', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:373, name:'暴飛龍', type:'dragon', type2:'flying', hp:220, tier:3, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'咬碎',dmg:114,cost:9,type:'dark',megaBoost:true,bonusEnergy:6,bonusVsType:'psychic',ignoreReflect:true},{name:'龍之氣息',dmg:77,cost:4,type:'dragon',selfHeal:0.27},{name:'冰霜吸血擊',dmg:139,cost:14,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'flying'},{name:'燕返',dmg:80,cost:4,type:'flying',rider:'mega-charge',status:{effect:'confusion', chance:0.4},status2:{effect:'sleep',chance:0.4}}]},
  { mega:{spriteId:10062, type:'dragon', type2:'psychic', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:380, name:'拉帝亞斯', type:'dragon', type2:'psychic', hp:320, tier:3, ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'念力',dmg:126,cost:12,type:'psychic',megaBoost:true,bonusEnergy:4},{name:'龍之氣息',dmg:133,cost:12,type:'dragon',status:{effect:'sleep', chance:0.4},bonusVsType:'dragon'},{name:'魔法閃耀',dmg:129,cost:12,type:'fairy',status:{effect:'freeze', chance:0.4},bonusVsType:'fighting',ignoreReflect:true},{name:'熔岩爆發',dmg:92,cost:7,type:'fire',rider:'type-draw',status:{effect:'burn', chance:0.4},status2:{effect:'poison',chance:0.4}}]},
  { mega:{spriteId:10063, type:'dragon', type2:'psychic', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:381, name:'拉帝歐斯', type:'dragon', type2:'psychic', hp:320, tier:3, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'龍之隕星',dmg:128,cost:12,type:'dragon',megaBoost:true,bonusEnergy:4},{name:'念力',dmg:135,cost:12,type:'psychic',status:{effect:'burn', chance:0.4},bonusVsType:'fighting',ignoreReflect:true},{name:'冷凍光線',dmg:131,cost:12,type:'ice',selfHeal:0.23,bonusVsType:'flying',ignoreReflect:true,ignoreShield:true},{name:'地震',dmg:94,cost:7,type:'ground',selfHeal:0.16}]},
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'破壞光線',dmg:114,cost:9,type:'normal',rider:'energy-steal',megaBoost:true,bonusEnergy:6,ignoreReflect:true},{name:'連續切',dmg:77,cost:4,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'岩石碎裂',dmg:139,cost:14,type:'fighting',megaBoost:true,bonusEnergy:6,bonusVsType:'normal'},{name:'精神強奪擊',dmg:80,cost:4,type:'psychic',rider:'mega-charge'}]},
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'tough-claws', name:'強行', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'thick-fat', name:'冰凍之軀', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'冰霜拳',dmg:59,cost:1,type:'ice',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:128,cost:12,type:'grass',megaBoost:true,bonusEnergy:4},{name:'劇毒強奪擊',dmg:135,cost:12,type:'poison',ignoreReflect:true,status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreShield:true},{name:'破魂吸血擊',dmg:98,cost:7,type:'fighting',rider:'type-draw'}]},
  { mega:{spriteId:10068, type:'psychic', type2:'fighting', ability:{id:'tough-claws', name:'揭露之貌', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:475, name:'艾路雷朵', type:'psychic', type2:'fighting', hp:260, tier:2, ability:{id:'ground-domain', name:'風沙支配', trigger:'onEnter', desc:'上場時場地切換為沙塵暴；地面屬性攻擊傷害額外 +40'}, attacks:[{name:'踢腿',dmg:109,cost:9,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:105,cost:9,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'妖精威壓擊',dmg:79,cost:4,type:'fairy',rider:'mega-charge'},{name:'十萬伏特',dmg:141,cost:14,type:'electric',ignoreReflect:true,status:{effect:'paralysis', chance:0.4},bonusVsType:'flying',ignoreShield:true}]},
  { mega:{spriteId:10069, type:'normal', type2:'fairy', ability:{id:'multiscale', name:'多重鱗片', trigger:'onDefend', desc:'HP 全滿時，受到的攻擊傷害 ×0.9'}}, id:531, name:'差不多娃娃', type:'normal', hp:300, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'拍打',dmg:71,cost:3,type:'normal',rider:'type-draw',megaBoost:true,bonusEnergy:6},{name:'大地護甲擊',dmg:100,cost:8,type:'ground',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'魔法閃耀',dmg:141,cost:13,type:'fairy',selfHeal:0.28,bonusVsType:'dark'},{name:'日光束',dmg:137,cost:13,type:'grass',selfHeal:0.29,bonusVsType:'ground',ignoreReflect:true}]},
  { mega:{spriteId:10075, type:'rock', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:719, name:'蒂安希', type:'rock', type2:'fairy', hp:300, tier:3, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'岩石滑落',dmg:113,cost:9,type:'rock',rider:'mega-charge',megaBoost:true,bonusEnergy:7},{name:'魔法閃耀',dmg:76,cost:4,type:'fairy',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'破魂強奪擊',dmg:138,cost:14,type:'fighting',status:{effect:'sleep', chance:0.4},bonusVsType:'steel'},{name:'閃光炮',dmg:145,cost:14,type:'steel',selfHeal:0.21,bonusVsType:'rock',ignoreReflect:true}]},
  { mega:{spriteId:10278, type:'fairy', type2:'flying', ability:{id:'adaptability', name:'飛行皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:36, name:'皮可西', type:'fairy', hp:280, tier:2, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'拍打',dmg:58,cost:1,type:'normal',rider:'type-draw',megaBoost:true,bonusEnergy:5},{name:'疾風吸能擊',dmg:87,cost:6,type:'flying',rider:'energy-steal'},{name:'妖精吸能擊',dmg:127,cost:11,type:'fairy',selfHeal:0.2,bonusVsType:'dark'},{name:'毒液',dmg:123,cost:11,type:'poison',ignoreReflect:true,status:{effect:'poison', chance:0.4},bonusVsType:'grass'}]},
  { mega:{spriteId:10279, type:'grass', type2:'poison', ability:{id:'solid-rock', name:'防彈', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:71, name:'大食花', type:'grass', type2:'poison', hp:230, tier:1, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'激流護甲擊',dmg:88,cost:5,type:'water',rider:'type-draw'},{name:'惡意突刺',dmg:84,cost:5,type:'poison',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'葉刃',dmg:114,cost:10,type:'grass',megaBoost:true,bonusEnergy:7},{name:'鐵頭',dmg:150,cost:15,type:'steel',status:{effect:'sleep', chance:0.4},bonusVsType:'rock',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10284, type:'steel', type2:'flying', ability:{id:'solid-rock', name:'重甲化', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:227, name:'盔甲鳥', type:'steel', type2:'flying', hp:270, tier:2, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'啄',dmg:115,cost:10,type:'flying',rider:'mega-charge',megaBoost:true,bonusEnergy:8,ignoreReflect:true},{name:'鐵頭',dmg:122,cost:10,type:'steel',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'蟲刃剪',dmg:150,cost:15,type:'bug',megaBoost:true,bonusEnergy:8,bonusVsType:'psychic'},{name:'破魂強奪擊',dmg:80,cost:5,type:'fighting',rider:'energy-steal'}]},
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'drizzle-ocean', name:'海洋支配', trigger:'onEnter', desc:'上場時場地切換為海洋世界；水／冰屬性攻擊傷害額外 +40'}, attacks:[{name:'念力',dmg:73,cost:4,type:'psychic',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'大地吸血擊',dmg:80,cost:4,type:'ground',rider:'mega-charge'},{name:'破魂威壓擊',dmg:116,cost:10,type:'fighting',megaBoost:true,bonusEnergy:6,rider:'self-cure'},{name:'高周波音',dmg:145,cost:15,type:'normal',selfHeal:0.25,ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10311, type:'fire', type2:'steel', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:485, name:'席多藍恩', type:'fire', type2:'steel', hp:285, tier:3, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'金屬爪',dmg:127,cost:12,type:'steel',megaBoost:true,bonusEnergy:5},{name:'大字爆炎',dmg:134,cost:12,type:'fire',ignoreReflect:true,selfHeal:0.18},{name:'毒針',dmg:97,cost:7,type:'poison',rider:'mega-charge',status:{effect:'poison', chance:0.4},status2:{effect:'burn',chance:0.4}},{name:'寶石爆破',dmg:53,cost:1,type:'rock',rider:'type-draw',status:{effect:'confusion', chance:0.4},status2:{effect:'poison',chance:0.4}}]},
  { mega:{spriteId:10312, type:'dark', type2:null, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:491, name:'達克萊伊', type:'dark', hp:310, tier:3, ability:{id:'blaze-boost', name:'葉綠素', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'夜騷動',dmg:115,cost:10,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'暗影球',dmg:88,cost:5,type:'ghost',rider:'energy-steal',megaBoost:true,bonusEnergy:7},{name:'泥巴射擊',dmg:150,cost:15,type:'ground',selfHeal:0.26,bonusVsType:'rock'},{name:'火焰牙',dmg:147,cost:15,type:'fire',ignoreReflect:true,status:{effect:'burn', chance:0.4},bonusVsType:'ice'}]},
  { mega:{spriteId:10286, type:'fire', type2:'fighting', ability:{id:'guts', name:'不服輸', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:500, name:'炎武王', type:'fire', type2:'fighting', hp:300, tier:2, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'火花',dmg:82,cost:4,type:'fire',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:111,cost:9,type:'fighting',ignoreReflect:true,megaBoost:true,bonusEnergy:5},{name:'荒草吸血擊',dmg:140,cost:14,type:'grass',selfHeal:0.28,bonusVsType:'water',ignoreReflect:true},{name:'幽靈之爪',dmg:147,cost:14,type:'ghost',selfHeal:0.29,bonusVsType:'psychic'}]},
  { mega:{spriteId:10287, type:'ground', type2:'steel', ability:{id:'solid-rock', name:'極巨腺體', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:530, name:'龍頭地鼠', type:'ground', type2:'steel', hp:300, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'金屬爪',dmg:76,cost:4,type:'steel',rider:'self-cure',megaBoost:true,bonusEnergy:7},{name:'泥巴射擊',dmg:105,cost:9,type:'ground',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'岩石滑落',dmg:145,cost:14,type:'rock',selfHeal:0.18,bonusVsType:'bug',ignoreReflect:true},{name:'雪崩',dmg:141,cost:14,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'ground'}]},
  { mega:{spriteId:10288, type:'bug', type2:'poison', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:545, name:'蜈蚣王', type:'bug', type2:'poison', hp:260, tier:2, ability:{id:'dark-domain', name:'暗夜支配', trigger:'onEnter', desc:'上場時場地切換為暗夜詛咒領域；惡屬性攻擊傷害額外 +40'}, attacks:[{name:'連續啃咬',dmg:66,cost:3,type:'bug',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'逆鱗威壓擊',dmg:113,cost:9,type:'dragon',rider:'self-cure'},{name:'毒液',dmg:109,cost:9,type:'poison',megaBoost:true,bonusEnergy:6},{name:'冰凍光束',dmg:138,cost:14,type:'ice',ignoreReflect:true,status:{effect:'freeze', chance:0.4},bonusVsType:'dragon',ignoreShield:true}]},
  { mega:{spriteId:10289, type:'dark', type2:'fighting', ability:{id:'huge-power', name:'加速', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:560, name:'頭巾混混', type:'dark', type2:'fighting', hp:240, tier:1, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'灼熱吸能擊',dmg:101,cost:7,type:'fire',rider:'move-reflect',ignoreReflect:true},{name:'惡意波動',dmg:97,cost:7,type:'dark',megaBoost:true,bonusEnergy:5,rider:'weaken'},{name:'近身戰',dmg:53,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5,rider:'move-reflect'},{name:'冰凍拳',dmg:133,cost:12,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'flying'}]},
  { mega:{spriteId:10290, type:'electric', type2:null, ability:{id:'huge-power', name:'親子羈絆', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:604, name:'麻麻鰻魚王', type:'electric', hp:270, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'咬碎',dmg:121,cost:10,type:'dark',rider:'mega-charge',megaBoost:true,bonusEnergy:7,ignoreReflect:true},{name:'電磁炮',dmg:150,cost:15,type:'electric',megaBoost:true,bonusEnergy:8,bonusVsType:'water'},{name:'毒牙',dmg:113,cost:10,type:'poison',megaBoost:true,bonusEnergy:8,rider:'card-steal'},{name:'破魂護甲擊',dmg:86,cost:5,type:'fighting',rider:'self-cure'}]},
  { mega:{spriteId:10292, type:'grass', type2:'fighting', ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:652, name:'布里卡隆', type:'grass', type2:'fighting', hp:300, tier:2, ability:{id:'no-weakness-dodge-60', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；60% 機率完全閃避攻擊'}, attacks:[{name:'藤鞭',dmg:84,cost:5,type:'grass',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'磚塊',dmg:114,cost:10,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'吼叫',dmg:150,cost:15,type:'normal',selfHeal:0.19,ignoreReflect:true},{name:'燕返',dmg:150,cost:15,type:'flying',selfHeal:0.16,bonusVsType:'fighting',ignoreReflect:true}]},
  { mega:{spriteId:10293, type:'fire', type2:'psychic', ability:{id:'thick-fat', name:'治癒之心', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:655, name:'妖火紅狐', type:'fire', type2:'psychic', hp:260, tier:2, ability:{id:'magic-guard', name:'魔法防守', trigger:'onStatus', desc:'不會受到中毒／燒傷的傷害'}, attacks:[{name:'火花',dmg:106,cost:9,type:'fire',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'未來雷霆',dmg:113,cost:9,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'暗影強奪擊',dmg:76,cost:4,type:'dark',rider:'mega-charge'},{name:'毒針',dmg:138,cost:14,type:'poison',status:{effect:'confusion', chance:0.4},bonusVsType:'fairy',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10295, type:'fire', type2:'normal', ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:668, name:'火炎獅', type:'fire', type2:'normal', hp:270, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'突擊',dmg:117,cost:10,type:'normal',rider:'move-reflect',megaBoost:true,bonusEnergy:8},{name:'破魂吸血擊',dmg:113,cost:10,type:'fighting',ignoreReflect:true,rider:'life-drain'},{name:'大字爆炎',dmg:150,cost:15,type:'fire',megaBoost:true,bonusEnergy:8,bonusVsType:'ice'},{name:'惡意波動',dmg:82,cost:5,type:'dark',selfHeal:0.24,rider:'guard-up'}]},
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'blaze-boost', name:'太陽之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}, attacks:[{name:'魔法閃耀',dmg:67,cost:2,type:'fairy',rider:'self-cure',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:63,cost:2,type:'electric',ignoreReflect:true,rider:'weaken'},{name:'突擊',dmg:93,cost:7,type:'normal',megaBoost:true,bonusEnergy:4,rider:'mega-charge'},{name:'日光束',dmg:133,cost:12,type:'grass',status:{effect:'freeze', chance:0.4},bonusVsType:'rock'}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'mold-breaker', name:'破格', trigger:'onAttack', desc:'攻擊時無視對方的防禦型特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'念力',dmg:68,cost:3,type:'psychic',rider:'energy-steal',megaBoost:true,bonusEnergy:6},{name:'大地吸能擊',dmg:75,cost:3,type:'ground',rider:'self-cure'},{name:'火花',dmg:111,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:140,cost:14,type:'dark',status:{effect:'sleep', chance:0.4},bonusVsType:'psychic',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10297, type:'dark', type2:'psychic', ability:{id:'huge-power', name:'精神力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:687, name:'烏賊王', type:'dark', type2:'psychic', hp:260, tier:2, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'惡意波動',dmg:75,cost:3,type:'dark',ignoreReflect:true,megaBoost:true,bonusEnergy:6,rider:'type-draw'},{name:'精神強擊',dmg:104,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6,rider:'energy-steal'},{name:'神速護甲擊',dmg:100,cost:8,type:'normal',rider:'type-draw'},{name:'大地波動',dmg:141,cost:13,type:'ground',selfHeal:0.21,bonusVsType:'rock'}]},
  { mega:{spriteId:10298, type:'rock', type2:'fighting', ability:{id:'huge-power', name:'連續攻擊', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:689, name:'龜足巨鎧', type:'rock', type2:'water', hp:260, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'岩石滑落',dmg:108,cost:9,type:'rock',rider:'mega-charge',megaBoost:true,bonusEnergy:6},{name:'鋼影強奪擊',dmg:82,cost:4,type:'steel',rider:'type-draw'},{name:'衝浪',dmg:111,cost:9,type:'water',megaBoost:true,bonusEnergy:6},{name:'妖精吸能擊',dmg:140,cost:14,type:'fairy',ignoreReflect:true,selfHeal:0.21,bonusVsType:'fighting',ignoreShield:true}]},
  { mega:{spriteId:10299, type:'poison', type2:'dragon', ability:{id:'blaze-boost', name:'火鬃', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:691, name:'毒藻龍', type:'poison', type2:'dragon', hp:260, tier:2, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'惡意突刺',dmg:112,cost:9,type:'poison',rider:'type-draw',megaBoost:true,bonusEnergy:7},{name:'破魂吸血擊',dmg:75,cost:4,type:'fighting',rider:'energy-steal'},{name:'逆鱗護甲擊',dmg:115,cost:9,type:'dragon',megaBoost:true,bonusEnergy:7},{name:'十字剪',dmg:144,cost:14,type:'bug',ignoreReflect:true,selfHeal:0.15,bonusVsType:'grass',ignoreShield:true}]},
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害+40'}, attacks:[{name:'空手劈',dmg:83,cost:5,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'大地威壓擊',dmg:79,cost:5,type:'ground',rider:'energy-steal'},{name:'疾風吸能擊',dmg:120,cost:10,type:'flying',megaBoost:true,bonusEnergy:8},{name:'惡意突刺',dmg:149,cost:15,type:'poison',status:{effect:'poison', chance:0.4},bonusVsType:'fairy',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10301, type:'dragon', type2:'ground', ability:{id:'frisk-ward', name:'穿透', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:718, name:'基格爾德', type:'dragon', type2:'ground', hp:320, tier:3, ability:{id:'guts', name:'堅韌', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}, attacks:[{name:'咬碎',dmg:104,cost:8,type:'dark',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'大地虹吸',dmg:134,cost:13,type:'ground',status:{effect:'burn', chance:0.4},bonusVsType:'steel'},{name:'電球',dmg:141,cost:13,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'flying',ignoreReflect:true},{name:'龍之波動',dmg:137,cost:13,type:'dragon',rider:'type-draw',selfHeal:0.21}]},
  { mega:{spriteId:10315, type:'fighting', type2:'ice', ability:{id:'adaptability', name:'龍化', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:740, name:'好勝毛蟹', type:'fighting', type2:'ice', hp:270, tier:2, ability:{id:'insomnia', name:'不眠', trigger:'onDefend', desc:'不會陷入睡眠狀態'}, attacks:[{name:'岩崩吸能擊',dmg:118,cost:10,type:'rock',rider:'move-reflect',ignoreReflect:true},{name:'決勝衝擊',dmg:147,cost:15,type:'fighting',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'冰凍拳',dmg:121,cost:10,type:'ice',megaBoost:true,bonusEnergy:7,rider:'move-reflect'},{name:'夜襲',dmg:83,cost:5,type:'dark',selfHeal:0.29,rider:'guard-up'}]},
  { mega:{spriteId:10302, type:'normal', type2:'dragon', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:780, name:'老翁龍', type:'normal', type2:'dragon', hp:300, tier:2, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'吼叫',dmg:114,cost:9,type:'normal',rider:'self-cure',megaBoost:true,bonusEnergy:6},{name:'龍之氣息',dmg:77,cost:4,type:'dragon',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'精神護甲擊',dmg:139,cost:14,type:'psychic',status:{effect:'confusion', chance:0.4},bonusVsType:'fighting',ignoreReflect:true},{name:'月亮力量',dmg:146,cost:14,type:'fairy',selfHeal:0.28,bonusVsType:'dark'}]},
  { mega:{spriteId:10317, type:'steel', type2:'fairy', ability:{id:'solid-rock', name:'過濾', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:801, name:'瑪機雅娜', type:'steel', type2:'fairy', hp:310, tier:3, ability:{id:'solid-rock', name:'終結之地', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'鐵頭',dmg:112,cost:9,type:'steel',ignoreReflect:true,megaBoost:true,bonusEnergy:8},{name:'魔法閃耀',dmg:75,cost:4,type:'fairy',rider:'energy-steal',megaBoost:true,bonusEnergy:8},{name:'污泥炸彈',dmg:148,cost:14,type:'poison',selfHeal:0.16,bonusVsType:'grass'},{name:'爆炸火焰',dmg:144,cost:14,type:'fire',selfHeal:0.18,bonusVsType:'bug',ignoreReflect:true}]},
  { mega:{spriteId:10319, type:'electric', type2:null, ability:{id:'guts', name:'熱交換', trigger:'onAttack', desc:'自身帶有異常狀態時，攻擊傷害 +40'}}, id:807, name:'捷拉奧拉', type:'electric', hp:310, tier:3, ability:{id:'flame-body', name:'火焰之軀', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入燒傷'}, attacks:[{name:'雷霆',dmg:120,cost:10,type:'electric',ignoreReflect:true,megaBoost:true,bonusEnergy:7},{name:'磚塊',dmg:82,cost:5,type:'fighting',rider:'mega-charge',megaBoost:true,bonusEnergy:8},{name:'冰霜吸血擊',dmg:145,cost:15,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'ground',ignoreReflect:true},{name:'幽靈球',dmg:150,cost:15,type:'ghost',selfHeal:0.24,bonusVsType:'ghost'}]},
  { mega:{spriteId:10303, type:'fighting', type2:null, ability:{id:'adaptability', name:'變幻自如', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:870, name:'列陣兵', type:'fighting', hp:230, tier:1, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'岩石碎裂',dmg:80,cost:5,type:'fighting',rider:'self-cure',megaBoost:true,bonusEnergy:8},{name:'精神護甲擊',dmg:87,cost:5,type:'psychic',ignoreReflect:true,rider:'guard-up'},{name:'大地威壓擊',dmg:117,cost:10,type:'ground',megaBoost:true,bonusEnergy:8,rider:'energy-steal'},{name:'妖精之風',dmg:146,cost:15,type:'fairy',selfHeal:0.18,bonusVsType:'dark'}]},
  { mega:{spriteId:10320, type:'grass', type2:'fire', ability:{id:'huge-power', name:'心之力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:952, name:'狠辣椒', type:'grass', type2:'fire', hp:220, tier:1, ability:{id:'own-tempo', name:'我行我素', trigger:'onDefend', desc:'不會陷入混亂狀態'}, attacks:[{name:'能量球',dmg:79,cost:5,type:'grass',ignoreReflect:true,megaBoost:true,bonusEnergy:6},{name:'神速強奪擊',dmg:86,cost:5,type:'normal',rider:'mega-charge'},{name:'噴射火焰',dmg:116,cost:10,type:'fire',megaBoost:true,bonusEnergy:6},{name:'電擊',dmg:145,cost:15,type:'electric',status:{effect:'paralysis', chance:0.4},bonusVsType:'water',ignoreReflect:true,ignoreShield:true}]},
  { mega:{spriteId:10321, type:'rock', type2:'poison', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:970, name:'晶光花', type:'rock', type2:'poison', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'岩石滑落',dmg:76,cost:4,type:'rock',rider:'self-cure',megaBoost:true,bonusEnergy:5,bonusVsType:'flying'},{name:'污泥炸彈',dmg:112,cost:10,type:'poison',megaBoost:true,bonusEnergy:5,rider:'card-steal'},{name:'幽冥吸血擊',dmg:119,cost:10,type:'ghost',rider:'mega-charge'},{name:'冰霜吸血擊',dmg:148,cost:15,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'ground'}]},
  { mega:{spriteId:10322, type:'dragon', type2:'water', ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:978, name:'米立龍', type:'dragon', type2:'water', hp:210, tier:1, ability:{id:'sturdy', name:'戰鬥盔甲', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'水槍',dmg:67,cost:2,type:'water',rider:'energy-steal',megaBoost:true,bonusEnergy:5},{name:'龍之脈動',dmg:63,cost:2,type:'dragon',rider:'self-cure',megaBoost:true,bonusEnergy:5},{name:'劇毒威壓擊',dmg:93,cost:7,type:'poison',rider:'weaken'},{name:'雪崩',dmg:133,cost:12,type:'ice',status:{effect:'freeze', chance:0.4},bonusVsType:'ground',ignoreReflect:true}]},
  { mega:{spriteId:10325, type:'dragon', type2:'ice', ability:{id:'adaptability', name:'適應力', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:998, name:'戟脊龍', type:'dragon', type2:'ice', hp:245, tier:3, ability:{id:'crimson-pulse', name:'緋紅脈動', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1；每回合開始必定額外抽到一張直搗黃龍'}, attacks:[{name:'冰耳光',dmg:57,cost:1,type:'ice',status:{effect:'freeze', chance:0.4},megaBoost:true,bonusEnergy:6,rider:'weaken'},{name:'龍之波動',dmg:93,cost:7,type:'dragon',rider:'self-cure',status:{effect:'confusion', chance:0.4},status2:{effect:'sleep',chance:0.4}},{name:'寶石爆破',dmg:133,cost:12,type:'rock',selfHeal:0.23,bonusVsType:'bug'},{name:'蟲毒吸能擊',dmg:96,cost:7,type:'bug',selfHeal:0.17,rider:'weaken'}]},
];
const EFF = {
...
const MEGA_MOVESET_RANGE = { 1: [60, 160], 2: [70, 175], 3: [80, 190] };
