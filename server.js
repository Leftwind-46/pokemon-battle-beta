...
const POKEMON = [
  ...
  // Tier 2
  { mega:{spriteId:10034, type:'fire', type2:'dragon', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 ×1.3'}}, id:6,   name:'噴火龍',     type:'fire',     type2:'flying',  hp:290, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'火焰噴射',dmg:26,cost:2,type:'fire',status:{effect:'burn', chance:0.25},megaBoost:true,bonusEnergy:6},{name:'龍息',dmg:58,cost:7,type:'dragon',megaBoost:true,bonusEnergy:5},{name:'火焰衝擊',dmg:95,cost:12,type:'fire',status:{effect:'paralysis', chance:0.2}},{name:'破空飛翔',dmg:100,cost:12,type:'flying',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'水砲',dmg:20,cost:0,type:'water',megaBoost:true,bonusEnergy:4},{name:'影舞',cost:2,type:'water',support:true,effect:'shadow-dance'},{name:'衝浪',dmg:90,cost:11,type:'water',selfHeal:0.28},{name:'冰凍光束',dmg:93,cost:11,type:'ice',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10058, type:'dragon', type2:'ground', ability:{id:'blaze-boost', name:'沙之力', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}}, id:445, name:'烈咬陸鯊',   type:'dragon',   type2:'ground',  hp:280, tier:2, ability:{id:'frisk-ward', name:'沙隱', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'龍爪',dmg:23,cost:1,type:'dragon',megaBoost:true,bonusEnergy:5},{name:'集氣',cost:3,type:'dragon',support:true,effect:'focus-energy',bonusEnergy:9},{name:'地震',dmg:95,cost:11,type:'ground',selfHeal:0.23},{name:'龍之隕星',dmg:93,cost:11,type:'dragon',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'冰凍光束',dmg:21,cost:0,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'怒風',dmg:52,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'冰耳光',dmg:92,cost:11,type:'ice',status:{effect:'sleep', chance:0.2}},{name:'冥想',cost:3,type:'ice',support:true,effect:'meditate'}]},
  ...
  { mega:{spriteId:10065, type:'grass', type2:'dragon', ability:{id:'motor-drive', name:'避雷針', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:254, name:'蜥蜴王',     type:'grass',                     hp:260, tier:2, ability:{id:'blaze-boost', name:'茂盛', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.5'}, attacks:[{name:'電球',dmg:29,cost:2,type:'electric',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'能量球',dmg:61,cost:8,type:'grass',status:{effect:'confusion', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'大地之力',dmg:59,cost:7,type:'ground',megaBoost:true,bonusEnergy:5},{name:'冥想',cost:3,type:'grass',support:true,effect:'meditate'}]},
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'纏繞',dmg:25,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:23,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:50,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'}]},
  ...
  { mega:{spriteId:10308, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:398, name:'姆克鷹',     type:'normal',   type2:'flying',  hp:240, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'燕返',dmg:24,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'衝撞',dmg:51,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'羽棲',cost:8,type:'flying',support:true,effect:'roost'},{name:'勇鳥猛衝',dmg:93,cost:12,type:'flying',selfHeal:0.25}]},
  ...
  { id:53, name:'貓老大', type:'normal',  hp:210, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'冥想',cost:3,type:'normal',support:true,effect:'meditate'},{name:'音爆拳',dmg:27,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'惡意突刺',dmg:59,cost:7,type:'dark',megaBoost:true,bonusEnergy:5},{name:'連續切',dmg:98,cost:12,type:'normal',status:{effect:'confusion', chance:0.25}}]},
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 ×1.3'}, attacks:[{name:'咬住',dmg:21,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'吼叫',dmg:50,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'normal',support:true,effect:'trick'},{name:'火焰牙',dmg:52,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  ...
  { id:452, name:'龍王蠍', type:'poison', type2:'dark', hp:280, tier:2, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害×1.1'}, attacks:[{name:'毒針',dmg:24,cost:0,type:'poison',status:{effect:'poison', chance:0.3},megaBoost:true,bonusEnergy:4},{name:'夜斬',dmg:50,cost:6,type:'dark',megaBoost:true,bonusEnergy:4},{name:'撐住',cost:5,type:'poison',support:true,effect:'brace'},{name:'惡意突刺',dmg:90,cost:11,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  ...
  { id:576, name:'哥德小姐', type:'psychic',  hp:280, tier:2, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.5'}, attacks:[{name:'念力',dmg:28,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'擾亂精神',cost:1,type:'psychic',support:true,effect:'debuff',status:{effect:'confusion', chance:1}},{name:'精神強擊',dmg:94,cost:11,type:'psychic',selfHeal:0.2},{name:'未來預知',dmg:99,cost:12,type:'psychic',status:{effect:'freeze', chance:0.15}}]},
  ...
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.5'}, attacks:[{name:'啃咬',dmg:21,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:24,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'詭計',cost:3,type:'steel',support:true,effect:'trick'},{name:'重磅衝撞',dmg:91,cost:11,type:'steel',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10054, type:'fighting', type2:'psychic', ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}}, id:308, name:'恰雷姆', type:'fighting', type2:'psychic', hp:210, tier:1, ability:{id:'huge-power', name:'驚人怪力', trigger:'onAttack', desc:'攻擊傷害固定 ×1.25'}, attacks:[{name:'空手劈',dmg:26,cost:1,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'念力',dmg:29,cost:1,type:'psychic',megaBoost:true,bonusEnergy:5},{name:'小偷',cost:5,type:'fighting',support:true,effect:'thief'},{name:'惡意彈珠',dmg:96,cost:12,type:'dark',selfHeal:0.3}]},
  ...
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×2以上）的攻擊傷害再減少 25%'}, attacks:[{name:'冰霜拳',dmg:22,cost:1,type:'ice',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:50,cost:6,type:'grass',megaBoost:true,bonusEnergy:4},{name:'暴風雪',dmg:90,cost:11,type:'ice',status:{effect:'poison', chance:0.3}},{name:'劍舞',cost:4,type:'grass',support:true,effect:'sword-dance'}]},
  ...
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×2（原本 ×1.5）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害減半'}, attacks:[{name:'魔法閃耀',dmg:22,cost:0,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'劍舞',cost:4,type:'fairy',support:true,effect:'sword-dance'},{name:'月亮之力',dmg:50,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'葉暴風',dmg:90,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
...
const TRAINERS = [
  ...
  {id:'tailwind',      name:'順風',     cat:'item', type:'flying',  desc:'下次攻擊若為飛行屬性，傷害 ×1.2'},
  ...
  {id:'dragon-pulse',  name:'龍之波動', cat:'item', type:'dragon',  desc:'下次攻擊若為龍屬性，傷害 ×1.6'},
  {id:'focus-punch',   name:'捨身猛擊', cat:'item', type:'fighting',desc:'下次攻擊威力 ×1.2，但自身 HP ×0.8'},
  // ── supporters ──
  ...
  {id:'all-out',    name:'全力出擊',   cat:'supporter', desc:'下次攻擊傷害 ×2，但下回合無法回復能量'},
  ...
  {id:'stadium-evil-forest',   name:'邪惡森林',   cat:'stadium', type:'grass',  desc:'原本克制草屬性的寶可夢（火／冰／飛行／毒／蟲），全部變成弱草屬性（草屬性攻擊 ×2）'},
  ...
  {id:'stadium-colosseum',     name:'羅馬鬥技場', cat:'stadium', type:'fighting', desc:'格鬥屬性招式傷害 ×1.5；格鬥屬性攻擊不再被幽靈屬性完全免疫'},
  {id:'stadium-mystic-space',  name:'魔幻空間',   cat:'stadium', type:'psychic', desc:'超能力屬性寶可夢受到的傷害 ×0.9；弱點消失（不受超效傷害影響）'},
  {id:'stadium-lava',          name:'熔岩火山',   cat:'stadium', type:'fire',   desc:'火屬性招式傷害 ×1.1；水屬性招式傷害 ×0.5'},
  {id:'stadium-ocean',         name:'海洋世界',   cat:'stadium', type:'water',  desc:'水屬性招式消耗能量減半；電屬性招式傷害 ×1.5'},
  {id:'stadium-shrine',        name:'莊嚴神社',   cat:'stadium', type:'normal', desc:'一般屬性招式一律視為剋制對手（效果拉滿 ×2）'},
  // ── stadium：屬性分類新卡 ──
  {id:'stadium-sandstorm',   name:'沙塵暴',   cat:'stadium', type:'ground', desc:'非地面／岩石／鋼屬性寶可夢，每回合結束損失最大HP的6%'},
  {id:'stadium-rock-field',  name:'岩石地帶', cat:'stadium', type:'rock',   desc:'岩石／地面／鋼屬性寶可夢，受到的攻擊傷害 ×0.85'},
];
...
function doAttack(attacker, defender, atk, aBuff, dBuff, log, G, switchGuardMult = 1) {
  ...
  const abilityDmgMult = ((attacker.ability?.id === 'guts' && attacker.status) ? 1.3
    ...
    : (attacker.ability?.id === 'drought-lava' && (atkType === 'ground' || atkType === 'fire')) ? 1.25
  ...
  // 岩石地帶：岩石／地面／鋼屬性寶可夢，受到的攻擊傷害×0.85
  const rockFieldMult = (G.activeStadium?.id === 'stadium-rock-field' &&
    (['rock','ground','steel'].includes(defender.type) || ['rock','ground','steel'].includes(defender.type2))) ? 0.85 : 1;
...
function applyTrainer(card, role, G, log, chosenType) {
  ...
  switch (card.id) {
    ...
    case 'all-out':
      ...
      log.push({ text: `使用了全力出擊，下次攻擊傷害 ×2！但下回合無法回復能量！`, cls: 'system' });
      break;
    case 'fire-bomb': {
    ...
    case 'tailwind':
      buff.typeBoost = { type: 'flying', mult: 1.2 };
      log.push({ text: `使用了順風，下次攻擊若為飛行屬性，傷害 ×1.2！`, cls: 'system' });
      break;
    case 'fairy-wind': {
      active.status = null;
    ...
    case 'dragon-pulse':
      buff.typeBoost = { type: 'dragon', mult: 1.6 };
      log.push({ text: `使用了龍之波動，下次攻擊若為龍屬性，傷害 ×1.6！`, cls: 'system' });
      break;
    case 'focus-punch':
      buff.atkMult = Math.max(buff.atkMult, 1.2);
      active.cur = Math.max(1, Math.round(active.cur * 0.8));
      log.push({ text: `使用了捨身猛擊，下次攻擊威力 ×1.2！但 ${active.name} 損失了 20% 目前 HP！`, cls: 'system' });
      break;
    case 'energy-drain': {
