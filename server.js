...
const POKEMON = [
  ...
  { mega:{spriteId:10304, type:'electric', type2:null, ability:{id:'motor-drive', name:'電氣場地', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:26,  name:'雷丘',       type:'electric', hp:200, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'衝撞',dmg:60,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'十萬伏特',dmg:60,cost:1,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:5},{name:'電磁衝浪',dmg:120,cost:6,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:4},{name:'逆鱗威壓擊',dmg:38,cost:5,type:'dragon',rider:'weaken'}]},
  ...
  { id:87,  name:'白海獅',     type:'water',    type2:'ice',     hp:240, tier:1, ability:{id:'legacy-boost', name:'指揮', trigger:'onLeave', desc:'陣亡或被換下場時，下一隻上場的我方寶可夢首次攻擊：能量消耗×0.5、傷害+40'}, attacks:[{name:'冷凍光線',dmg:61,cost:3,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:5},{name:'荒草吸血擊',dmg:25,cost:3,type:'grass',rider:'life-drain'},{name:'大浪',dmg:100,cost:6,type:'water',megaBoost:true,bonusEnergy:4},{name:'衝浪',dmg:148,cost:11,type:'water',status:{effect:'confusion', chance:0.25}}]},
  { id:82,  name:'三合一磁怪',   type:'electric', type2:'steel',   hp:210, tier:1, ability:{id:'item-synergy', name:'機械之心', trigger:'onAttack', desc:'本回合使用過道具卡時，攻擊傷害 +40'}, attacks:[{name:'電磁炮',dmg:65,cost:2,type:'electric',status:{effect:'paralysis', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:22,cost:3,type:'poison',rider:'weaken'},{name:'電磁衝浪',dmg:108,cost:8,type:'electric',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'閃光炮',dmg:157,cost:12,type:'steel',selfHeal:0.18}]},
  ...
  { mega:{spriteId:10036, type:'water', type2:null, ability:{id:'huge-power', name:'超級發射器', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:9,   name:'水箭龜',     type:'water',    hp:280, tier:2, ability:{id:'blaze-boost', name:'激流', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'水砲',dmg:50,cost:0,type:'water',megaBoost:true,bonusEnergy:4},{name:'蟲毒吸能擊',dmg:34,cost:2,type:'bug',rider:'energy-steal'},{name:'衝浪',dmg:120,cost:11,type:'water',selfHeal:0.28},{name:'冰凍光束',dmg:123,cost:11,type:'ice',selfHeal:0.29}]},
  ...
  { mega:{spriteId:10285, type:'ice', type2:'ghost', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:478, name:'雪妖女',     type:'ice',      type2:'ghost',   hp:280, tier:2, ability:{id:'frisk-ward', name:'雪隱', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'冰凍光束',dmg:51,cost:0,type:'ice',status:{effect:'freeze', chance:0.15},megaBoost:true,bonusEnergy:4},{name:'怒風',dmg:82,cost:6,type:'flying',megaBoost:true,bonusEnergy:4},{name:'冰耳光',dmg:122,cost:11,type:'ice',status:{effect:'sleep', chance:0.2}},{name:'激流威壓擊',dmg:24,cost:3,type:'water',rider:'weaken'}]},
  ...
  { id:250, name:'鳳王',       type:'fire',     type2:'flying',  hp:340, tier:3, ability:{id:'flying-domain', name:'疾風支配', trigger:'onEnter', desc:'上場時場地切換為疾風之翼；飛行屬性攻擊傷害額外 +40'}, attacks:[{name:'怒風',dmg:56,cost:3,type:'flying',status:{effect:'paralysis', chance:0.2}},{name:'聖焰',dmg:93,cost:8,type:'fire',status:{effect:'burn', chance:0.3}},{name:'大地波動',dmg:90,cost:9,type:'ground',rider:'energy-steal'},{name:'神聖之焰',dmg:140,cost:13,type:'fire',selfHeal:0.22}]},
  { id:249, name:'洛奇亞',     type:'psychic',  type2:'flying',  hp:340, tier:3, ability:{id:'psychic-domain', name:'幻境支配', trigger:'onEnter', desc:'上場時場地切換為魔幻空間；超能力屬性攻擊傷害額外 +40'}, attacks:[{name:'念力',dmg:55,cost:3,type:'psychic',status:{effect:'confusion', chance:0.25}},{name:'暴風',dmg:92,cost:8,type:'flying',status:{effect:'sleep', chance:0.2}},{name:'冰凍光束',dmg:88,cost:9,type:'ice',rider:'guard-up'},{name:'極光束',dmg:138,cost:13,type:'flying',status:{effect:'freeze', chance:0.15}}]},
  ...
  { id:146, name:'火焰鳥',     type:'fire',     type2:'flying',  hp:200, tier:3, ability:{id:'pressure', name:'壓迫感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'火焰衝擊',dmg:72,cost:11,type:'fire',status:{effect:'burn', chance:0.3},megaBoost:true,bonusEnergy:6},{name:'超能力',dmg:65,cost:4,type:'psychic',status:{effect:'confusion', chance:0.15},selfHeal:0.16},{name:'噴射火焰',dmg:76,cost:9,type:'fire',status:{effect:'paralysis', chance:0.2}},{name:'怒風',dmg:76,cost:9,type:'flying',selfHeal:0.28}]},
  { id:888,name:'蒼響',      type:'fairy',    type2:'steel',   hp:370, tier:3, ability:{id:'steel-domain', name:'鋼鐵支配', trigger:'onEnter', desc:'上場時場地切換為鋼鐵堡壘；鋼屬性攻擊傷害額外 +40'}, attacks:[{name:'鐵頭功',dmg:66,cost:8,type:'steel',megaBoost:true,bonusEnergy:8},{name:'剛劍',dmg:94,cost:11,type:'steel',selfHeal:0.19},{name:'接近戰',dmg:94,cost:11,type:'fighting',selfHeal:0.21},{name:'神秘劍',dmg:80,cost:6,type:'fairy',selfHeal:0.18}]},
  { id:716, name:'哲爾尼亞斯', type:'fairy',    hp:330, tier:3, ability:{id:'adaptability', name:'妖精氣場', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}, attacks:[{name:'妖精之風',dmg:57,cost:3,type:'fairy'},{name:'月亮力量',dmg:94,cost:8,type:'fairy',status:{effect:'paralysis', chance:0.2}},{name:'十萬伏特',dmg:90,cost:9,type:'electric',rider:'card-steal'},{name:'光之波動',dmg:139,cost:13,type:'fairy',status:{effect:'freeze', chance:0.15}}]},
  { id:378, name:'雷吉艾斯',   type:'ice',      hp:370, tier:3, ability:{id:'thick-fat', name:'厚脂肪', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}, attacks:[{name:'暴風雪',dmg:78,cost:13,type:'ice',status:{effect:'freeze', chance:0.2},megaBoost:true,bonusEnergy:8},{name:'閃光炮',dmg:71,cost:8,type:'steel',status:{effect:'paralysis', chance:0.2}},{name:'冰耳光',dmg:84,cost:13,type:'ice',status:{effect:'confusion', chance:0.25}},{name:'電磁砲',dmg:71,cost:8,type:'electric',status:{effect:'burn', chance:0.25}}]},
  { id:717, name:'伊裴爾塔爾', type:'dark',     type2:'flying',  hp:350, tier:3, ability:{id:'no-weakness-dodge', name:'深淵支配', trigger:'onDefend', desc:'不會受到超效傷害；10% 機率完全閃避攻擊'}, attacks:[{name:'惡意波動',dmg:58,cost:3,type:'dark'},{name:'空氣斬',dmg:91,cost:8,type:'flying',status:{effect:'freeze', chance:0.15}},{name:'大地虹吸',dmg:85,cost:9,type:'ground',rider:'life-drain'},{name:'夜騷動',dmg:141,cost:13,type:'dark',selfHeal:0.25}]},
  { id:483, name:'帝牙盧卡',   type:'steel',    type2:'dragon',  hp:360, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'閃光炮',dmg:76,cost:12,type:'steel',megaBoost:true,bonusEnergy:7},{name:'鋼鐵翼',dmg:95,cost:10,type:'steel',selfHeal:0.19},{name:'龍爪',dmg:81,cost:5,type:'dragon',selfHeal:0.21},{name:'時間咆哮',dmg:95,cost:10,type:'dragon',selfHeal:0.2}]},
  { id:484, name:'帕路奇亞',   type:'water',    type2:'dragon',  hp:200, tier:3, ability:{id:'dragon-domain', name:'龍域降臨', trigger:'onEnter', desc:'上場時場地切換為龍之谷；龍屬性攻擊傷害額外 +40'}, attacks:[{name:'衝浪',dmg:65,cost:7,type:'water',megaBoost:true,bonusEnergy:7},{name:'龍之脈動',dmg:70,cost:6,type:'dragon',status:{effect:'paralysis', chance:0.2}},{name:'水之脈動',dmg:82,cost:11,type:'water',selfHeal:0.25},{name:'空間扭曲',dmg:98,cost:11,type:'dragon',selfHeal:0.15}]},
  ...
  { id:24,  name:'阿柏怪',     type:'poison',                    hp:200, tier:1, ability:{id:'poison-domain', name:'劇毒支配', trigger:'onEnter', desc:'上場時場地切換為劇毒領域；毒屬性攻擊傷害額外 +40'}, attacks:[{name:'纏繞',dmg:66,cost:0,type:'normal',status:{effect:'sleep', chance:0.25},megaBoost:true,bonusEnergy:4},{name:'毒牙',dmg:64,cost:0,type:'poison',status:{effect:'poison', chance:0.35},megaBoost:true,bonusEnergy:4},{name:'甩尾',dmg:96,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'鋼影護甲擊',dmg:12,cost:5,type:'steel',rider:'guard-up'}]},
  ...
  { id:477, name:'黑夜魔靈',   type:'ghost',                     hp:220, tier:1, ability:{id:'ghost-domain', name:'亡靈支配', trigger:'onEnter', desc:'上場時場地切換為亡靈墓園；幽靈屬性攻擊傷害額外 +40'}, attacks:[{name:'暗影爪',dmg:72,cost:3,type:'ghost',status:{effect:'paralysis', chance:0.2},megaBoost:true,bonusEnergy:6},{name:'冰凍拳',dmg:72,cost:3,type:'ice',status:{effect:'freeze', chance:0.1},megaBoost:true,bonusEnergy:6},{name:'幽靈球',dmg:113,cost:8,type:'ghost',megaBoost:true,bonusEnergy:6},{name:'疾風強奪擊',dmg:11,cost:3,type:'flying',rider:'card-steal'}]},
  ...
  { mega:{spriteId:10057, type:'dark', type2:null, ability:{id:'frisk-ward', name:'魔法鏡', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}}, id:359, name:'阿勃梭魯',   type:'dark',                      hp:220, tier:1, ability:{id:'huge-power', name:'超幸運', trigger:'onAttack', desc:'攻擊傷害固定 +40'}, attacks:[{name:'夜斬',dmg:70,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'追影斬',dmg:68,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'妖精威壓擊',dmg:27,cost:3,type:'fairy',rider:'weaken'},{name:'暗黑脈衝',dmg:163,cost:14,type:'dark',selfHeal:0.26}]},
  // ── +30 新增（最終進化型，非幻獸/神獸，無龍/妖精屬性）──
  { id:865, name:'蔥遊兵', type:'fighting',  hp:220, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'連續攻擊',dmg:67,cost:3,type:'normal',megaBoost:true,bonusEnergy:6},{name:'鋼影吸能擊',dmg:33,cost:2,type:'steel',rider:'energy-steal'},{name:'居合斬',dmg:112,cost:8,type:'fighting',status:{effect:'paralysis', chance:0.15},megaBoost:true,bonusEnergy:6},{name:'近身戰',dmg:157,cost:13,type:'fighting',selfHeal:0.18}]},
  { id:297, name:'鐵掌力士', type:'fighting',  hp:250, tier:1, ability:{id:'fighting-domain', name:'鬥氣支配', trigger:'onEnter', desc:'上場時場地切換為羅馬鬥技場；格鬥屬性攻擊傷害額外 +40'}, attacks:[{name:'壓制',dmg:55,cost:1,type:'normal',megaBoost:true,bonusEnergy:5},{name:'近身戰',dmg:84,cost:7,type:'fighting',megaBoost:true,bonusEnergy:5},{name:'豪腕',dmg:125,cost:12,type:'fighting',selfHeal:0.22},{name:'蟲毒護甲擊',dmg:27,cost:3,type:'bug',rider:'guard-up'}]},
  ...
  { id:508, name:'長毛狗', type:'normal',  hp:240, tier:1, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'咬住',dmg:61,cost:0,type:'normal',megaBoost:true,bonusEnergy:4},{name:'吼叫',dmg:96,cost:6,type:'normal',megaBoost:true,bonusEnergy:4},{name:'破魂威壓擊',dmg:11,cost:3,type:'fighting',rider:'weaken'},{name:'火焰牙',dmg:98,cost:7,type:'fire',status:{effect:'burn', chance:0.15},megaBoost:true,bonusEnergy:5}]},
  ...
  { id:407, name:'羅絲雷朵', type:'grass', type2:'poison', hp:270, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'激流吸血擊',dmg:31,cost:4,type:'water',rider:'life-drain'},{name:'魔法葉',dmg:99,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'花瓣舞',dmg:99,cost:9,type:'grass',megaBoost:true,bonusEnergy:7},{name:'污泥炸彈',dmg:141,cost:14,type:'poison',status:{effect:'burn', chance:0.25}}]},
  ...
  { id:738, name:'鍬農炮蟲', type:'bug', type2:'electric', hp:270, tier:2, ability:{id:'desperate-blade', name:'背水之刃', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'蟲咬',dmg:64,cost:4,type:'bug',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:99,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'蟲鳴',dmg:96,cost:9,type:'bug',megaBoost:true,bonusEnergy:7},{name:'妖精吸能擊',dmg:25,cost:5,type:'fairy',rider:'energy-steal'}]},
  ...
  { mega:{spriteId:10073, type:'normal', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:18, name:'大比鳥', type:'normal', type2:'flying', hp:220, tier:1, ability:{id:'frisk-ward', name:'牽制', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:61,cost:2,type:'flying',megaBoost:true,bonusEnergy:6},{name:'疾風拳',dmg:62,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'燕返',dmg:109,cost:8,type:'flying',megaBoost:true,bonusEnergy:6},{name:'劇毒威壓擊',dmg:50,cost:8,type:'poison',rider:'weaken'}]},
  { mega:{spriteId:10039, type:'normal', type2:null, ability:{id:'huge-power', name:'親子羈絆', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:115, name:'袋獸', type:'normal', hp:280, tier:2, ability:{id:'status-immune-once', name:'淬鍊之心', trigger:'onStatus', desc:'首次被施加異常狀態時解除並免疫，之後攻擊傷害永久 +40'}, attacks:[{name:'扒',dmg:55,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'連環巴掌',dmg:85,cost:7,type:'normal',megaBoost:true,bonusEnergy:5},{name:'破魂吸能擊',dmg:17,cost:5,type:'fighting',rider:'energy-steal'},{name:'地震',dmg:126,cost:12,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  ...
  { mega:{spriteId:10050, type:'fire', type2:'fighting', ability:{id:'huge-power', name:'加速', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:257, name:'火焰雞', type:'fire', type2:'fighting', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'踢腿',dmg:59,cost:4,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'火花',dmg:95,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'烈焰衝浪腳',dmg:98,cost:9,type:'fire',megaBoost:true,bonusEnergy:7},{name:'冰霜強奪擊',dmg:34,cost:5,type:'ice',rider:'card-steal'}]},
  ...
  { mega:{spriteId:10052, type:'steel', type2:'fairy', ability:{id:'huge-power', name:'大力士', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:303, name:'大嘴娃', type:'steel', type2:'fairy', hp:200, tier:1, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}, attacks:[{name:'啃咬',dmg:61,cost:0,type:'dark',megaBoost:true,bonusEnergy:4},{name:'鐵頭',dmg:65,cost:0,type:'steel',megaBoost:true,bonusEnergy:4},{name:'幽冥威壓擊',dmg:12,cost:3,type:'ghost',rider:'weaken'},{name:'重磅衝撞',dmg:145,cost:11,type:'steel',status:{effect:'poison', chance:0.3}}]},
  ...
  { mega:{spriteId:10055, type:'electric', type2:null, ability:{id:'intimidate', name:'威嚇', trigger:'onEnter', desc:'上場時讓對方下一次攻擊傷害 ×0.9'}}, id:310, name:'雷電獸', type:'electric', hp:230, tier:1, ability:{id:'static', name:'靜電', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者陷入麻痺'}, attacks:[{name:'電擊',dmg:84,cost:5,type:'electric',megaBoost:true,bonusEnergy:8},{name:'大地護甲擊',dmg:10,cost:3,type:'ground',rider:'guard-up'},{name:'十萬伏特',dmg:124,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'火焰牙',dmg:176,cost:15,type:'fire',selfHeal:0.26}]},
  { mega:{spriteId:10070, type:'water', type2:'dark', ability:{id:'tough-claws', name:'強壯之顎', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:319, name:'巨牙鯊', type:'water', type2:'dark', hp:220, tier:1, ability:{id:'rough-skin', name:'粗糙皮膚', trigger:'onDefend', desc:'受到攻擊傷害時，反彈攻擊者 1/8 最大HP 傷害'}, attacks:[{name:'水槍',dmg:78,cost:4,type:'water',megaBoost:true,bonusEnergy:7},{name:'劇毒強奪擊',dmg:34,cost:5,type:'poison',rider:'card-steal'},{name:'衝浪',dmg:122,cost:10,type:'water',megaBoost:true,bonusEnergy:8},{name:'冰牙',dmg:176,cost:14,type:'ice',selfHeal:0.18}]},
  { mega:{spriteId:10087, type:'fire', type2:'ground', ability:{id:'tough-claws', name:'強行', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:323, name:'噴火駝', type:'fire', type2:'ground', hp:260, tier:2, ability:{id:'solid-rock', name:'硬岩', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'火花',dmg:59,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'泥巴射擊',dmg:97,cost:8,type:'ground',megaBoost:true,bonusEnergy:6},{name:'幽冥吸血擊',dmg:24,cost:3,type:'ghost',rider:'life-drain'},{name:'地震',dmg:139,cost:13,type:'ground',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10067, type:'dragon', type2:'fairy', ability:{id:'adaptability', name:'妖精皮膚', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:334, name:'七夕青鳥', type:'dragon', type2:'flying', hp:270, tier:2, ability:{id:'frisk-ward', name:'自然回復', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'啄',dmg:66,cost:4,type:'flying',megaBoost:true,bonusEnergy:7},{name:'龍之氣息',dmg:101,cost:10,type:'dragon',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:104,cost:9,type:'flying',megaBoost:true,bonusEnergy:7},{name:'荒草威壓擊',dmg:50,cost:8,type:'grass',rider:'weaken'}]},
  ...
  { mega:{spriteId:10088, type:'normal', type2:'fighting', ability:{id:'huge-power', name:'根性', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:428, name:'長耳兔', type:'normal', hp:220, tier:1, ability:{id:'frisk-ward', name:'魅力', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'連續拳',dmg:67,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速星星拳',dmg:64,cost:2,type:'normal',megaBoost:true,bonusEnergy:6},{name:'高速旋轉踢',dmg:114,cost:8,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'精神強奪擊',dmg:25,cost:1,type:'psychic',rider:'card-steal'}]},
  { mega:{spriteId:10060, type:'grass', type2:'ice', ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:460, name:'暴雪王', type:'grass', type2:'ice', hp:280, tier:2, ability:{id:'solid-rock', name:'降雪', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'冰霜拳',dmg:52,cost:1,type:'ice',megaBoost:true,bonusEnergy:5},{name:'魔法葉',dmg:80,cost:6,type:'grass',megaBoost:true,bonusEnergy:4},{name:'暴風雪',dmg:120,cost:11,type:'ice',status:{effect:'poison', chance:0.3}},{name:'破魂吸血擊',dmg:38,cost:4,type:'fighting',rider:'life-drain'}]},
  { mega:{spriteId:10068, type:'psychic', type2:'fighting', ability:{id:'huge-power', name:'精神力', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:475, name:'艾路雷朵', type:'psychic', type2:'fighting', hp:260, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'空手劈',dmg:51,cost:3,type:'fighting',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:89,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'妖精威壓擊',dmg:16,cost:2,type:'fairy',rider:'weaken'},{name:'近身戰',dmg:133,cost:13,type:'fighting',status:{effect:'paralysis', chance:0.2}}]},
  ...
  { mega:{spriteId:10284, type:'steel', type2:'flying', ability:{id:'solid-rock', name:'頑強', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:227, name:'盔甲鳥', type:'steel', type2:'flying', hp:270, tier:2, ability:{id:'sturdy', name:'頑強', trigger:'onDefend', desc:'HP 全滿時，受到會直接擊倒的攻擊會保留 1 HP'}, attacks:[{name:'啄',dmg:69,cost:5,type:'flying',megaBoost:true,bonusEnergy:8},{name:'鐵頭',dmg:105,cost:10,type:'steel',megaBoost:true,bonusEnergy:8},{name:'猛禽炸彈',dmg:105,cost:10,type:'flying',megaBoost:true,bonusEnergy:8},{name:'破魂強奪擊',dmg:63,cost:8,type:'fighting',rider:'card-steal'}]},
  { mega:{spriteId:10306, type:'psychic', type2:'steel', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:358, name:'風鈴鈴', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:61,cost:2,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'大地吸血擊',dmg:14,cost:5,type:'ground',rider:'life-drain'},{name:'未來預知',dmg:107,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'高周波音',dmg:155,cost:13,type:'normal',selfHeal:0.25}]},
  ...
  { mega:{spriteId:10290, type:'electric', type2:null, ability:{id:'motor-drive', name:'電鰻升格', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:604, name:'麻麻鰻魚王', type:'electric', hp:270, tier:2, ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}, attacks:[{name:'咬碎',dmg:69,cost:4,type:'dark',megaBoost:true,bonusEnergy:7},{name:'電擊',dmg:105,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'十萬伏特',dmg:101,cost:10,type:'electric',megaBoost:true,bonusEnergy:8},{name:'破魂護甲擊',dmg:19,cost:3,type:'fighting',rider:'guard-up'}]},
  ...
  { mega:{spriteId:10293, type:'fire', type2:'psychic', ability:{id:'motor-drive', name:'飄浮', trigger:'onDefend', desc:'受到電屬性攻擊時完全免疫，並回復 3 點能量'}}, id:655, name:'妖火紅狐', type:'fire', type2:'psychic', hp:260, tier:2, ability:{id:'blaze-boost', name:'猛火', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}, attacks:[{name:'火花',dmg:60,cost:3,type:'fire',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:98,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'暗影強奪擊',dmg:31,cost:2,type:'dark',rider:'card-steal'},{name:'未來預知',dmg:136,cost:14,type:'psychic',status:{effect:'confusion', chance:0.25}}]},
  { mega:{spriteId:10295, type:'fire', type2:'normal', ability:{id:'blaze-boost', name:'火鬃', trigger:'onAttack', desc:'HP 低於 1/3 時，本系招式傷害 ×1.1'}}, id:668, name:'火炎獅', type:'fire', type2:'normal', hp:270, tier:2, ability:{id:'pressure', name:'緊張感', trigger:'onEnter', desc:'上場時讓對方損失 3 點能量'}, attacks:[{name:'拍打',dmg:70,cost:5,type:'normal',megaBoost:true,bonusEnergy:8},{name:'破魂吸血擊',dmg:14,cost:5,type:'fighting',rider:'life-drain'},{name:'大字爆炎',dmg:105,cost:10,type:'fire',megaBoost:true,bonusEnergy:8},{name:'高周波音',dmg:150,cost:15,type:'normal',selfHeal:0.24}]},
  { mega:{spriteId:10296, type:'fairy', type2:null, ability:{id:'adaptability', name:'妖精領域', trigger:'onAttack', desc:'屬性加成（STAB）提升為 ×1.2（原本 ×1.1）'}}, id:670, name:'花葉蒂', type:'fairy', hp:200, tier:1, ability:{id:'frisk-ward', name:'花之守護', trigger:'onDefend', desc:'25% 機率將受到的傷害 ×0.9'}, attacks:[{name:'魔法閃耀',dmg:62,cost:0,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'雷光威壓擊',dmg:40,cost:4,type:'electric',rider:'weaken'},{name:'月亮之力',dmg:96,cost:6,type:'fairy',megaBoost:true,bonusEnergy:4},{name:'葉暴風',dmg:144,cost:11,type:'grass',status:{effect:'freeze', chance:0.15}}]},
  { mega:{spriteId:10314, type:'psychic', type2:null, ability:{id:'trace', name:'複製', trigger:'onEnter', desc:'上場時複製對手當前的特性'}}, id:678, name:'超能妙喵', type:'psychic', hp:220, tier:1, ability:{id:'chance-debuff', name:'穿透', trigger:'onAttack', desc:'攻擊命中後 25% 機率讓對方下次攻擊傷害 ×0.9'}, attacks:[{name:'念力',dmg:73,cost:3,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'大地吸能擊',dmg:20,cost:1,type:'ground',rider:'energy-steal'},{name:'未來預知',dmg:116,cost:9,type:'psychic',megaBoost:true,bonusEnergy:7},{name:'暗黑爆破',dmg:173,cost:14,type:'dark',status:{effect:'sleep', chance:0.2}}]},
  { mega:{spriteId:10297, type:'dark', type2:'psychic', ability:{id:'huge-power', name:'唱反調', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:687, name:'烏賊王', type:'dark', type2:'psychic', hp:260, tier:2, ability:{id:'shield-invert', name:'顛倒之心', trigger:'onDefend', desc:'對手的防禦加成效果對自己反而變成傷害加成'}, attacks:[{name:'惡意彈珠',dmg:54,cost:2,type:'dark',megaBoost:true,bonusEnergy:6},{name:'念力',dmg:95,cost:8,type:'psychic',megaBoost:true,bonusEnergy:6},{name:'神速護甲擊',dmg:13,cost:3,type:'normal',rider:'guard-up'},{name:'未來預知',dmg:131,cost:13,type:'psychic',selfHeal:0.21}]},
  { mega:{spriteId:10298, type:'rock', type2:'fighting', ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:689, name:'龜足巨鎧', type:'rock', type2:'water', hp:260, tier:2, ability:{id:'tough-claws', name:'硬爪', trigger:'onAttack', desc:'攻擊傷害 +40'}, attacks:[{name:'岩石滑落',dmg:55,cost:3,type:'rock',megaBoost:true,bonusEnergy:6},{name:'鋼影強奪擊',dmg:39,cost:3,type:'steel',rider:'card-steal'},{name:'石刃',dmg:96,cost:8,type:'rock',megaBoost:true,bonusEnergy:6},{name:'衝浪',dmg:140,cost:14,type:'water',selfHeal:0.21}]},
  { mega:{spriteId:10299, type:'poison', type2:'dragon', ability:{id:'thick-fat', name:'再生力', trigger:'onDefend', desc:'受到火／冰屬性攻擊傷害 ×0.92'}}, id:691, name:'毒藻龍', type:'poison', type2:'dragon', hp:260, tier:2, ability:{id:'poison-point', name:'毒刺', trigger:'onDefend', desc:'受到攻擊後 20% 機率讓攻擊者中毒'}, attacks:[{name:'毒液',dmg:61,cost:4,type:'poison',megaBoost:true,bonusEnergy:7},{name:'破魂吸血擊',dmg:34,cost:3,type:'fighting',rider:'life-drain'},{name:'污泥炸彈',dmg:100,cost:9,type:'poison',megaBoost:true,bonusEnergy:7},{name:'龍之波動',dmg:142,cost:14,type:'dragon',selfHeal:0.15}]},
  { mega:{spriteId:10300, type:'fighting', type2:'flying', ability:{id:'huge-power', name:'無防守', trigger:'onAttack', desc:'攻擊傷害固定 +40'}}, id:701, name:'摔角鷹人', type:'fighting', type2:'flying', hp:230, tier:1, ability:{id:'desperate-blade', name:'輕盈', trigger:'onAttack', desc:'HP 低於 50% 時，攻擊傷害 +40'}, attacks:[{name:'空手劈',dmg:83,cost:5,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'大地威壓擊',dmg:63,cost:8,type:'ground',rider:'weaken'},{name:'近身戰',dmg:124,cost:10,type:'fighting',megaBoost:true,bonusEnergy:8},{name:'空氣斬',dmg:180,cost:15,type:'flying',status:{effect:'poison', chance:0.3}}]},
  { mega:{spriteId:10301, type:'dragon', type2:'ground', ability:{id:'solid-rock', name:'極巨腺體', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}}, id:718, name:'基格爾德', type:'dragon', type2:'ground', hp:360, tier:3, ability:{id:'solid-rock', name:'終結之地', trigger:'onDefend', desc:'受到剋制（×1.2以上）的攻擊傷害再減少 5%'}, attacks:[{name:'咬碎',dmg:66,cost:8,type:'dark',megaBoost:true,bonusEnergy:8},{name:'泥巴射擊',dmg:96,cost:13,type:'ground',status:{effect:'burn', chance:0.25}},{name:'地震',dmg:96,cost:13,type:'ground',status:{effect:'paralysis', chance:0.2}},{name:'龍爪',dmg:96,cost:13,type:'dragon',selfHeal:0.21}]},
  { mega:{spriteId:10315, type:'fighting', type2:'ice', ability:{id:'tough-claws', name:'鐵拳', trigger:'onAttack', desc:'攻擊傷害 +40'}}, id:740, name:'好勝毛蟹', type:'fighting', type2:'ice', hp:270, tier:2, ability:{id:'true-damage', name:'不動如山', trigger:'onAttack', desc:'攻擊傷害不會被對方的防禦特性、閃避或撐住效果影響'}, attacks:[{name:'岩崩吸能擊',dmg:20,cost:5,type:'rock',rider:'energy-steal'},{name:'空手劈',dmg:102,cost:9,type:'fighting',megaBoost:true,bonusEnergy:7},{name:'冰凍拳',dmg:100,cost:9,type:'ice',megaBoost:true,bonusEnergy:7},{name:'近身戰',dmg:147,cost:14,type:'fighting',selfHeal:0.29}]},
